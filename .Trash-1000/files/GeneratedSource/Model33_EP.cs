...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 20:08 on lunedì 27 giugno 2022.
	/// </remarks>
	public partial class Model33_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110 has executed. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110_isDone;
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110 has performed initialisation. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110_isInitialised;
		/// <summary>True if Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617 has executed. Set this to false to force re-execution of Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617</summary>
		public bool Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone;
		...
		/// <summary>True if Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617 has executed. Set this to false to force re-execution of Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617</summary>
		public bool Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone;
		...
		/// <summary>True if Changed_PlayerIndex_PlayerInTeam_vdouble__617 has executed. Set this to false to force re-execution of Changed_PlayerIndex_PlayerInTeam_vdouble__617</summary>
		public bool Changed_PlayerIndex_PlayerInTeam_vdouble__617_isDone;
		...
		/// <summary>True if Changed_vdouble__617 has executed. Set this to false to force re-execution of Changed_vdouble__617</summary>
		public bool Changed_vdouble__617_isDone;
		...
		public Bernoulli vbool443_rep_B_toDef;
		public Bernoulli[] vbool443_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli vbool443_rep_F_marginal;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli[] vbool443_rep_rep_B_toDef;
		public Bernoulli[][] vbool443_rep_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli[] vbool443_rep_rep_F_marginal;
		public Bernoulli[][][] vbool443_rep_rep_rep_B;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli[][] vbool443_rep_rep_rep_B_toDef;
		public Bernoulli[][][] vbool443_rep_rep_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli[][] vbool443_rep_rep_rep_F_marginal;
		/// <summary>Message to marginal of 'vbool444'</summary>
		public Bernoulli vbool444_marginal_F;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli vbool444_rep_B_toDef;
		public Bernoulli[] vbool444_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli vbool444_rep_F_marginal;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli[] vbool444_rep_rep_B_toDef;
		public Bernoulli[][] vbool444_rep_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli[] vbool444_rep_rep_F_marginal;
		public Bernoulli[][][] vbool444_rep_rep_rep_B;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli[][] vbool444_rep_rep_rep_B_toDef;
		public Bernoulli[][][] vbool444_rep_rep_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli[][] vbool444_rep_rep_rep_F_marginal;
		public Bernoulli[][][] vbool446_B;
		public Bernoulli[][][] vbool446_F;
		/// <summary>Field backing the vdouble__617 property</summary>
		private double[] Vdouble__617;
		...
		public double[][] vdouble2401_reduced;
		public double[][] vdouble2408_reduced;
		public double[][] vdouble2409_reduced;
		public Gaussian[][][] vdouble2410_F;
		public Gaussian[][][] vdouble2411_F;
		public Gaussian[][][] vdouble2421_F;
		public Gaussian[][][] vdouble2431_F;
		public Gaussian[][][] vdouble2438_B;
		public Gaussian[][][] vdouble2438_F;
		public Gaussian[][][] vdouble2440_B;
		public Gaussian[][][] vdouble2440_F;
		public Gaussian[][][] vdouble2442_F;
		/// <summary>Message from use of 'vdouble2442'</summary>
		public Gaussian[][][] vdouble2442_use_B;
		public Gaussian[][][] vdouble2444_B;
		public Gaussian[][][] vdouble2444_F;
		#endregion
		...
		public double[][][] deathcount
		{
			...
			set {
				...
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110_isInitialised = false;
		...
		public double[] Match_time_m
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_5_isInitialised = false;
				this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110_isDone = false;
		...
		public double[][][] p_time_m__t__n
		{
			...
			set {
				...
				this.Changed_Match_time_m_p_time_m__t__n_PlayerInTeam_isDone = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_5_isInitialised = false;
				this.Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone = false;
				this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_quit_vdoubl11_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam1_isDone = false;
		...
		public int[][][] PlayerIndex
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_5_isInitialised = false;
				this.Changed_PlayerIndex_PlayerInTeam_vdouble__617_isDone = false;
				this.Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone = false;
				this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_quit_vdoubl11_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__617'</summary>
		public double[] vdouble__617
		{
			get {
				return this.Vdouble__617;
			}
			set {
				if ((value!=null)&&(value.Length!=7319)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7319)+" was expected for variable \'vdouble__617\'");
				}
				this.Vdouble__617 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__617_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_5_isInitialised = false;
				this.Changed_PlayerIndex_PlayerInTeam_vdouble__617_isDone = false;
				this.Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone = false;
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of deathcount and killcount and Match_time_m and numberOfIterations and p_time_m__t__n and PlayerIndex and PlayerInTeam and quit and team2wins and vdouble__617</summary>
		...
		private void Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam1(int numberOfIterations)
		{
			...
			// Create array for replicates of 'vdouble2451_F'
			Gaussian[] vdouble2451_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble2451_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble2451_B'
			Gaussian[] vdouble2451_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble2451_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble2453_F'
			Gaussian[] vdouble2453_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble2453_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble2453_B'
			Gaussian[] vdouble2453_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble2453_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[][][] vdouble2415_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2415_F'
				vdouble2415_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2415_F'
					vdouble2415_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==1) {
							vdouble2415_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			double[][] vdouble2413_reduced = new double[1000][];
			double[][] vdouble2414_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				vdouble2413_reduced[nMatches] = new double[2];
				vdouble2414_reduced[nMatches] = new double[2];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					vdouble2413_reduced[nMatches][nTeamsPerMatch] = default(double);
					vdouble2414_reduced[nMatches][nTeamsPerMatch] = default(double);
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							vdouble2413_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][0]);
							vdouble2414_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(vdouble2413_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
			...
			// Create array for replicates of 'vdouble2432_F'
			Gaussian[][][] vdouble2432_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2432_F'
				vdouble2432_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2432_F'
					vdouble2432_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble2432_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			Gaussian[][][] vdouble2435_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2435_F'
				vdouble2435_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2435_F'
					vdouble2435_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble2435_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble2435_use_B'
			Gaussian[][][] vdouble2435_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2435_use_B'
				vdouble2435_use_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2435_use_B'
					vdouble2435_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble2435_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			// Create array for replicates of 'vdouble2432_B'
			Gaussian[][][] vdouble2432_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2432_B'
				vdouble2432_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2432_B'
					vdouble2432_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble2432_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble2429_B'
			Gaussian[][][] vdouble2429_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2429_B'
				vdouble2429_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2429_B'
					vdouble2429_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble2429_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
			...
			Gaussian[][][] vdouble2429_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2429_F'
				vdouble2429_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2429_F'
					vdouble2429_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble2429_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble2431_B'
			Gaussian[][][] vdouble2431_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2431_B'
				vdouble2431_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2431_B'
					vdouble2431_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble2431_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			Gaussian[][][] vdouble2425_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2425_F'
				vdouble2425_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2425_F'
					vdouble2425_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble2425_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble2425_use_B'
			Gaussian[][][] vdouble2425_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2425_use_B'
				vdouble2425_use_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2425_use_B'
					vdouble2425_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble2425_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			// Create array for replicates of 'vdouble2421_B'
			Gaussian[][][] vdouble2421_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2421_B'
				vdouble2421_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2421_B'
					vdouble2421_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble2421_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			Gaussian[][][] vdouble2415_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2415_B'
				vdouble2415_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2415_B'
					vdouble2415_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==1) {
							vdouble2415_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			...
			Gaussian[][][] vdouble2411_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2411_B'
				vdouble2411_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble2411_B'
					vdouble2411_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble2411_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
				...
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.vdouble2438_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][3], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble2440' from Difference factor
							this.vdouble2440_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble2438_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 1.5000000000000002E-05);
							// Message to 'vdouble2442' from Gaussian factor
							this.vdouble2442_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.vdouble2440_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 1.0000000000000001E-05);
							// Message to 'vdouble2444' from Difference factor
							this.vdouble2444_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(0.0, this.vdouble2442_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Under_performing' from IsPositive factor
							this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = IsPositiveOp.IsPositiveAverageConditional(this.vdouble2444_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vbool446' from And factor
							this.vbool446_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanAndOp.AndAverageConditional(this.vbool443_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vbool444_rep_rep_rep' from Or factor
							this.vbool444_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanOrOp.AAverageConditional(this.Quit[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool446_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						}
						this.vbool444_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool444_rep_rep_rep_B[nMatches][nTeamsPerMatch], this.vbool444_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch]);
					}
					this.vbool444_rep_rep_B_toDef[nMatches] = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool444_rep_rep_rep_B_toDef[nMatches], this.vbool444_rep_rep_B_toDef[nMatches]);
				}
				this.vbool444_rep_B_toDef = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool444_rep_rep_B_toDef, this.vbool444_rep_B_toDef);
				this.vbool444_rep_F_marginal = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool444_rep_B_toDef, this.vBernoulli68, this.vbool444_rep_F_marginal);
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					// Message to 'vbool444_rep' from Replicate factor
					this.vbool444_rep_F[nMatches] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool444_rep_rep_B_toDef[nMatches], this.vbool444_rep_F_marginal, nMatches, this.vbool444_rep_F[nMatches]);
					this.vbool444_rep_rep_F_marginal[nMatches] = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool444_rep_rep_B_toDef[nMatches], this.vbool444_rep_F[nMatches], this.vbool444_rep_rep_F_marginal[nMatches]);
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						// Message to 'vbool444_rep_rep' from Replicate factor
						this.vbool444_rep_rep_F[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool444_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch], this.vbool444_rep_rep_F_marginal[nMatches], nTeamsPerMatch, this.vbool444_rep_rep_F[nMatches][nTeamsPerMatch]);
						this.vbool444_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool444_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch], this.vbool444_rep_rep_F[nMatches][nTeamsPerMatch], this.vbool444_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch]);
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'vbool444_rep_rep_rep' from Replicate factor
							this.vbool444_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool444_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool444_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch], nPlayersMinusPerTeam, this.vbool444_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vbool446' from Or factor
							this.vbool446_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanOrOp.BAverageConditional(this.Quit[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool444_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vbool443_rep_rep_rep' from And factor
							this.vbool443_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanAndOp.AAverageConditional(this.vbool446_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						}
						this.vbool443_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool443_rep_rep_rep_B[nMatches][nTeamsPerMatch], this.vbool443_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch]);
					}
					this.vbool443_rep_rep_B_toDef[nMatches] = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool443_rep_rep_rep_B_toDef[nMatches], this.vbool443_rep_rep_B_toDef[nMatches]);
				}
				this.vbool443_rep_B_toDef = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool443_rep_rep_B_toDef, this.vbool443_rep_B_toDef);
				this.vbool443_rep_F_marginal = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool443_rep_B_toDef, this.vBernoulli68, this.vbool443_rep_F_marginal);
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							vdouble2419_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(1.9000000000000001E-05, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble2422' from Plus factor
							vdouble2422_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(vdouble2419_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble2421_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Product factor
							kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble2422_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble2425' from Gaussian factor
							vdouble2425_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble2425_use' from Max factor
							vdouble2425_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Killcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, vdouble2425_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Gaussian factor
							kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(vdouble2425_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble2422' from Product factor
							vdouble2422_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble2421' from Plus factor
							vdouble2421_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(vdouble2422_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble2419_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0] = GaussianProductOpBase.BAverageConditional(vdouble2421_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -9.5000000000000005E-05);
						}
					}
					// Message to 'vbool443_rep' from Replicate factor
					this.vbool443_rep_F[nMatches] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool443_rep_rep_B_toDef[nMatches], this.vbool443_rep_F_marginal, nMatches, this.vbool443_rep_F[nMatches]);
					this.vbool443_rep_rep_F_marginal[nMatches] = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool443_rep_rep_B_toDef[nMatches], this.vbool443_rep_F[nMatches], this.vbool443_rep_rep_F_marginal[nMatches]);
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						// Message to 'vbool443_rep_rep' from Replicate factor
						this.vbool443_rep_rep_F[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool443_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch], this.vbool443_rep_rep_F_marginal[nMatches], nTeamsPerMatch, this.vbool443_rep_rep_F[nMatches][nTeamsPerMatch]);
						this.vbool443_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool443_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch], this.vbool443_rep_rep_F[nMatches][nTeamsPerMatch], this.vbool443_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch]);
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'vbool443_rep_rep_rep' from Replicate factor
							this.vbool443_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool443_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool443_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch], nPlayersMinusPerTeam, this.vbool443_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Under_performing' from And factor
							this.Under_performing_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanAndOp.BAverageConditional(this.vbool446_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool443_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble2444' from IsPositive factor
							this.vdouble2444_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = IsPositiveOp_Proper.XAverageConditional(this.Under_performing_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble2444_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble2442_use' from Difference factor
							this.vdouble2442_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(0.0, this.vdouble2444_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble2440' from Gaussian factor
							this.vdouble2440_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble2442_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 1.0000000000000001E-05);
							// Message to 'vdouble2438' from Difference factor
							this.vdouble2438_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble2440_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 1.5000000000000002E-05);
							// Message to 'Perfomance_opposing_team_uses' from Difference factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = DoublePlusOp.BAverageConditional(this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][3], this.vdouble2438_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							// Message to 'vdouble2429' from Product factor
							vdouble2429_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-8.5000000000000006E-05, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble2432' from Plus factor
							vdouble2432_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(vdouble2429_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble2431_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Product factor
							death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble2432_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble2435' from Gaussian factor
							vdouble2435_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble2435_use' from Max factor
							vdouble2435_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Deathcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, vdouble2435_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Gaussian factor
							death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(vdouble2435_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble2432' from Product factor
							vdouble2432_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble2431' from Plus factor
							vdouble2431_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(vdouble2432_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble2429_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble2431_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 1.1000000000000001E-05);
							// Message to 'player_perf_t__n_uses' from Replicate factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						...
						if (nTeamsPerMatch==0) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'vdouble2411' from Product factor
								vdouble2411_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble2409_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble2410' from Ratio factor
								vdouble2410_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble2411_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble2410' from Sum factor
								this.vdouble2410_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_0_0_' from Sum factor
								this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble2410_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble2410_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble2411' from Ratio factor
								this.vdouble2411_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble2410_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_0_' from Product factor
								this.Perfomance_opposing_team_0__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble2409_reduced[nMatches][nTeamsPerMatch], this.vdouble2411_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							}
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble2453' from Difference factor
						vdouble2453_F[nMatches] = DoublePlusOp.AAverageConditional(-0.01, Diff_F[nMatches]);
						// Message to 'vdouble2453' from IsPositive factor
						vdouble2453_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble2453_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.01, vdouble2453_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble2451' from Difference factor
						vdouble2451_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.01);
						// Message to 'vdouble2451' from IsPositive factor
						vdouble2451_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble2451_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble2451_B[nMatches], 0.01);
						// Message to 'Diff' from Copy factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==1) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'vdouble2415' from Sum factor
								vdouble2415_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble2416' from Ratio factor
								vdouble2416_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble2415_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_1_' from Product factor
								this.Perfomance_opposing_team_1__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble2414_reduced[nMatches][nTeamsPerMatch], vdouble2416_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								...
								vdouble2416_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_uses_B_toDef2[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble2414_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble2415' from Ratio factor
								vdouble2415_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble2416_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'player_perf_t__n_1_1_' from Sum factor
								this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble2415_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble2415_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'Perfomance_opposing_team_uses' from Replicate factor
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][3] = DoublePlusOp.SumAverageConditional(this.vdouble2438_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble2421' from Product factor
							this.vdouble2421_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-9.5000000000000005E-05, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							// Message to 'vdouble2419' from Plus factor
							vdouble2419_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(vdouble2422_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble2421_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble2419_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 1.9000000000000001E-05);
							// Message to 'vdouble2431' from Product factor
							this.vdouble2431_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(1.1000000000000001E-05, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
						}
						if (nTeamsPerMatch==1) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'vdouble2429' from Plus factor
							vdouble2429_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(vdouble2432_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble2431_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = GaussianProductOpBase.BAverageConditional(vdouble2429_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -8.5000000000000006E-05);
			...
			// Message to 'vbool443_marginal' from Variable factor
			this.vbool443_marginal_F = VariableOp.MarginalAverageConditional<Bernoulli>(this.vbool443_rep_B_toDef, this.vBernoulli68, this.vbool443_marginal_F);
			this.vbool444_marginal_F = Bernoulli.Uniform();
			// Message to 'vbool444_marginal' from Variable factor
			this.vbool444_marginal_F = VariableOp.MarginalAverageConditional<Bernoulli>(this.vbool444_rep_B_toDef, this.vBernoulli68, this.vbool444_marginal_F);
		...
		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and quit and vdouble__617 and must reset on changes to deathcount and killcount and team2wins</summary>
		...
		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__617 and must reset on changes to deathcount and killcount and quit and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110(bool initialise)
		{
			if (this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110_isDone&&((!initialise)||this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110_isDone = true;
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__617</summary>
		private void Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617()
		{
			if (this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone = true;
		}
		...
		private void Changed_Match_time_m_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble2401_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						if (nTeamsPerMatch==0) {
							this.vdouble2409_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble2408_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and quit and team2wins and vdouble__617</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde9(bool initialise)
		{
			...
			this.vbool443_rep_F_marginal = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vBernoulli68);
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vbool443_rep_F[nMatches] = Bernoulli.Uniform();
				this.vbool443_rep_rep_F_marginal[nMatches] = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vbool443_rep_F[nMatches]);
				this.vbool443_rep_rep_B_toDef[nMatches] = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vbool443_rep_F[nMatches]);
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					this.vbool443_rep_rep_F[nMatches][nTeamsPerMatch] = Bernoulli.Uniform();
					this.vbool443_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vbool443_rep_rep_F[nMatches][nTeamsPerMatch]);
					this.vbool443_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vbool443_rep_rep_F[nMatches][nTeamsPerMatch]);
					this.vbool444_rep_rep_F[nMatches][nTeamsPerMatch] = Bernoulli.Uniform();
					this.vbool444_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vbool444_rep_rep_F[nMatches][nTeamsPerMatch]);
				}
				this.vbool444_rep_F[nMatches] = Bernoulli.Uniform();
				this.vbool444_rep_rep_B_toDef[nMatches] = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vbool444_rep_F[nMatches]);
			}
			this.vbool444_rep_B_toDef = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vBernoulli68);
			this.vbool444_rep_F_marginal = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vBernoulli68);
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vbool444_rep_rep_F_marginal[nMatches] = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vbool444_rep_F[nMatches]);
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					this.vbool444_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vbool444_rep_rep_F[nMatches][nTeamsPerMatch]);
				}
			}
			this.vbool443_rep_B_toDef = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vBernoulli68);
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and quit and team2wins and vdouble__617</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_5(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							this.vdouble2410_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						this.vbool443_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vbool446_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vbool444_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vbool444_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vbool446_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.Under_performing_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vdouble2444_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble2442_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble2440_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble2438_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble2421_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						this.vdouble2438_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble2440_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble2442_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble2444_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vbool443_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__617</summary>
		private void Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617()
		{
			if (this.Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617_isDone = true;
		}
		...
		private void Changed_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						this.vdouble2401_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][nTeamsPerMatch]);
						if (nTeamsPerMatch==0) {
							this.vdouble2408_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][1]);
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of PlayerIndex and PlayerInTeam and vdouble__617</summary>
		private void Changed_PlayerIndex_PlayerInTeam_vdouble__617()
		{
			if (this.Changed_PlayerIndex_PlayerInTeam_vdouble__617_isDone) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.perf_from_ds_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__617[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
					}
				}
			}
			this.Changed_PlayerIndex_PlayerInTeam_vdouble__617_isDone = true;
		}
		...
		private void Changed_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					this.vdouble2401_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble2408_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble2409_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble2410_F'
					this.vdouble2410_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for 'vbool443_rep_rep_rep' Forwards messages.
					this.vbool443_rep_rep_rep_F[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vbool446_F'
					this.vbool446_F[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for 'vbool444_rep_rep_rep' Backwards messages.
					this.vbool444_rep_rep_rep_B[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for 'vbool444_rep_rep_rep' Forwards messages.
					this.vbool444_rep_rep_rep_F[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vbool446_B'
					this.vbool446_B[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble2444_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble2442_use_B'
					this.vdouble2442_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble2440_B'
					this.vdouble2440_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble2438_B'
					this.vdouble2438_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble2421_F'
					this.vdouble2421_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble2438_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble2440_F'
					this.vdouble2440_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble2442_F'
					this.vdouble2442_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble2444_F'
					this.vdouble2444_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for 'vbool443_rep_rep_rep' Backwards messages.
					this.vbool443_rep_rep_rep_B[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
				}
			}
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool449'
			bool[] vbool449 = new bool[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool449[nMatches] = true;
					Constrain.Equal<bool>(true, vbool449[nMatches]);
				}
			}
			// Create array for replicates of 'vbool451'
			bool[] vbool451 = new bool[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vbool451[nMatches] = true;
					Constrain.Equal<bool>(true, vbool451[nMatches]);
				}
			}
			// Create array for replicates of 'vbool453'
			bool[] vbool453 = new bool[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool453[nMatches] = true;
					Constrain.Equal<bool>(true, vbool453[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__617</summary>
		private void Changed_vdouble__617()
		{
			if (this.Changed_vdouble__617_isDone) {
				return ;
			}
			// Create array for 'vdouble__617_marginal' Forwards messages.
			this.vdouble__617_marginal_F = new DistributionStructArray<Gaussian,double>(7319);
			for(int nPlayers = 0; nPlayers<7319; nPlayers++) {
				this.vdouble__617_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__617_marginal' from DerivedVariable factor
			this.vdouble__617_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__617, this.vdouble__617_marginal_F);
			this.Changed_vdouble__617_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vBernoulli68 = Bernoulli.Uniform();
			// Create array for replicates of 'perf_from_ds_F'
			...
			this.vdouble2401_reduced = new double[1000][];
			this.Avg_play_time_team_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble2401_reduced[nMatches] = new double[2];
				this.Avg_play_time_team_reduced[nMatches] = new double[2];
			}
			this.vdouble2408_reduced = new double[1000][];
			this.vdouble2409_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble2408_reduced[nMatches] = new double[2];
				this.vdouble2409_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble2410_F'
			this.vdouble2410_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2410_F'
				this.vdouble2410_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble2411_F'
			...
			// Create array for 'vbool443_rep' Forwards messages.
			this.vbool443_rep_F = new Bernoulli[1000];
			// Create array for replicates of 'vbool443_rep_rep_F_marginal'
			this.vbool443_rep_rep_F_marginal = new Bernoulli[1000];
			// Create array for replicates of 'vbool443_rep_rep_B_toDef'
			this.vbool443_rep_rep_B_toDef = new Bernoulli[1000];
			// Create array for replicates of 'vbool443_rep_rep_F'
			this.vbool443_rep_rep_F = new Bernoulli[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for 'vbool443_rep_rep' Forwards messages.
				this.vbool443_rep_rep_F[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool443_rep_rep_rep_F_marginal'
			this.vbool443_rep_rep_rep_F_marginal = new Bernoulli[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool443_rep_rep_rep_F_marginal'
				this.vbool443_rep_rep_rep_F_marginal[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool443_rep_rep_rep_B_toDef'
			this.vbool443_rep_rep_rep_B_toDef = new Bernoulli[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool443_rep_rep_rep_B_toDef'
				this.vbool443_rep_rep_rep_B_toDef[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool443_rep_rep_rep_F'
			this.vbool443_rep_rep_rep_F = new Bernoulli[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool443_rep_rep_rep_F'
				this.vbool443_rep_rep_rep_F[nMatches] = new Bernoulli[2][];
			}
			// Create array for replicates of 'vbool446_F'
			this.vbool446_F = new Bernoulli[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool446_F'
				this.vbool446_F[nMatches] = new Bernoulli[2][];
			}
			// Create array for replicates of 'vbool444_rep_rep_rep_B'
			this.vbool444_rep_rep_rep_B = new Bernoulli[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool444_rep_rep_rep_B'
				this.vbool444_rep_rep_rep_B[nMatches] = new Bernoulli[2][];
			}
			// Create array for replicates of 'vbool444_rep_rep_F'
			this.vbool444_rep_rep_F = new Bernoulli[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for 'vbool444_rep_rep' Forwards messages.
				this.vbool444_rep_rep_F[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool444_rep_rep_rep_B_toDef'
			this.vbool444_rep_rep_rep_B_toDef = new Bernoulli[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool444_rep_rep_rep_B_toDef'
				this.vbool444_rep_rep_rep_B_toDef[nMatches] = new Bernoulli[2];
			}
			// Create array for 'vbool444_rep' Forwards messages.
			this.vbool444_rep_F = new Bernoulli[1000];
			// Create array for replicates of 'vbool444_rep_rep_B_toDef'
			this.vbool444_rep_rep_B_toDef = new Bernoulli[1000];
			// Create array for replicates of 'vbool444_rep_rep_F_marginal'
			this.vbool444_rep_rep_F_marginal = new Bernoulli[1000];
			// Create array for replicates of 'vbool444_rep_rep_rep_F_marginal'
			this.vbool444_rep_rep_rep_F_marginal = new Bernoulli[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool444_rep_rep_rep_F_marginal'
				this.vbool444_rep_rep_rep_F_marginal[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool444_rep_rep_rep_F'
			this.vbool444_rep_rep_rep_F = new Bernoulli[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool444_rep_rep_rep_F'
				this.vbool444_rep_rep_rep_F[nMatches] = new Bernoulli[2][];
			}
			// Create array for replicates of 'vbool446_B'
			this.vbool446_B = new Bernoulli[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool446_B'
				this.vbool446_B[nMatches] = new Bernoulli[2][];
			}
			// Create array for replicates of 'Under_performing_B'
			...
			// Create array for replicates of 'vdouble2444_B'
			this.vdouble2444_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2444_B'
				this.vdouble2444_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble2442_use_B'
			this.vdouble2442_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2442_use_B'
				this.vdouble2442_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble2440_B'
			this.vdouble2440_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2440_B'
				this.vdouble2440_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble2438_B'
			this.vdouble2438_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2438_B'
				this.vdouble2438_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble2421_F'
			this.vdouble2421_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2421_F'
				this.vdouble2421_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'player_perf_t__n_1_1__B'
			...
			// Create array for replicates of 'vdouble2438_F'
			this.vdouble2438_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2438_F'
				this.vdouble2438_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble2440_F'
			this.vdouble2440_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2440_F'
				this.vdouble2440_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble2442_F'
			this.vdouble2442_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2442_F'
				this.vdouble2442_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble2444_F'
			this.vdouble2444_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble2444_F'
				this.vdouble2444_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'Under_performing_F'
			...
			// Create array for replicates of 'vbool443_rep_rep_rep_B'
			this.vbool443_rep_rep_rep_B = new Bernoulli[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool443_rep_rep_rep_B'
				this.vbool443_rep_rep_rep_B[nMatches] = new Bernoulli[2][];
			}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_PlayerIndex_PlayerInTeam_vdouble__617();
			this.Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617();
			this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__617();
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__6110(initialise);
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__617") {
				this.vdouble__617 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
