...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 14:23 on sabato 25 giugno 2022.
	/// </remarks>
	public partial class Model114_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>Message to marginal of 'vbool574'</summary>
		public Bernoulli vbool574_marginal_F;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli vbool574_rep_B_toDef;
		public Bernoulli[] vbool574_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli vbool574_rep_F_marginal;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli[] vbool574_rep_rep_B_toDef;
		public Bernoulli[][] vbool574_rep_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli[] vbool574_rep_rep_F_marginal;
		public Bernoulli[][][] vbool574_rep_rep_rep_B;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli[][] vbool574_rep_rep_rep_B_toDef;
		public Bernoulli[][][] vbool574_rep_rep_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli[][] vbool574_rep_rep_rep_F_marginal;
		/// <summary>Message to marginal of 'vbool575'</summary>
		public Bernoulli vbool575_marginal_F;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli vbool575_rep_B_toDef;
		public Bernoulli[] vbool575_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli vbool575_rep_F_marginal;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli[] vbool575_rep_rep_B_toDef;
		public Bernoulli[][] vbool575_rep_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli[] vbool575_rep_rep_F_marginal;
		public Bernoulli[][][] vbool575_rep_rep_rep_B;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli[][] vbool575_rep_rep_rep_B_toDef;
		public Bernoulli[][][] vbool575_rep_rep_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli[][] vbool575_rep_rep_rep_F_marginal;
		public Bernoulli[][][] vbool578_B;
		public Bernoulli[][][] vbool578_F;
		...
		public double[][] vdouble3468_reduced;
		public double[][] vdouble3475_reduced;
		public double[][] vdouble3476_reduced;
		public Gaussian[][][] vdouble3477_F;
		public Gaussian[][][] vdouble3478_F;
		public Gaussian[][][] vdouble3488_F;
		public Gaussian[][][] vdouble3498_F;
		public Gaussian[][][] vdouble3505_B;
		public Gaussian[][][] vdouble3505_F;
		public Gaussian[][][] vdouble3507_B;
		public Gaussian[][][] vdouble3507_F;
		public Gaussian[][][] vdouble3509_F;
		/// <summary>Message from use of 'vdouble3509'</summary>
		public Gaussian[][][] vdouble3509_use_B;
		public Gaussian[][][] vdouble3511_B;
		public Gaussian[][][] vdouble3511_F;
		...
		private void Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam1(int numberOfIterations)
		{
			...
			this.vbool574_marginal_F = Bernoulli.Uniform();
			...
			// Create array for replicates of 'vdouble3518_F'
			Gaussian[] vdouble3518_F = new Gaussian[343];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble3518_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble3518_B'
			Gaussian[] vdouble3518_B = new Gaussian[343];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble3518_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble3520_F'
			Gaussian[] vdouble3520_F = new Gaussian[343];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble3520_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble3520_B'
			Gaussian[] vdouble3520_B = new Gaussian[343];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble3520_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[][][] vdouble3482_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3482_F'
				vdouble3482_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3482_F'
					vdouble3482_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==1) {
							vdouble3482_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			double[][] vdouble3480_reduced = new double[343][];
			double[][] vdouble3481_reduced = new double[343][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				vdouble3480_reduced[nMatches] = new double[2];
				vdouble3481_reduced[nMatches] = new double[2];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					vdouble3480_reduced[nMatches][nTeamsPerMatch] = default(double);
					vdouble3481_reduced[nMatches][nTeamsPerMatch] = default(double);
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							vdouble3480_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][0]);
							vdouble3481_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(vdouble3480_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
			...
			Gaussian[][][] vdouble3499_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3499_F'
				vdouble3499_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3499_F'
					vdouble3499_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3499_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3502_F'
				vdouble3502_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3502_F'
					vdouble3502_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3502_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble3502_use_B'
			Gaussian[][][] vdouble3502_use_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3502_use_B'
				vdouble3502_use_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3502_use_B'
					vdouble3502_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3502_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			Gaussian[][][] vdouble3499_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3499_B'
				vdouble3499_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3499_B'
					vdouble3499_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3499_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble3496_B'
			Gaussian[][][] vdouble3496_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3496_B'
				vdouble3496_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3496_B'
					vdouble3496_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3496_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
			...
			// Create array for replicates of 'vdouble3496_F'
			Gaussian[][][] vdouble3496_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3496_F'
				vdouble3496_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3496_F'
					vdouble3496_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3496_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble3498_B'
			Gaussian[][][] vdouble3498_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3498_B'
				vdouble3498_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3498_B'
					vdouble3498_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3498_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble3489_F'
			Gaussian[][][] vdouble3489_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3489_F'
				vdouble3489_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3489_F'
					vdouble3489_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3489_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			// Create array for replicates of 'vdouble3492_F'
			Gaussian[][][] vdouble3492_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3492_F'
				vdouble3492_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3492_F'
					vdouble3492_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3492_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble3492_use_B'
			Gaussian[][][] vdouble3492_use_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3492_use_B'
				vdouble3492_use_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3492_use_B'
					vdouble3492_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3492_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			Gaussian[][][] vdouble3489_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3489_B'
				vdouble3489_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3489_B'
					vdouble3489_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3489_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble3486_B'
			Gaussian[][][] vdouble3486_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3486_B'
				vdouble3486_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3486_B'
					vdouble3486_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3486_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			Gaussian[][][] vdouble3488_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3488_B'
				vdouble3488_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3488_B'
					vdouble3488_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3488_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			// Create array for replicates of 'vdouble3478_B'
			Gaussian[][][] vdouble3478_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3478_B'
				vdouble3478_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3478_B'
					vdouble3478_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble3478_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			// Create array for replicates of 'vdouble3477_B'
			Gaussian[][][] vdouble3477_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3477_B'
				vdouble3477_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3477_B'
					vdouble3477_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble3477_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
				...
				for(int nMatches = 0; nMatches<343; nMatches++) {
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							// Message to 'vdouble3505' from Difference factor
							this.vdouble3505_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][3], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble3507' from Difference factor
							this.vdouble3507_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble3505_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 1.0000000000000001E-05);
							// Message to 'vdouble3509' from Gaussian factor
							this.vdouble3509_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.vdouble3507_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 2.5640055167695236E-306);
							// Message to 'vdouble3511' from Difference factor
							this.vdouble3511_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(0.0, this.vdouble3509_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Under_performing' from IsPositive factor
							this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = IsPositiveOp.IsPositiveAverageConditional(this.vdouble3511_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vbool578' from And factor
							this.vbool578_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanAndOp.AndAverageConditional(this.vbool574_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vbool575_rep_rep_rep' from Or factor
							this.vbool575_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanOrOp.AAverageConditional(this.Quit[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool578_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						}
						this.vbool575_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool575_rep_rep_rep_B[nMatches][nTeamsPerMatch], this.vbool575_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch]);
					}
					this.vbool575_rep_rep_B_toDef[nMatches] = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool575_rep_rep_rep_B_toDef[nMatches], this.vbool575_rep_rep_B_toDef[nMatches]);
				}
				this.vbool575_rep_B_toDef = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool575_rep_rep_B_toDef, this.vbool575_rep_B_toDef);
				this.vbool575_rep_F_marginal = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool575_rep_B_toDef, this.vBernoulli77, this.vbool575_rep_F_marginal);
				for(int nMatches = 0; nMatches<343; nMatches++) {
					// Message to 'vbool575_rep' from Replicate factor
					this.vbool575_rep_F[nMatches] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool575_rep_rep_B_toDef[nMatches], this.vbool575_rep_F_marginal, nMatches, this.vbool575_rep_F[nMatches]);
					this.vbool575_rep_rep_F_marginal[nMatches] = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool575_rep_rep_B_toDef[nMatches], this.vbool575_rep_F[nMatches], this.vbool575_rep_rep_F_marginal[nMatches]);
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						// Message to 'vbool575_rep_rep' from Replicate factor
						this.vbool575_rep_rep_F[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool575_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch], this.vbool575_rep_rep_F_marginal[nMatches], nTeamsPerMatch, this.vbool575_rep_rep_F[nMatches][nTeamsPerMatch]);
						this.vbool575_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool575_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch], this.vbool575_rep_rep_F[nMatches][nTeamsPerMatch], this.vbool575_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch]);
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'vbool575_rep_rep_rep' from Replicate factor
							this.vbool575_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool575_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool575_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch], nPlayersMinusPerTeam, this.vbool575_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vbool578' from Or factor
							this.vbool578_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanOrOp.BAverageConditional(this.Quit[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool575_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vbool574_rep_rep_rep' from And factor
							this.vbool574_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanAndOp.AAverageConditional(this.vbool578_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						}
						this.vbool574_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool574_rep_rep_rep_B[nMatches][nTeamsPerMatch], this.vbool574_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch]);
					}
					this.vbool574_rep_rep_B_toDef[nMatches] = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool574_rep_rep_rep_B_toDef[nMatches], this.vbool574_rep_rep_B_toDef[nMatches]);
				}
				this.vbool574_rep_B_toDef = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool574_rep_rep_B_toDef, this.vbool574_rep_B_toDef);
				this.vbool574_rep_F_marginal = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool574_rep_B_toDef, this.vBernoulli76, this.vbool574_rep_F_marginal);
				for(int nMatches = 0; nMatches<343; nMatches++) {
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							// Message to 'vdouble3486' from Product factor
							vdouble3486_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(2.4567389591214163E-06, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble3489' from Plus factor
							vdouble3489_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(vdouble3486_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble3488_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Product factor
							kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble3489_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble3492' from Gaussian factor
							vdouble3492_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble3492_use' from Max factor
							vdouble3492_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Killcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, vdouble3492_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Gaussian factor
							kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(vdouble3492_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble3489' from Product factor
							vdouble3489_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble3488' from Plus factor
							vdouble3488_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(vdouble3489_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble3486_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0] = GaussianProductOpBase.BAverageConditional(vdouble3488_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 2.1494862404080466E-07);
						}
					}
					// Message to 'vbool574_rep' from Replicate factor
					this.vbool574_rep_F[nMatches] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool574_rep_rep_B_toDef[nMatches], this.vbool574_rep_F_marginal, nMatches, this.vbool574_rep_F[nMatches]);
					this.vbool574_rep_rep_F_marginal[nMatches] = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool574_rep_rep_B_toDef[nMatches], this.vbool574_rep_F[nMatches], this.vbool574_rep_rep_F_marginal[nMatches]);
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						// Message to 'vbool574_rep_rep' from Replicate factor
						this.vbool574_rep_rep_F[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool574_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch], this.vbool574_rep_rep_F_marginal[nMatches], nTeamsPerMatch, this.vbool574_rep_rep_F[nMatches][nTeamsPerMatch]);
						this.vbool574_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool574_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch], this.vbool574_rep_rep_F[nMatches][nTeamsPerMatch], this.vbool574_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch]);
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'vbool574_rep_rep_rep' from Replicate factor
							this.vbool574_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool574_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool574_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch], nPlayersMinusPerTeam, this.vbool574_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Under_performing' from And factor
							this.Under_performing_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanAndOp.BAverageConditional(this.vbool578_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool574_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble3511' from IsPositive factor
							this.vdouble3511_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = IsPositiveOp_Proper.XAverageConditional(this.Under_performing_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble3511_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble3509_use' from Difference factor
							this.vdouble3509_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(0.0, this.vdouble3511_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble3507' from Gaussian factor
							this.vdouble3507_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble3509_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 2.5640055167695236E-306);
							// Message to 'vdouble3505' from Difference factor
							this.vdouble3505_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble3507_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 1.0000000000000001E-05);
							// Message to 'Perfomance_opposing_team_uses' from Difference factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = DoublePlusOp.BAverageConditional(this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][3], this.vdouble3505_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							// Message to 'vdouble3496' from Product factor
							vdouble3496_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(1.85923228782512E-06, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble3499' from Plus factor
							vdouble3499_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(vdouble3496_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble3498_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Product factor
							death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble3499_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble3502' from Gaussian factor
							vdouble3502_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble3502_use' from Max factor
							vdouble3502_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Deathcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, vdouble3502_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Gaussian factor
							death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(vdouble3502_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble3499' from Product factor
							vdouble3499_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble3498' from Plus factor
							vdouble3498_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(vdouble3499_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble3496_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble3498_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 3.1726952640079678E-07);
							// Message to 'player_perf_t__n_uses' from Replicate factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==0) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'vdouble3478' from Product factor
								vdouble3478_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble3476_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble3477' from Ratio factor
								vdouble3477_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble3478_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble3477' from Sum factor
								this.vdouble3477_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_0_0_' from Sum factor
								this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble3477_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble3477_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble3478' from Ratio factor
								this.vdouble3478_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble3477_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_0_' from Product factor
								this.Perfomance_opposing_team_0__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble3476_reduced[nMatches][nTeamsPerMatch], this.vdouble3478_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble3520' from Difference factor
						vdouble3520_F[nMatches] = DoublePlusOp.AAverageConditional(-1.3012637574411616, Diff_F[nMatches]);
						// Message to 'vdouble3520' from IsPositive factor
						vdouble3520_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble3520_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-1.3012637574411616, vdouble3520_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble3518' from Difference factor
						vdouble3518_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 1.3012637574411616);
						// Message to 'vdouble3518' from IsPositive factor
						vdouble3518_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble3518_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble3518_B[nMatches], 1.3012637574411616);
						// Message to 'Diff' from Copy factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==1) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'vdouble3482' from Sum factor
								vdouble3482_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble3483' from Ratio factor
								vdouble3483_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble3482_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_1_' from Product factor
								this.Perfomance_opposing_team_1__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble3481_reduced[nMatches][nTeamsPerMatch], vdouble3483_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								...
								vdouble3483_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_uses_B_toDef2[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble3481_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble3482' from Ratio factor
								vdouble3482_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble3483_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'player_perf_t__n_1_1_' from Sum factor
								this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble3482_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble3482_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'Perfomance_opposing_team_uses' from Replicate factor
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][3] = DoublePlusOp.SumAverageConditional(this.vdouble3505_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							if (nTeamsPerMatch==0) {
								// Message to 'Perfomance_opposing_team_uses' from Replicate factor
							...
							// Message to 'vdouble3488' from Product factor
							this.vdouble3488_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(2.1494862404080466E-07, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							if (nTeamsPerMatch==0) {
								// Message to 'Perfomance_opposing_team_uses' from Replicate factor
							...
							// Message to 'vdouble3498' from Product factor
							this.vdouble3498_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(3.1726952640079678E-07, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
						}
						if (nTeamsPerMatch==1) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'vdouble3486' from Plus factor
							vdouble3486_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(vdouble3489_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble3488_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble3486_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 2.4567389591214163E-06);
							// Message to 'vdouble3496' from Plus factor
							vdouble3496_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(vdouble3499_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble3498_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = GaussianProductOpBase.BAverageConditional(vdouble3496_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 1.85923228782512E-06);
			...
			// Message to 'vbool574_marginal' from Variable factor
			this.vbool574_marginal_F = VariableOp.MarginalAverageConditional<Bernoulli>(this.vbool574_rep_B_toDef, this.vBernoulli76, this.vbool574_marginal_F);
			this.vbool575_marginal_F = Bernoulli.Uniform();
			// Message to 'vbool575_marginal' from Variable factor
			this.vbool575_marginal_F = VariableOp.MarginalAverageConditional<Bernoulli>(this.vbool575_rep_B_toDef, this.vBernoulli77, this.vbool575_marginal_F);
		...
		private void Changed_Match_time_m_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<343; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble3468_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						if (nTeamsPerMatch==0) {
							this.vdouble3476_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble3475_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
		...
		private void Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde9(bool initialise)
		{
			...
			this.vbool574_rep_F_marginal = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vBernoulli76);
			for(int nMatches = 0; nMatches<343; nMatches++) {
				this.vbool574_rep_F[nMatches] = Bernoulli.Uniform();
				this.vbool574_rep_rep_F_marginal[nMatches] = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vbool574_rep_F[nMatches]);
				this.vbool574_rep_rep_B_toDef[nMatches] = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vbool574_rep_F[nMatches]);
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					this.vbool574_rep_rep_F[nMatches][nTeamsPerMatch] = Bernoulli.Uniform();
					this.vbool574_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vbool574_rep_rep_F[nMatches][nTeamsPerMatch]);
					this.vbool574_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vbool574_rep_rep_F[nMatches][nTeamsPerMatch]);
					this.vbool575_rep_rep_F[nMatches][nTeamsPerMatch] = Bernoulli.Uniform();
					this.vbool575_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vbool575_rep_rep_F[nMatches][nTeamsPerMatch]);
				}
				this.vbool575_rep_F[nMatches] = Bernoulli.Uniform();
				this.vbool575_rep_rep_B_toDef[nMatches] = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vbool575_rep_F[nMatches]);
			}
			this.vbool575_rep_B_toDef = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vBernoulli77);
			this.vbool575_rep_F_marginal = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vBernoulli77);
			for(int nMatches = 0; nMatches<343; nMatches++) {
				this.vbool575_rep_rep_F_marginal[nMatches] = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vbool575_rep_F[nMatches]);
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					this.vbool575_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vbool575_rep_rep_F[nMatches][nTeamsPerMatch]);
				}
			}
			this.vbool574_rep_B_toDef = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vBernoulli76);
		...
		private void Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_5(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<343; nMatches++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							this.vdouble3477_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble3478_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						this.vdouble3498_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						this.vbool574_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vbool578_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vbool575_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vbool575_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vbool578_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.Under_performing_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vdouble3511_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble3509_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble3507_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble3505_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						this.vdouble3505_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble3507_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble3509_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble3511_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vbool574_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
					}
				}
			}
		...
		private void Changed_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<343; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						this.vdouble3468_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][nTeamsPerMatch]);
						if (nTeamsPerMatch==0) {
							this.vdouble3475_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][1]);
						}
					}
				}
			}
		...
		private void Changed_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<343; nMatches++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					this.vdouble3468_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble3475_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble3476_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble3477_F'
					this.vdouble3477_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble3478_F'
					this.vdouble3478_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble3498_F'
					this.vdouble3498_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for 'vbool574_rep_rep_rep' Forwards messages.
					this.vbool574_rep_rep_rep_F[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vbool578_F'
					this.vbool578_F[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for 'vbool575_rep_rep_rep' Backwards messages.
					this.vbool575_rep_rep_rep_B[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for 'vbool575_rep_rep_rep' Forwards messages.
					this.vbool575_rep_rep_rep_F[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vbool578_B'
					this.vbool578_B[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble3511_B'
					this.vdouble3511_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble3509_use_B'
					this.vdouble3509_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble3507_B'
					this.vdouble3507_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble3505_B'
					this.vdouble3505_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					// Create array for replicates of 'vdouble3505_F'
					this.vdouble3505_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble3507_F'
					this.vdouble3507_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble3509_F'
					this.vdouble3509_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble3511_F'
					this.vdouble3511_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for 'vbool574_rep_rep_rep' Backwards messages.
					this.vbool574_rep_rep_rep_B[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
				}
			}
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool585'
			bool[] vbool585 = new bool[343];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool585[nMatches] = true;
					Constrain.Equal<bool>(true, vbool585[nMatches]);
				}
			}
		...
		private void Constant()
		{
			...
			this.vdouble3468_reduced = new double[343][];
			this.Avg_play_time_team_reduced = new double[343][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				this.vdouble3468_reduced[nMatches] = new double[2];
				this.Avg_play_time_team_reduced[nMatches] = new double[2];
			}
			this.vdouble3475_reduced = new double[343][];
			this.vdouble3476_reduced = new double[343][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				this.vdouble3475_reduced[nMatches] = new double[2];
				this.vdouble3476_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble3477_F'
			this.vdouble3477_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3477_F'
				this.vdouble3477_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble3478_F'
			this.vdouble3478_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3478_F'
				this.vdouble3478_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'Perfomance_opposing_team_0__F'
			...
			// Create array for replicates of 'vdouble3498_F'
			this.vdouble3498_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3498_F'
				this.vdouble3498_F[nMatches] = new Gaussian[2][];
			}
			...
			// Create array for 'vbool574_rep' Forwards messages.
			this.vbool574_rep_F = new Bernoulli[343];
			// Create array for replicates of 'vbool574_rep_rep_F_marginal'
			this.vbool574_rep_rep_F_marginal = new Bernoulli[343];
			// Create array for replicates of 'vbool574_rep_rep_B_toDef'
			this.vbool574_rep_rep_B_toDef = new Bernoulli[343];
			// Create array for replicates of 'vbool574_rep_rep_F'
			this.vbool574_rep_rep_F = new Bernoulli[343][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for 'vbool574_rep_rep' Forwards messages.
				this.vbool574_rep_rep_F[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool574_rep_rep_rep_F_marginal'
			this.vbool574_rep_rep_rep_F_marginal = new Bernoulli[343][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vbool574_rep_rep_rep_F_marginal'
				this.vbool574_rep_rep_rep_F_marginal[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool574_rep_rep_rep_B_toDef'
			this.vbool574_rep_rep_rep_B_toDef = new Bernoulli[343][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vbool574_rep_rep_rep_B_toDef'
				this.vbool574_rep_rep_rep_B_toDef[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool574_rep_rep_rep_F'
			this.vbool574_rep_rep_rep_F = new Bernoulli[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vbool574_rep_rep_rep_F'
				this.vbool574_rep_rep_rep_F[nMatches] = new Bernoulli[2][];
			}
			this.vBernoulli77 = Bernoulli.FromLogOdds(-0.6931471805599454);
			// Create array for replicates of 'vbool578_F'
			this.vbool578_F = new Bernoulli[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vbool578_F'
				this.vbool578_F[nMatches] = new Bernoulli[2][];
			}
			// Create array for replicates of 'vbool575_rep_rep_rep_B'
			this.vbool575_rep_rep_rep_B = new Bernoulli[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vbool575_rep_rep_rep_B'
				this.vbool575_rep_rep_rep_B[nMatches] = new Bernoulli[2][];
			}
			// Create array for replicates of 'vbool575_rep_rep_F'
			this.vbool575_rep_rep_F = new Bernoulli[343][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for 'vbool575_rep_rep' Forwards messages.
				this.vbool575_rep_rep_F[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool575_rep_rep_rep_B_toDef'
			this.vbool575_rep_rep_rep_B_toDef = new Bernoulli[343][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vbool575_rep_rep_rep_B_toDef'
				this.vbool575_rep_rep_rep_B_toDef[nMatches] = new Bernoulli[2];
			}
			// Create array for 'vbool575_rep' Forwards messages.
			this.vbool575_rep_F = new Bernoulli[343];
			// Create array for replicates of 'vbool575_rep_rep_B_toDef'
			this.vbool575_rep_rep_B_toDef = new Bernoulli[343];
			// Create array for replicates of 'vbool575_rep_rep_F_marginal'
			this.vbool575_rep_rep_F_marginal = new Bernoulli[343];
			// Create array for replicates of 'vbool575_rep_rep_rep_F_marginal'
			this.vbool575_rep_rep_rep_F_marginal = new Bernoulli[343][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vbool575_rep_rep_rep_F_marginal'
				this.vbool575_rep_rep_rep_F_marginal[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool575_rep_rep_rep_F'
			this.vbool575_rep_rep_rep_F = new Bernoulli[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vbool575_rep_rep_rep_F'
				this.vbool575_rep_rep_rep_F[nMatches] = new Bernoulli[2][];
			}
			// Create array for replicates of 'vbool578_B'
			this.vbool578_B = new Bernoulli[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vbool578_B'
				this.vbool578_B[nMatches] = new Bernoulli[2][];
			}
			// Create array for replicates of 'Under_performing_B'
			...
			// Create array for replicates of 'vdouble3511_B'
			this.vdouble3511_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3511_B'
				this.vdouble3511_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble3509_use_B'
			this.vdouble3509_use_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3509_use_B'
				this.vdouble3509_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble3507_B'
			this.vdouble3507_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3507_B'
				this.vdouble3507_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble3505_B'
			this.vdouble3505_B = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3505_B'
				this.vdouble3505_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble3488_F'
			this.vdouble3488_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3488_F'
			...
			// Create array for replicates of 'vdouble3505_F'
			this.vdouble3505_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3505_F'
				this.vdouble3505_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble3507_F'
			this.vdouble3507_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3507_F'
				this.vdouble3507_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble3509_F'
			this.vdouble3509_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3509_F'
				this.vdouble3509_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble3511_F'
			this.vdouble3511_F = new Gaussian[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vdouble3511_F'
				this.vdouble3511_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'Under_performing_F'
			...
			// Create array for replicates of 'vbool574_rep_rep_rep_B'
			this.vbool574_rep_rep_rep_B = new Bernoulli[343][][];
			for(int nMatches = 0; nMatches<343; nMatches++) {
				// Create array for replicates of 'vbool574_rep_rep_rep_B'
				this.vbool574_rep_rep_rep_B[nMatches] = new Bernoulli[2][];
			}
		...
		public object Marginal(string variableName)
		{
			...
			if (variableName=="vbool574") {
				return this.Vbool574Marginal();
			}
			if (variableName=="vbool575") {
				return this.Vbool575Marginal();
			}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vbool574' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public Bernoulli Vbool574Marginal()
		{
			return this.vbool574_marginal_F;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vbool575' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public Bernoulli Vbool575Marginal()
		{
			return this.vbool575_marginal_F;
		}
