...
namespace Models
{
	...
	public partial class Model39_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__333 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__333</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__333_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__336 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__336</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__336_isDone;
		...
		/// <summary>True if Changed_vdouble__336 has executed. Set this to false to force re-execution of Changed_vdouble__336</summary>
		public bool Changed_vdouble__336_isDone;
		/// <summary>True if Changed_vdouble__337 has executed. Set this to false to force re-execution of Changed_vdouble__337</summary>
		public bool Changed_vdouble__337_isDone;
		...
		/// <summary>Message to marginal of 'vdouble__336'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__336_marginal_F;
		/// <summary>Field backing the vdouble__337 property</summary>
		private double[] Vdouble__337;
		...
		/// <summary>Message to marginal of 'vdouble__338'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__338_marginal_F;
		/// <summary>Buffer for VariablePointOp_Rprop.MarginalAverageConditional</summary>
		public RpropBufferData[] vdouble__338_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__333_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__336_isDone = false;
			}
		}
		...
		public double[] vdouble__336
		{
			...
			set {
				if ((value!=null)&&(value.Length!=3522)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3522)+" was expected for variable \'vdouble__336\'");
				}
				this.Vdouble__336 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__336_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__333_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__337'</summary>
		public double[] vdouble__337
		{
			get {
				return this.Vdouble__337;
			}
			set {
				if ((value!=null)&&(value.Length!=3522)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3522)+" was expected for variable \'vdouble__337\'");
				}
				this.Vdouble__337 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__337_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__333_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__336 and vdouble__337</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__333(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__333_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3522);
			for(int nPlayers = 0; nPlayers<3522; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3522);
			...
			for(int nPlayers = 0; nPlayers<3522; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__336[nPlayers], this.Vdouble__337[nPlayers]);
			}
			...
			Gaussian[] vdouble952_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
			...
			Gaussian[] vdouble952_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble952_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble950_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble950_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble950_B'
			Gaussian[] vdouble950_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble950_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble948_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble948_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble948_B'
			Gaussian[] vdouble948_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble948_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool245_B'
			Bernoulli[] vbool245_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool245_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool245' from Not factor
					vbool245_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble946_F'
			Gaussian[] vdouble946_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble946_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble946_B'
			Gaussian[] vdouble946_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble946_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool242_B'
			Bernoulli[] vbool242_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool242_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool242' from Not factor
					vbool242_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble952' from Difference factor
						vdouble952_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble952' from IsPositive factor
						vdouble952_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble952_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble952_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble950' from Difference factor
						vdouble950_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble950' from IsPositive factor
						vdouble950_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble950_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble950_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble948' from Difference factor
						vdouble948_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble948' from IsPositive factor
						vdouble948_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool245_B[nMatches], vdouble948_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble948_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble946' from Difference factor
						vdouble946_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble946' from IsPositive factor
						vdouble946_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool242_B[nMatches], vdouble946_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble946_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__333_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__336</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__336(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__336_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__338_F;
			// Create array for 'vdouble__338' Forwards messages.
			vdouble__338_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__338_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____80_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____80_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble920_F'
			Gaussian[][][] vdouble920_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble918_F'
			Gaussian[][][] vdouble918_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble924_F'
			Gaussian[] vdouble924_F = new Gaussian[500];
			// Create array for replicates of 'vdouble925_F'
			Gaussian[] vdouble925_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				// Create array for 'vdouble____80' Forwards messages.
				vdouble____80_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble918_F'
				vdouble918_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble920_F'
				vdouble920_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____80' Forwards messages.
					vdouble____80_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble918_F'
					vdouble918_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble920_F'
					vdouble920_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____80_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble918_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble918' from Gaussian factor
						vdouble918_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__336[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble920_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble920' from Product factor
						vdouble920_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble918_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____80' from Ratio factor
						vdouble____80_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble920_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble924_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble924' from Sum factor
				vdouble924_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____80_F[nMatches][0]);
				vdouble925_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble925' from Sum factor
				vdouble925_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____80_F[nMatches][1]);
				// Message to 'vdouble__338' from Difference factor
				vdouble__338_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble924_F[nMatches], vdouble925_F[nMatches]), string.Format("vdouble__338_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__338_use_B_reduced;
			vdouble__338_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__338_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__338_use_B_reduced, vdouble__338_F[nMatches], this.vdouble__338_marginal_F[nMatches], this.vdouble__338_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__338_marginal' from VariablePoint factor
					this.vdouble__338_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__338_use_B_reduced, vdouble__338_F[nMatches], this.vdouble__338_use_B_nMatches__buffer[nMatches], this.vdouble__338_marginal_F[nMatches]), string.Format("vdouble__338_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__336_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__336 and vdouble__337</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__336</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__338_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__338_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__336 and vdouble__337</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__336 and vdouble__337</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool246'
			bool[] vbool246 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool246[nMatches] = true;
					Constrain.Equal<bool>(true, vbool246[nMatches]);
				}
			}
			// Create array for replicates of 'vbool248'
			bool[] vbool248 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
			...
			// Create array for replicates of 'vbool250'
			bool[] vbool250 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool250[nMatches] = true;
					Constrain.Equal<bool>(true, vbool250[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__336</summary>
		private void Changed_vdouble__336()
		{
			if (this.Changed_vdouble__336_isDone) {
				return ;
			}
			// Create array for 'vdouble__336_marginal' Forwards messages.
			this.vdouble__336_marginal_F = new DistributionStructArray<Gaussian,double>(3522);
			for(int nPlayers = 0; nPlayers<3522; nPlayers++) {
				this.vdouble__336_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__336_marginal' from DerivedVariable factor
			this.vdouble__336_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__336, this.vdouble__336_marginal_F);
			this.Changed_vdouble__336_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__337</summary>
		private void Changed_vdouble__337()
		{
			if (this.Changed_vdouble__337_isDone) {
				return ;
			}
			// Create array for 'vdouble__337_marginal' Forwards messages.
			this.vdouble__337_marginal_F = new DistributionStructArray<Gaussian,double>(3522);
			for(int nPlayers = 0; nPlayers<3522; nPlayers++) {
				this.vdouble__337_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__337_marginal' from DerivedVariable factor
			this.vdouble__337_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__337, this.vdouble__337_marginal_F);
			this.Changed_vdouble__337_isDone = true;
		}
		...
		private void Constant()
		{
			...
			// Create array for 'vdouble__338_marginal' Forwards messages.
			this.vdouble__338_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__338_use_B_nMatches__buffer'
			this.vdouble__338_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3522);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__337();
			this.Changed_vdouble__336();
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__333(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__336(numberOfIterations);
		...
		public object Marginal(string variableName)
		{
			...
			if (variableName=="vdouble__338") {
				return this.Vdouble__338Marginal();
			}
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__337") {
				this.vdouble__337 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		{
			return this.vdouble__336_marginal_F;
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__338' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__338Marginal()
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__338_marginal_F);
		}
