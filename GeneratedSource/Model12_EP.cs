...
namespace Models
{
	...
	public partial class Model12_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_vdouble__106 has executed. Set this to false to force re-execution of Changed_vdouble__106</summary>
		public bool Changed_vdouble__106_isDone;
		...
		/// <summary>Field backing the vdouble__106 property</summary>
		private double[] Vdouble__106;
		...
		public double[] skills__gamma_
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7185)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7185)+" was expected for variable \'skills__gamma_\'");
				}
		...
		/// <summary>The externally-specified value of 'vdouble__106'</summary>
		public double[] vdouble__106
		{
			get {
				return this.Vdouble__106;
			}
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vdouble__106\'");
				}
				this.Vdouble__106 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__106_isDone = false;
			}
		}
		...
		public int[][] vint____18
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7185)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7185)+" was expected for variable \'vint____18\'");
				}
		...
		private void Changed_skills__gamma_()
		{
			...
			this.skills__gamma__marginal_F = new DistributionStructArray<Gaussian,double>(7185);
		...
		/// <summary>Computations that depend on the observed value of vdouble__106</summary>
		private void Changed_vdouble__106()
		{
			if (this.Changed_vdouble__106_isDone) {
				return ;
			}
			// Create array for 'vdouble__106_marginal' Forwards messages.
			this.vdouble__106_marginal_F = new DistributionStructArray<Gaussian,double>(200);
			for(int index48 = 0; index48<200; index48++) {
				this.vdouble__106_marginal_F[index48] = Gaussian.Uniform();
			}
			// Message to 'vdouble__106_marginal' from DerivedVariable factor
			this.vdouble__106_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__106, this.vdouble__106_marginal_F);
			this.Changed_vdouble__106_isDone = true;
		}
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__106") {
				this.vdouble__106 = (double[])value;
				return ;
			}
			if (variableName=="vbool__17") {
