...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 17:22 on giovedì 7 luglio 2022.
	/// </remarks>
	public partial class Model33_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423 has executed. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423</summary>
		public bool Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_isDone;
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211 has executed. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211_isDone;
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211 has performed initialisation. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211_isInitialised;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210</summary>
		public bool Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210</summary>
		public bool Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210_isInitialised;
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9_isInitialised;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8</summary>
		public bool Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8</summary>
		public bool Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8_isInitialised;
		...
		/// <summary>True if Changed_vdouble__423_vdouble__424 has executed. Set this to false to force re-execution of Changed_vdouble__423_vdouble__424</summary>
		public bool Changed_vdouble__423_vdouble__424_isDone;
		/// <summary>True if Changed_vdouble__424 has executed. Set this to false to force re-execution of Changed_vdouble__424</summary>
		public bool Changed_vdouble__424_isDone;
		...
		/// <summary>Field backing the vdouble__424 property</summary>
		private double[] Vdouble__424;
		...
		/// <summary>Message to marginal of 'vdouble__425'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__425_marginal_F;
		/// <summary>Buffer for VariablePointOp_Rprop.MarginalAverageConditional</summary>
		public RpropBufferData[] vdouble__425_use_B_nMatches__buffer;
		public double[][] vdouble1412_reduced;
		public double[][] vdouble1419_reduced;
		public double[][] vdouble1420_reduced;
		public Gaussian[][][] vdouble1421_F;
		public Gaussian[][][] vdouble1422_F;
		public double[][] vdouble1424_reduced;
		public double[][] vdouble1425_reduced;
		public Gaussian[][][] vdouble1426_B;
		public Gaussian[][][] vdouble1426_F;
		public Gaussian[][][] vdouble1427_B;
		public Gaussian[][][] vdouble1427_F;
		public Gaussian[][][] vdouble1430_F;
		public Gaussian[][][] vdouble1432_B;
		public Gaussian[][][] vdouble1432_F;
		public Gaussian[][][] vdouble1433_B;
		public Gaussian[][][] vdouble1433_F;
		public Gaussian[][][] vdouble1436_F;
		/// <summary>Message from use of 'vdouble1436'</summary>
		public Gaussian[][][] vdouble1436_use_B;
		public Gaussian[][][] vdouble1440_F;
		public Gaussian[][][] vdouble1442_B;
		public Gaussian[][][] vdouble1442_F;
		public Gaussian[][][] vdouble1443_B;
		public Gaussian[][][] vdouble1443_F;
		public Gaussian[][][] vdouble1446_F;
		/// <summary>Message from use of 'vdouble1446'</summary>
		public Gaussian[][][] vdouble1446_use_B;
		#endregion
		...
		public double[][][] deathcount
		{
			...
			set {
				if ((value!=null)&&(value.Length!=359)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+359)+" was expected for variable \'deathcount\'");
				}
				...
				this.Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210_isInitialised = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211_isInitialised = false;
		...
		public double[][][] killcount
		{
			...
			set {
				if ((value!=null)&&(value.Length!=359)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+359)+" was expected for variable \'killcount\'");
				}
		...
		public double[] Match_time_m
		{
			...
			set {
				if ((value!=null)&&(value.Length!=359)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+359)+" was expected for variable \'Match_time_m\'");
				}
				...
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210_isInitialised = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3_isDone = false;
				...
				this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_isDone = false;
			}
		}
		...
		public double[][][] p_time_m__t__n
		{
			...
			set {
				if ((value!=null)&&(value.Length!=359)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+359)+" was expected for variable \'p_time_m__t__n\'");
				}
				...
				this.Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3_isDone = false;
		...
		public int[][][] PlayerIndex
		{
			...
			set {
				if ((value!=null)&&(value.Length!=359)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+359)+" was expected for variable \'PlayerIndex\'");
				}
				...
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9_isDone = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
		...
		public int[][] PlayerInTeam
		{
			...
			set {
				if ((value!=null)&&(value.Length!=359)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+359)+" was expected for variable \'PlayerInTeam\'");
				}
		...
		public int[] team2wins
		{
			...
			set {
				if ((value!=null)&&(value.Length!=359)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+359)+" was expected for variable \'team2wins\'");
				}
		...
		public double[] vdouble__423
		{
			...
			set {
				if ((value!=null)&&(value.Length!=2412)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+2412)+" was expected for variable \'vdouble__423\'");
				}
				...
				this.Changed_numberOfIterationsDecreased_team2wins_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_17_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_7_isInitialised = false;
				this.Changed_vdouble__423_vdouble__424_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8_isDone = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9_isDone = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__424'</summary>
		public double[] vdouble__424
		{
			get {
				return this.Vdouble__424;
			}
			set {
				if ((value!=null)&&(value.Length!=2412)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+2412)+" was expected for variable \'vdouble__424\'");
				}
				this.Vdouble__424 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__424_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_17_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_7_isInitialised = false;
				this.Changed_vdouble__423_vdouble__424_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of deathcount and killcount and Match_time_m and numberOfIterations and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins and vdouble__423 and vdouble__424</summary>
		...
		private void Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3(int numberOfIterations)
		{
			...
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(2412);
			for(int nMatches = 0; nMatches<359; nMatches++) {
			...
			// Create array for replicates of 'vdouble1422_B'
			Gaussian[][][] vdouble1422_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1422_B'
				vdouble1422_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1422_B'
					vdouble1422_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble1422_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			// Create array for replicates of 'vdouble1421_B'
			Gaussian[][][] vdouble1421_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1421_B'
				vdouble1421_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1421_B'
					vdouble1421_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble1421_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			// Create array for replicates of 'SumTeam1_F'
			Gaussian[] SumTeam1_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				SumTeam1_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'SumTeam2_F'
			Gaussian[] SumTeam2_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				SumTeam2_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'Diff_F'
			Gaussian[] Diff_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				Diff_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble1459_F'
			Gaussian[] vdouble1459_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1459_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1459_B'
			Gaussian[] vdouble1459_B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1459_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'Diff_1__B'
			Gaussian[] Diff_1__B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
			...
			Gaussian[] Diff_B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				Diff_B[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble1457_F'
			Gaussian[] vdouble1457_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1457_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1457_B'
			Gaussian[] vdouble1457_B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1457_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'Diff_0__B'
			Gaussian[] Diff_0__B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
			...
			Gaussian[][] Diff_2__uses_F = new Gaussian[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
			...
			// Create array for replicates of 'vdouble1455_F'
			Gaussian[] vdouble1455_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1455_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1455_B'
			Gaussian[] vdouble1455_B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1455_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool209_B'
			Bernoulli[] vbool209_B = new Bernoulli[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool209_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool209' from Not factor
					vbool209_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1453_F'
			Gaussian[] vdouble1453_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1453_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1453_B'
			Gaussian[] vdouble1453_B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1453_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool206_B'
			Bernoulli[] vbool206_B = new Bernoulli[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool206_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool206' from Not factor
					vbool206_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'Diff_2__B'
			Gaussian[] Diff_2__B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
			...
			Gaussian[] SumTeam1_B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				SumTeam1_B[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'player_perf_t__n_item0_B'
			DistributionStructArray<Gaussian,double>[] player_perf_t__n_item0_B = new DistributionStructArray<Gaussian,double>[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
			...
			Gaussian[] SumTeam2_B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				SumTeam2_B[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'player_perf_t__n_item1_B'
			DistributionStructArray<Gaussian,double>[] player_perf_t__n_item1_B = new DistributionStructArray<Gaussian,double>[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
			...
			// Create array for replicates of 'vdouble1430_B'
			Gaussian[][][] vdouble1430_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1430_B'
				vdouble1430_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1430_B'
					vdouble1430_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1430_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble1440_B'
			Gaussian[][][] vdouble1440_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1440_B'
				vdouble1440_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1440_B'
					vdouble1440_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1440_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'perf_n_m_B'
			Gaussian[][][] perf_n_m_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'perf_n_m_B'
			...
			Gaussian[][][] perf_from_ds_use_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'perf_from_ds_use_B'
				...
				for(int nMatches = 0; nMatches<359; nMatches++) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							// Message to 'vdouble1430' from Product factor
							this.vdouble1430_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(2.5567203850565789, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble1433' from Plus factor
							this.vdouble1433_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble1430_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1432_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Product factor
							this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1433_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1436' from Gaussian factor
							this.vdouble1436_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1436_use' from Max factor
							this.vdouble1436_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Killcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble1436_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Gaussian factor
							this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble1436_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1433' from Product factor
							this.vdouble1433_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1432' from Plus factor
							this.vdouble1432_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble1433_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1430_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0] = GaussianProductOpBase.BAverageConditional(this.vdouble1432_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -0.54459509911730619);
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							// Message to 'vdouble1440' from Product factor
							this.vdouble1440_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-2.7928178121382596, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble1443' from Plus factor
							this.vdouble1443_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble1440_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1442_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Product factor
							this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1443_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1446' from Gaussian factor
							this.vdouble1446_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1446_use' from Max factor
							this.vdouble1446_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Deathcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble1446_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Gaussian factor
							this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble1446_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1443' from Product factor
							this.vdouble1443_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1442' from Plus factor
							this.vdouble1442_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble1443_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1440_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(this.vdouble1442_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.79084835337752024);
							// Message to 'player_perf_t__n_uses' from Replicate factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==0) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								vdouble1422_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1420_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1421' from Ratio factor
								vdouble1421_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble1422_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1421' from Sum factor
								this.vdouble1421_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_0_0_' from Sum factor
								this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble1421_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1421_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble1422' from Ratio factor
								this.vdouble1422_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble1421_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_0_' from Product factor
								this.Perfomance_opposing_team_0__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1420_reduced[nMatches][nTeamsPerMatch], this.vdouble1422_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							}
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble1459' from Difference factor
						vdouble1459_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062759999999999996, Diff_F[nMatches]);
						// Message to 'vdouble1459' from IsPositive factor
						vdouble1459_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1459_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062759999999999996, vdouble1459_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble1457' from Difference factor
						vdouble1457_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062759999999999996);
						// Message to 'vdouble1457' from IsPositive factor
						vdouble1457_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1457_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1457_B[nMatches], 0.062759999999999996);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1455' from Difference factor
						vdouble1455_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062759999999999996, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1455' from IsPositive factor
						vdouble1455_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool209_B[nMatches], vdouble1455_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062759999999999996, vdouble1455_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1453' from Difference factor
						vdouble1453_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062759999999999996);
						// Message to 'vdouble1453' from IsPositive factor
						vdouble1453_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool206_B[nMatches], vdouble1453_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1453_B[nMatches], 0.062759999999999996);
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==1) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'Perfomance_opposing_team' from Replicate factor
								this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = ReplicateOp_NoDivide.DefAverageConditional<Gaussian>(this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble1427' from Product factor
								this.vdouble1427_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1425_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1426' from Ratio factor
								this.vdouble1426_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(this.vdouble1427_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1426' from Sum factor
								this.vdouble1426_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_1_1_' from Sum factor
								this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(this.vdouble1426_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1426_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble1427' from Ratio factor
								this.vdouble1427_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble1426_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_1_' from Product factor
								this.Perfomance_opposing_team_1__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1425_reduced[nMatches][nTeamsPerMatch], this.vdouble1427_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							// Message to 'vdouble1432' from Product factor
							this.vdouble1432_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-0.54459509911730619, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							// Message to 'vdouble1430' from Plus factor
							vdouble1430_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble1433_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1432_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1442' from Product factor
							this.vdouble1442_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(0.79084835337752024, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble1440' from Plus factor
							vdouble1440_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble1443_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1442_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						}
						if (nTeamsPerMatch==1) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble1430_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 2.5567203850565789);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = GaussianProductOpBase.BAverageConditional(vdouble1440_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -2.7928178121382596);
			...
			for(int nPlayers = 0; nPlayers<2412; nPlayers++) {
		...
		/// <summary>Computations that depend on the observed value of deathcount and killcount and Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__423 and vdouble__424 and must reset on changes to team2wins</summary>
		...
		private void Changed_deathcount_PlayerInTeam()
		{
			...
			this.deathcount_marginal_F = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,double[][]>(359);
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'deathcount_marginal' Forwards messages.
		...
		/// <summary>Computations that depend on the observed value of killcount and Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__423 and vdouble__424 and must reset on changes to deathcount and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_killcount_PlayerInTeam()
		{
			...
			this.killcount_marginal_F = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,double[][]>(359);
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'killcount_marginal' Forwards messages.
		...
		private void Changed_Match_time_m()
		{
			...
			this.Match_time_m_marginal_F = new DistributionStructArray<Gaussian,double>(359);
			for(int nMatches = 0; nMatches<359; nMatches++) {
		...
		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterations and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__423</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423(int numberOfIterations)
		{
			if (this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__425_F;
			// Create array for 'vdouble__425' Forwards messages.
			vdouble__425_F = new DistributionStructArray<Gaussian,double>(359);
			for(int nMatches = 0; nMatches<359; nMatches++) {
				vdouble__425_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____138_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____138_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[359];
			// Create array for replicates of 'vdouble1397_F'
			Gaussian[] vdouble1397_F = new Gaussian[359];
			// Create array for replicates of 'vdouble1396_F'
			Gaussian[] vdouble1396_F = new Gaussian[359];
			// Create array for replicates of 'vdouble1392_F'
			Gaussian[][][] vdouble1392_F = new Gaussian[359][][];
			// Create array for replicates of 'vdouble1390_F'
			Gaussian[][][] vdouble1390_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'vdouble____138' Forwards messages.
				vdouble____138_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble1392_F'
				vdouble1392_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1390_F'
				vdouble1390_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____138' Forwards messages.
					vdouble____138_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble1390_F'
					vdouble1390_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1392_F'
					vdouble1392_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____138_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1390_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1390' from Gaussian factor
						vdouble1390_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__423[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1392_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1392' from Product factor
						vdouble1392_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1390_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____138' from Ratio factor
						vdouble____138_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1392_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.match_time_m[nMatches]);
					}
				}
				vdouble1396_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1396' from Sum factor
				vdouble1396_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____138_F[nMatches][0]);
				vdouble1397_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1397' from Sum factor
				vdouble1397_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____138_F[nMatches][1]);
				// Message to 'vdouble__425' from Difference factor
				vdouble__425_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1396_F[nMatches], vdouble1397_F[nMatches]), string.Format("vdouble__425_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__425_use_B_reduced;
			vdouble__425_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<359; nMatches++) {
					this.vdouble__425_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__425_use_B_reduced, vdouble__425_F[nMatches], this.vdouble__425_marginal_F[nMatches], this.vdouble__425_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__425_marginal' from VariablePoint factor
					this.vdouble__425_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__425_use_B_reduced, vdouble__425_F[nMatches], this.vdouble__425_use_B_nMatches__buffer[nMatches], this.vdouble__425_marginal_F[nMatches]), string.Format("vdouble__425_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__423 and vdouble__424 and must reset on changes to deathcount and killcount and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211(bool initialise)
		{
			if (this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211_isDone&&((!initialise)||this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<359; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211_isDone = true;
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211_isInitialised = true;
		}
			...
			for(int nMatches = 0; nMatches<359; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble1425_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble1424_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
						this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble1412_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						if (nTeamsPerMatch==0) {
							this.vdouble1420_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble1419_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins and vdouble__423 and vdouble__424</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__423</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdoubl2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<359; nMatches++) {
				this.vdouble__425_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__425_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__423 and vdouble__424 and must reset on changes to deathcount and killcount and Match_time_m and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<359; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210_isDone = true;
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerIndex and PlayerInTeam and vdouble__423 and vdouble__424 and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Message to 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' from GetDeepJaggedItems factor
			...
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9_isDone = true;
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and team2wins and vdouble__423 and vdouble__424</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
			...
			for(int nMatches = 0; nMatches<359; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble1430_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1433_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1432_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==1) {
							...
							this.vdouble1427_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble1432_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1433_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1436_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1436_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==0) {
							...
							this.vdouble1422_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble1442_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1440_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1443_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1446_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1446_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1443_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1442_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						if (nTeamsPerMatch==1) {
							this.vdouble1426_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble1427_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__423 and vdouble__424</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and vdouble__423 and vdouble__424 and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8_isInitialised)) {
				return ;
			}
			this.skills_prior_use_F_marginal = GetDeepJaggedItemsOp<double>.Marginal<DistributionStructArray<Gaussian,double>,Gaussian>(this.skills_prior_F, this.skills_prior_use_B, this.skills_prior_use_F_marginal);
			this.Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8_isDone = true;
			this.Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8_isInitialised = true;
		}
		...
		private void Changed_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<359; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble1424_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][0]);
						}
						this.vdouble1412_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][nTeamsPerMatch]);
					}
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
					...
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==0) {
							this.vdouble1419_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][1]);
						}
					}
				}
			}
			// Create array for 'p_time_m__t__n_marginal' Forwards messages.
			this.p_time_m__t__n_marginal_F = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,double[][]>(359);
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'p_time_m__t__n_marginal' Forwards messages.
		...
		private void Changed_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<359; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					// Create array for replicates of 'vdouble1430_F'
					this.vdouble1430_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1433_F'
					this.vdouble1433_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1432_F'
					this.vdouble1432_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble1424_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble1425_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble1427_F'
					this.vdouble1427_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble1412_reduced[nMatches][nTeamsPerMatch] = default(double);
					...
					this.vdouble1432_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1433_B'
					this.vdouble1433_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1436_use_B'
					this.vdouble1436_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1436_F'
					this.vdouble1436_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble1419_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble1420_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble1422_F'
					this.vdouble1422_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble1442_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1440_F'
					this.vdouble1440_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1443_B'
					this.vdouble1443_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1446_use_B'
					this.vdouble1446_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1446_F'
					this.vdouble1446_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1443_F'
					this.vdouble1443_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1442_F'
					this.vdouble1442_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1427_B'
					this.vdouble1427_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				}
			}
		...
		private void Changed_team2wins()
		{
			...
			this.Diff_2__uses_B = new Gaussian[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
			...
			// Create array for replicates of 'vbool207'
			bool[] vbool207 = new bool[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool207[nMatches] = true;
					Constrain.Equal<bool>(true, vbool207[nMatches]);
				}
			}
			// Create array for replicates of 'vbool210'
			bool[] vbool210 = new bool[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool210[nMatches] = true;
					Constrain.Equal<bool>(true, vbool210[nMatches]);
				}
			}
			// Create array for replicates of 'vbool212'
			bool[] vbool212 = new bool[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vbool212[nMatches] = true;
					Constrain.Equal<bool>(true, vbool212[nMatches]);
				}
			}
			// Create array for replicates of 'vbool214'
			bool[] vbool214 = new bool[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
		...
		private void Changed_vdouble__423()
		{
			...
			this.vdouble__423_marginal_F = new DistributionStructArray<Gaussian,double>(2412);
			for(int nPlayers = 0; nPlayers<2412; nPlayers++) {
		...
		/// <summary>Computations that depend on the observed value of vdouble__423 and vdouble__424</summary>
		private void Changed_vdouble__423_vdouble__424()
		{
			if (this.Changed_vdouble__423_vdouble__424_isDone) {
				return ;
			}
			for(int nPlayers = 0; nPlayers<2412; nPlayers++) {
				// Message to 'skills_prior' from Gaussian factor
				this.skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__423[nPlayers], this.Vdouble__424[nPlayers]);
			}
			this.Changed_vdouble__423_vdouble__424_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__424</summary>
		private void Changed_vdouble__424()
		{
			if (this.Changed_vdouble__424_isDone) {
				return ;
			}
			// Create array for 'vdouble__424_marginal' Forwards messages.
			this.vdouble__424_marginal_F = new DistributionStructArray<Gaussian,double>(2412);
			for(int nPlayers = 0; nPlayers<2412; nPlayers++) {
				this.vdouble__424_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__424_marginal' from DerivedVariable factor
			this.vdouble__424_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__424, this.vdouble__424_marginal_F);
			this.Changed_vdouble__424_isDone = true;
		}
		...
		private void Constant()
		{
			...
			// Create array for 'vdouble__425_marginal' Forwards messages.
			this.vdouble__425_marginal_F = new DistributionStructArray<Gaussian,double>(359);
			// Create array for replicates of 'vdouble__425_use_B_nMatches__buffer'
			this.vdouble__425_use_B_nMatches__buffer = new RpropBufferData[359];
			// Create array for 'skills_prior' Forwards messages.
			this.skills_prior_F = new DistributionStructArray<Gaussian,double>(2412);
			for(int nPlayers = 0; nPlayers<2412; nPlayers++) {
				this.skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(2412);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Forwards messages.
			this.skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam__F = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,double[][]>(359);
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Forwards messages.
			...
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
			this.skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam__B = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,double[][]>(359);
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
			...
			// Create array for replicates of 'perf_from_ds_F'
			this.perf_from_ds_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'perf_from_ds_F'
				this.perf_from_ds_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'perf_n_m_F'
			this.perf_n_m_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'perf_n_m_F'
				this.perf_n_m_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'player_perf_t__n_F'
			this.player_perf_t__n_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'player_perf_t__n' Forwards messages.
				this.player_perf_t__n_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
			}
			// Create array for replicates of 'player_perf_t__n_uses_F_nTeamsPerMatch__nPlayersMinusPerTeam__marginal'
			this.player_perf_t__n_uses_F_nTeamsPerMatch__nPlayersMinusPerTeam__marginal = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'player_perf_t__n_uses_F_nTeamsPerMatch__nPlayersMinusPerTeam__marginal'
				this.player_perf_t__n_uses_F_nTeamsPerMatch__nPlayersMinusPerTeam__marginal[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'player_perf_t__n_uses_B_nTeamsPerMatch__nPlayersMinusPerTeam__toDef'
			this.player_perf_t__n_uses_B_nTeamsPerMatch__nPlayersMinusPerTeam__toDef = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'player_perf_t__n_uses_B_nTeamsPerMatch__nPlayersMinusPerTeam__toDef'
			...
			this.player_perf_t__n_uses_F = new Gaussian[359][][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'player_perf_t__n_uses' Forwards messages.
				this.player_perf_t__n_uses_F[nMatches] = new Gaussian[2][][];
			}
			// Create array for replicates of 'player_perf_t__n_uses_B'
			this.player_perf_t__n_uses_B = new Gaussian[359][][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'player_perf_t__n_uses' Backwards messages.
				this.player_perf_t__n_uses_B[nMatches] = new Gaussian[2][][];
			}
			// Create array for replicates of 'vdouble1430_F'
			this.vdouble1430_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1430_F'
				this.vdouble1430_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1433_F'
			this.vdouble1433_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1433_F'
				this.vdouble1433_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1432_F'
			this.vdouble1432_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1432_F'
				this.vdouble1432_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'Perfomance_opposing_team_uses_F'
			this.Perfomance_opposing_team_uses_F = new Gaussian[359][][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'Perfomance_opposing_team_uses_F'
				this.Perfomance_opposing_team_uses_F[nMatches] = new Gaussian[2][][];
			}
			// Create array for replicates of 'Perfomance_opposing_team_1__F'
			this.Perfomance_opposing_team_1__F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'Perfomance_opposing_team_1__F'
				this.Perfomance_opposing_team_1__F[nMatches] = new Gaussian[2][];
			}
			this.vdouble1425_reduced = new double[359][];
			this.vdouble1424_reduced = new double[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				this.vdouble1424_reduced[nMatches] = new double[2];
				this.vdouble1425_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble1427_F'
			this.vdouble1427_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1427_F'
				this.vdouble1427_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1426_F'
			this.vdouble1426_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1426_F'
				this.vdouble1426_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'player_perf_t__n_item1_rep_F'
			this.player_perf_t__n_item1_rep_F = new DistributionStructArray<Gaussian,double>[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'player_perf_t__n_item1_rep_F'
			...
			this.player_perf_t__n_item1_rep_F_marginal = new DistributionStructArray<Gaussian,double>[359][];
			// Create array for replicates of 'player_perf_t__n_item1_uses_F'
			this.player_perf_t__n_item1_uses_F = new DistributionStructArray<Gaussian,double>[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'player_perf_t__n_item1_uses' Forwards messages.
			...
			this.player_perf_t__n_depth1_F = new DistributionStructArray<Gaussian,double>[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'player_perf_t__n_depth1' Forwards messages.
			...
			this.player_perf_t__n_item1_uses_B = new DistributionStructArray<Gaussian,double>[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'player_perf_t__n_item1_uses' Backwards messages.
			...
			this.player_perf_t__n_item1_rep_B_toDef = new DistributionStructArray<Gaussian,double>[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'player_perf_t__n_item1_rep_B_toDef'
				this.player_perf_t__n_item1_rep_B_toDef[nMatches] = new DistributionStructArray<Gaussian,double>[2];
			}
			// Create array for replicates of 'player_perf_t__n_1_1__B'
			this.player_perf_t__n_1_1__B = new DistributionStructArray<Gaussian,double>[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'player_perf_t__n_1_1__B'
				this.player_perf_t__n_1_1__B[nMatches] = new DistributionStructArray<Gaussian,double>[2][];
			}
			this.Avg_play_time_team_reduced = new double[359][];
			this.vdouble1412_reduced = new double[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				this.vdouble1412_reduced[nMatches] = new double[2];
				this.Avg_play_time_team_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'Perfomance_opposing_team_uses_B'
			this.Perfomance_opposing_team_uses_B = new Gaussian[359][][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'Perfomance_opposing_team_uses_B'
				this.Perfomance_opposing_team_uses_B[nMatches] = new Gaussian[2][][];
			}
			// Create array for replicates of 'vdouble1432_B'
			this.vdouble1432_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1432_B'
				this.vdouble1432_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1433_B'
			this.vdouble1433_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1433_B'
				this.vdouble1433_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_B'
			this.kill_count_m__t__n_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'kill_count_m__t__n_B'
				this.kill_count_m__t__n_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1436_use_B'
			this.vdouble1436_use_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1436_use_B'
				this.vdouble1436_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1436_F'
			this.vdouble1436_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1436_F'
				this.vdouble1436_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_F'
			this.kill_count_m__t__n_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'kill_count_m__t__n_F'
				this.kill_count_m__t__n_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vc_Times_p_time'
			this.vc_Times_p_time = new double[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vc_Times_p_time'
				this.vc_Times_p_time[nMatches] = new double[2][];
			}
			// Create array for replicates of 'Perfomance_opposing_team_F'
			this.Perfomance_opposing_team_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'Perfomance_opposing_team_F'
				this.Perfomance_opposing_team_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'Perfomance_opposing_team_0__F'
			this.Perfomance_opposing_team_0__F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'Perfomance_opposing_team_0__F'
				this.Perfomance_opposing_team_0__F[nMatches] = new Gaussian[2][];
			}
			this.vdouble1419_reduced = new double[359][];
			this.vdouble1420_reduced = new double[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				this.vdouble1419_reduced[nMatches] = new double[2];
				this.vdouble1420_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble1422_F'
			this.vdouble1422_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1422_F'
				this.vdouble1422_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1421_F'
			this.vdouble1421_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1421_F'
				this.vdouble1421_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'player_perf_t__n_item0_rep_F'
			this.player_perf_t__n_item0_rep_F = new DistributionStructArray<Gaussian,double>[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'player_perf_t__n_item0_rep_F'
			...
			this.player_perf_t__n_item0_rep_F_marginal = new DistributionStructArray<Gaussian,double>[359][];
			// Create array for replicates of 'player_perf_t__n_item0_uses_F'
			this.player_perf_t__n_item0_uses_F = new DistributionStructArray<Gaussian,double>[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'player_perf_t__n_item0_uses' Forwards messages.
			...
			this.player_perf_t__n_item0_uses_B = new DistributionStructArray<Gaussian,double>[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'player_perf_t__n_item0_uses' Backwards messages.
			...
			this.player_perf_t__n_item0_rep_B_toDef = new DistributionStructArray<Gaussian,double>[359][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'player_perf_t__n_item0_rep_B_toDef'
				this.player_perf_t__n_item0_rep_B_toDef[nMatches] = new DistributionStructArray<Gaussian,double>[2];
			}
			// Create array for replicates of 'player_perf_t__n_0_0__B'
			this.player_perf_t__n_0_0__B = new DistributionStructArray<Gaussian,double>[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'player_perf_t__n_0_0__B'
				this.player_perf_t__n_0_0__B[nMatches] = new DistributionStructArray<Gaussian,double>[2][];
			}
			// Create array for replicates of 'Perfomance_opposing_team_B'
			this.Perfomance_opposing_team_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'Perfomance_opposing_team_B'
				this.Perfomance_opposing_team_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1442_B'
			this.vdouble1442_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1442_B'
				this.vdouble1442_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1440_F'
			this.vdouble1440_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1440_F'
				this.vdouble1440_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1443_B'
			this.vdouble1443_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1443_B'
				this.vdouble1443_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'death_count_m__t__n_B'
			this.death_count_m__t__n_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'death_count_m__t__n_B'
				this.death_count_m__t__n_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1446_use_B'
			this.vdouble1446_use_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1446_use_B'
				this.vdouble1446_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1446_F'
			this.vdouble1446_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1446_F'
				this.vdouble1446_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'death_count_m__t__n_F'
			this.death_count_m__t__n_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'death_count_m__t__n_F'
				this.death_count_m__t__n_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1443_F'
			this.vdouble1443_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1443_F'
				this.vdouble1443_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1442_F'
			this.vdouble1442_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1442_F'
				this.vdouble1442_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1426_B'
			this.vdouble1426_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1426_B'
				this.vdouble1426_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1427_B'
			this.vdouble1427_B = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'vdouble1427_B'
				this.vdouble1427_B[nMatches] = new Gaussian[2][];
			}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__423_vdouble__424();
			this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4(initialise);
			this.Changed_numberOfIterationsDecreased_vdouble__423_vdouble__424_Init_deathcount_killcount_Match_time_m8(initialise);
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__424_Init_deathcou9(initialise);
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423_vdouble__4210(initialise);
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4211(initialise);
			...
			this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__423(numberOfIterations);
		...
		public object Marginal(string variableName)
		{
			...
			if (variableName=="vdouble__425") {
				return this.Vdouble__425Marginal();
			}
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__424") {
				this.vdouble__424 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__425' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__425Marginal()
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__425_marginal_F);
		}
