...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 13:18 on mercoledì 13 luglio 2022.
	/// </remarks>
	public partial class Model118_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_numberOfIterations_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint____122 has executed. Set this to false to force re-execution of Changed_numberOfIterations_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint____122</summary>
		public bool Changed_numberOfIterations_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint____122_isDone;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16</summary>
		public bool Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16</summary>
		public bool Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16_isInitialised;
		...
		/// <summary>True if Changed_vdouble__1044 has executed. Set this to false to force re-execution of Changed_vdouble__1044</summary>
		public bool Changed_vdouble__1044_isDone;
		/// <summary>True if Changed_vdouble__1058 has executed. Set this to false to force re-execution of Changed_vdouble__1058</summary>
		public bool Changed_vdouble__1058_isDone;
		/// <summary>True if Changed_vint____122 has executed. Set this to false to force re-execution of Changed_vint____122</summary>
		public bool Changed_vint____122_isDone;
		...
		/// <summary>Message to marginal of 'vdouble__1044'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__1044_marginal_F;
		/// <summary>Field backing the vdouble__1058 property</summary>
		private double[] Vdouble__1058;
		/// <summary>Message to marginal of 'vdouble__1058'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__1058_marginal_F;
		/// <summary>Message to marginal of 'vdouble__1060'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__1060_marginal_F;
		...
		/// <summary>Field backing the vint____122 property</summary>
		private int[][] Vint____122;
		/// <summary>Message to marginal of 'vint____122'</summary>
		public PointMass<int[][]> vint____122_marginal_F;
		#endregion
		...
		public int[][][] PlayerIndex
		{
			...
			set {
				...
				this.Changed_draw_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_Playe6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16_isInitialised = false;
				this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint____122_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_deathcount_draw_killcount_Match_time_m_p_time_m__t__n_Playe1_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_draw_killcount_Match_time_m_p_time_3_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerInTeam_Init_deathcount_draw_killcount_Match12_isInitialised = false;
		...
		public double[] vdouble__1044
		{
			...
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vdouble__1044\'");
				}
				this.Vdouble__1044 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__1044_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16_isInitialised = false;
				this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint____122_isDone = false;
			}
		}

		/// <summary>The externally-specified value of 'vdouble__1058'</summary>
		public double[] vdouble__1058
		{
			get {
				return this.Vdouble__1058;
			}
			set {
				if ((value!=null)&&(value.Length!=6668)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6668)+" was expected for variable \'vdouble__1058\'");
				}
				this.Vdouble__1058 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__1058_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16_isInitialised = false;
				this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint____122_isDone = false;
			}
		}

		/// <summary>The externally-specified value of 'vint____122'</summary>
		public int[][] vint____122
		{
			get {
				return this.Vint____122;
			}
			set {
				if ((value!=null)&&(value.Length!=6668)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6668)+" was expected for variable \'vint____122\'");
				}
				this.Vint____122 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vint____122_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16_isInitialised = false;
				this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint____122_isDone = false;
			}
		}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterations and PlayerIndex and PlayerInTeam and vdouble__1044 and vdouble__1058 and vint____122</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_numberOfIterations_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint____122(int numberOfIterations)
		{
			if (this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint____122_isDone) {
				return ;
			}
			...
			// Create array for replicates of 'vint1430'
			int[][][] vint1430 = new int[1000][][];
			// Create array for replicates of 'vdouble3630'
			double[][][] vdouble3630 = new double[1000][][];
			// Create array for replicates of 'vdouble3631_B'
			Gamma[][][] vdouble3631_B = new Gamma[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vint1430'
				vint1430[nMatches] = new int[2][];
				// Create array for replicates of 'vdouble3631_B'
				vdouble3631_B[nMatches] = new Gamma[2][];
				// Create array for replicates of 'vdouble3630'
				vdouble3630[nMatches] = new double[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vint1430'
					vint1430[nMatches][nTeamsPerMatch] = new int[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble3630'
					vdouble3630[nMatches][nTeamsPerMatch] = new double[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble3631_B'
					vdouble3631_B[nMatches][nTeamsPerMatch] = new Gamma[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vint1430[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Math.Min(199, this.Vint____122[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]][nMatches]);
						vdouble3630[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Factor.Plus(this.Vdouble__1058[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], this.Vdouble__1044[vint1430[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]]);
						vdouble3631_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gamma.Uniform();
						// Message to 'vdouble3631' from Gaussian factor
						vdouble3631_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.PrecisionAverageConditional(this.Vdouble__1058[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], vdouble3630[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
					}
				}
			}
			// Create array for replicates of 'vdouble3631_B_Q'
			Gamma[][][] vdouble3631_B_Q = new Gamma[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble3631_B_Q'
				vdouble3631_B_Q[nMatches] = new Gamma[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble3631_B_Q'
					vdouble3631_B_Q[nMatches][nTeamsPerMatch] = new Gamma[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble3631_B_Q[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = default(Gamma);
					}
				}
			}
				...
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							vdouble3631_B_Q[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GammaProductOp_Laplace.Q(vdouble3631_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], _gamma_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], _gamma_rep2_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to '_gamma_rep2_rep_rep' from Product factor
							_gamma_rep2_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Tracing.FireEvent<Gamma>(GammaProductOp_Laplace.BAverageConditional(vdouble3631_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], _gamma_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], _gamma_rep2_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble3631_B_Q[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]), string.Format("_gamma_rep2_rep_rep_B[{0}]", new object[1] {nPlayersMinusPerTeam}), this.OnMessageUpdated, false);
							// Message to '_gamma_rep_rep_rep' from Product factor
							_gamma_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Tracing.FireEvent<Gamma>(GammaProductOp_Laplace.AAverageConditional(vdouble3631_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], _gamma_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], _gamma_rep2_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble3631_B_Q[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]), string.Format("_gamma_rep_rep_rep_B[{0}]", new object[1] {nPlayersMinusPerTeam}), this.OnMessageUpdated, false);
						}
			...
			this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint____122_isDone = true;
		}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to PlayerIndex and PlayerInTeam and vdouble__1044 and vdouble__1058 and vint____122</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16_isInitialised)) {
				return ;
			}
			...
			this.Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16_isDone = true;
			this.Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16_isInitialised = true;
		}
		...
		/// <summary>Computations that depend on the observed value of vdouble__1044</summary>
		private void Changed_vdouble__1044()
		{
			if (this.Changed_vdouble__1044_isDone) {
				return ;
			}
			// Create array for 'vdouble__1044_marginal' Forwards messages.
			this.vdouble__1044_marginal_F = new DistributionStructArray<Gaussian,double>(200);
			for(int index392 = 0; index392<200; index392++) {
				this.vdouble__1044_marginal_F[index392] = Gaussian.Uniform();
			}
			// Message to 'vdouble__1044_marginal' from DerivedVariable factor
			this.vdouble__1044_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__1044, this.vdouble__1044_marginal_F);
			this.Changed_vdouble__1044_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__1058</summary>
		private void Changed_vdouble__1058()
		{
			if (this.Changed_vdouble__1058_isDone) {
				return ;
			}
			// Create array for 'vdouble__1058_marginal' Forwards messages.
			this.vdouble__1058_marginal_F = new DistributionStructArray<Gaussian,double>(6668);
			for(int nPlayers = 0; nPlayers<6668; nPlayers++) {
				this.vdouble__1058_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__1058_marginal' from DerivedVariable factor
			this.vdouble__1058_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__1058, this.vdouble__1058_marginal_F);
			// Create array for 'vdouble__1060_marginal' Forwards messages.
			this.vdouble__1060_marginal_F = new DistributionStructArray<Gaussian,double>(6668);
			for(int nPlayers = 0; nPlayers<6668; nPlayers++) {
				this.vdouble__1060_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__1060_marginal' from DerivedVariable factor
			this.vdouble__1060_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__1058, this.vdouble__1060_marginal_F);
			this.Changed_vdouble__1058_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vint____122</summary>
		private void Changed_vint____122()
		{
			if (this.Changed_vint____122_isDone) {
				return ;
			}
			// Create array for 'vint____122_marginal' Forwards messages.
			this.vint____122_marginal_F = new PointMass<int[][]>(this.Vint____122);
			// Message to 'vint____122_marginal' from DerivedVariable factor
			this.vint____122_marginal_F = DerivedVariableOp.MarginalAverageConditional<PointMass<int[][]>,int[][]>(this.Vint____122, this.vint____122_marginal_F);
			this.Changed_vint____122_isDone = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			if (numberOfIterations!=this.numberOfIterationsDone) {
				if (numberOfIterations<this.numberOfIterationsDone) {
					this.numberOfIterationsDone = 0;
					this.Changed_draw_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_Playe6_isDone = false;
					this.Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16_isDone = false;
			...
			this.Changed_vdouble__1058();
			this.Changed_vdouble__1044();
			this.Changed_vint____122();
			...
			this.Constant();
			this.Changed_numberOfIterationsDecreased_Init_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint__16(initialise);
			this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_vdouble__1044_vdouble__1058_vint____122(numberOfIterations);
		...
		public object GetObservedValue(string variableName)
		{
			...
			if (variableName=="vint____122") {
				return this.vint____122;
			}
			if (variableName=="vdouble__1044") {
				return this.vdouble__1044;
			}
			if (variableName=="vdouble__1058") {
				return this.vdouble__1058;
			}
		...
		{
			if (variableName=="vdouble__1058") {
				return this.Vdouble__1058Marginal();
			}
			if (variableName=="vdouble__1060") {
				return this.Vdouble__1060Marginal();
			}
			if (variableName=="vdouble__1044") {
				return this.Vdouble__1044Marginal();
			}
			if (variableName=="vint____122") {
				return this.Vint____122Marginal();
			}
			if (variableName=="quit") {
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__1058") {
				this.vdouble__1058 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		{
			return this.vdouble__1044_marginal_F;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vdouble__1058' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__1058Marginal()
		{
			return this.vdouble__1058_marginal_F;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vdouble__1060' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__1060Marginal()
		{
			return this.vdouble__1060_marginal_F;
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vint____122' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public PointMass<int[][]> Vint____122Marginal()
		{
			return this.vint____122_marginal_F;
		}
