...
namespace Models
{
	...
	public partial class Model162_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_vdouble__1417 has executed. Set this to false to force re-execution of Changed_vdouble__1417</summary>
		public bool Changed_vdouble__1417_isDone;
		...
		/// <summary>True if Changed_vdouble__1443 has executed. Set this to false to force re-execution of Changed_vdouble__1443</summary>
		public bool Changed_vdouble__1443_isDone;
		/// <summary>True if Changed_vint____166 has executed. Set this to false to force re-execution of Changed_vint____166</summary>
		public bool Changed_vint____166_isDone;
		...
		/// <summary>Field backing the vdouble__1417 property</summary>
		private double[] Vdouble__1417;
		/// <summary>Message to marginal of 'vdouble__1417'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__1417_marginal_F;
		...
		/// <summary>Field backing the vdouble__1443 property</summary>
		private double[] Vdouble__1443;
		/// <summary>Message to marginal of 'vdouble__1443'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__1443_marginal_F;
		/// <summary>Message to marginal of 'vdouble__1445'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__1445_marginal_F;
		...
		/// <summary>Field backing the vint____166 property</summary>
		private int[][] Vint____166;
		/// <summary>Message to marginal of 'vint____166'</summary>
		public PointMass<int[][]> vint____166_marginal_F;
		...
		/// <summary>The externally-specified value of 'vdouble__1417'</summary>
		public double[] vdouble__1417
		{
			get {
				return this.Vdouble__1417;
			}
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vdouble__1417\'");
				}
				this.Vdouble__1417 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__1417_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__1443'</summary>
		public double[] vdouble__1443
		{
			get {
				return this.Vdouble__1443;
			}
			set {
				if ((value!=null)&&(value.Length!=6617)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6617)+" was expected for variable \'vdouble__1443\'");
				}
				this.Vdouble__1443 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__1443_isDone = false;
			}
		}

		/// <summary>The externally-specified value of 'vint____166'</summary>
		public int[][] vint____166
		{
			get {
				return this.Vint____166;
			}
			set {
				if ((value!=null)&&(value.Length!=6617)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6617)+" was expected for variable \'vint____166\'");
				}
				this.Vint____166 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vint____166_isDone = false;
			}
		}
		...
		/// <summary>Computations that depend on the observed value of vdouble__1417</summary>
		private void Changed_vdouble__1417()
		{
			if (this.Changed_vdouble__1417_isDone) {
				return ;
			}
			// Create array for 'vdouble__1417_marginal' Forwards messages.
			this.vdouble__1417_marginal_F = new DistributionStructArray<Gaussian,double>(200);
			for(int index533 = 0; index533<200; index533++) {
				this.vdouble__1417_marginal_F[index533] = Gaussian.Uniform();
			}
			// Message to 'vdouble__1417_marginal' from DerivedVariable factor
			this.vdouble__1417_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__1417, this.vdouble__1417_marginal_F);
			this.Changed_vdouble__1417_isDone = true;
		}
		...
		/// <summary>Computations that depend on the observed value of vdouble__1443</summary>
		private void Changed_vdouble__1443()
		{
			if (this.Changed_vdouble__1443_isDone) {
				return ;
			}
			// Create array for 'vdouble__1443_marginal' Forwards messages.
			this.vdouble__1443_marginal_F = new DistributionStructArray<Gaussian,double>(6617);
			for(int nPlayers = 0; nPlayers<6617; nPlayers++) {
				this.vdouble__1443_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__1443_marginal' from DerivedVariable factor
			this.vdouble__1443_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__1443, this.vdouble__1443_marginal_F);
			// Create array for 'vdouble__1445_marginal' Forwards messages.
			this.vdouble__1445_marginal_F = new DistributionStructArray<Gaussian,double>(6617);
			for(int nPlayers = 0; nPlayers<6617; nPlayers++) {
				this.vdouble__1445_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__1445_marginal' from DerivedVariable factor
			this.vdouble__1445_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__1443, this.vdouble__1445_marginal_F);
			this.Changed_vdouble__1443_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vint____166</summary>
		private void Changed_vint____166()
		{
			if (this.Changed_vint____166_isDone) {
				return ;
			}
			// Create array for 'vint____166_marginal' Forwards messages.
			this.vint____166_marginal_F = new PointMass<int[][]>(this.Vint____166);
			// Message to 'vint____166_marginal' from DerivedVariable factor
			this.vint____166_marginal_F = DerivedVariableOp.MarginalAverageConditional<PointMass<int[][]>,int[][]>(this.Vint____166, this.vint____166_marginal_F);
			this.Changed_vint____166_isDone = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__1417();
			this.Changed_vint____166();
		...
		public object GetObservedValue(string variableName)
		{
			...
			if (variableName=="vint____166") {
				return this.vint____166;
			}
			if (variableName=="vdouble__1417") {
				return this.vdouble__1417;
			}
		...
		{
			if (variableName=="vdouble__1443") {
				return this.Vdouble__1443Marginal();
			}
			if (variableName=="vdouble__1445") {
				return this.Vdouble__1445Marginal();
			}
			if (variableName=="vdouble__1431") {
			...
			if (variableName=="vdouble__1417") {
				return this.Vdouble__1417Marginal();
			}
			if (variableName=="vint____166") {
				return this.Vint____166Marginal();
			}
			if (variableName=="time_passed") {
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vint____166") {
				this.vint____166 = (int[][])value;
				return ;
			}
			if (variableName=="vdouble__1417") {
				this.vdouble__1417 = (double[])value;
				return ;
			}
			if (variableName=="vint__374") {
			...
			if (variableName=="vdouble__1443") {
				this.vdouble__1443 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__1417' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__1417Marginal()
		{
			return this.vdouble__1417_marginal_F;
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__1443' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__1443Marginal()
		{
			return this.vdouble__1443_marginal_F;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vdouble__1445' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__1445Marginal()
		{
			return this.vdouble__1445_marginal_F;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vint____166' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public PointMass<int[][]> Vint____166Marginal()
		{
			return this.vint____166_marginal_F;
		}
