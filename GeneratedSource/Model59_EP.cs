...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 12:20 on giovedì 7 luglio 2022.
	/// </remarks>
	public partial class Model59_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__503 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__503</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__503_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__506 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__506</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__506_isDone;
		...
		/// <summary>True if Changed_vdouble__506 has executed. Set this to false to force re-execution of Changed_vdouble__506</summary>
		public bool Changed_vdouble__506_isDone;
		/// <summary>True if Changed_vdouble__507 has executed. Set this to false to force re-execution of Changed_vdouble__507</summary>
		public bool Changed_vdouble__507_isDone;
		...
		/// <summary>Field backing the vdouble__506 property</summary>
		private double[] Vdouble__506;
		/// <summary>Message to marginal of 'vdouble__506'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__506_marginal_F;
		/// <summary>Field backing the vdouble__507 property</summary>
		private double[] Vdouble__507;
		...
		public RpropBufferData[] vdouble__508_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__503_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__506_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__506'</summary>
		public double[] vdouble__506
		{
			get {
				return this.Vdouble__506;
			}
			set {
				if ((value!=null)&&(value.Length!=3331)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3331)+" was expected for variable \'vdouble__506\'");
				}
				this.Vdouble__506 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__506_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__503_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__507'</summary>
		public double[] vdouble__507
		{
			get {
				return this.Vdouble__507;
			}
			set {
				if ((value!=null)&&(value.Length!=3331)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3331)+" was expected for variable \'vdouble__507\'");
				}
				this.Vdouble__507 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__507_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__503_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__506 and vdouble__507</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__503(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__503_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3331);
			for(int nPlayers = 0; nPlayers<3331; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3331);
			...
			for(int nPlayers = 0; nPlayers<3331; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__506[nPlayers], this.Vdouble__507[nPlayers]);
			}
			...
			Gaussian[] vdouble1412_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1412_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1412_B'
			Gaussian[] vdouble1412_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1412_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1410_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1410_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1410_B'
			Gaussian[] vdouble1410_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1410_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1408_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1408_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1408_B'
			Gaussian[] vdouble1408_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1408_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool365_B'
			Bernoulli[] vbool365_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool365_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool365' from Not factor
					vbool365_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1406_F'
			Gaussian[] vdouble1406_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1406_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1406_B'
			Gaussian[] vdouble1406_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1406_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool362_B'
			Bernoulli[] vbool362_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool362_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool362' from Not factor
					vbool362_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble1412' from Difference factor
						vdouble1412_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1412' from IsPositive factor
						vdouble1412_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1412_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1412_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble1410' from Difference factor
						vdouble1410_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble1410' from IsPositive factor
						vdouble1410_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1410_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1410_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1408' from Difference factor
						vdouble1408_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1408' from IsPositive factor
						vdouble1408_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool365_B[nMatches], vdouble1408_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1408_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1406' from Difference factor
						vdouble1406_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1406' from IsPositive factor
						vdouble1406_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool362_B[nMatches], vdouble1406_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1406_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__503_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__506</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__506(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__506_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__508_F;
			// Create array for 'vdouble__508' Forwards messages.
			vdouble__508_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__508_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____120_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____120_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1380_F'
			Gaussian[][][] vdouble1380_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1378_F'
			Gaussian[][][] vdouble1378_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1384_F'
			Gaussian[] vdouble1384_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1385_F'
			Gaussian[] vdouble1385_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				// Create array for 'vdouble____120' Forwards messages.
				vdouble____120_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble1378_F'
				vdouble1378_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1380_F'
				vdouble1380_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____120' Forwards messages.
					vdouble____120_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble1378_F'
					vdouble1378_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1380_F'
					vdouble1380_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____120_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1378_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1378' from Gaussian factor
						vdouble1378_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__506[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1380_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1380' from Product factor
						vdouble1380_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1378_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____120' from Ratio factor
						vdouble____120_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1380_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1384_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1384' from Sum factor
				vdouble1384_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____120_F[nMatches][0]);
				vdouble1385_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1385' from Sum factor
				vdouble1385_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____120_F[nMatches][1]);
				// Message to 'vdouble__508' from Difference factor
				vdouble__508_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1384_F[nMatches], vdouble1385_F[nMatches]), string.Format("vdouble__508_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__508_use_B_reduced;
			vdouble__508_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__508_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__508_use_B_reduced, vdouble__508_F[nMatches], this.vdouble__508_marginal_F[nMatches], this.vdouble__508_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__508_marginal' from VariablePoint factor
					this.vdouble__508_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__508_use_B_reduced, vdouble__508_F[nMatches], this.vdouble__508_use_B_nMatches__buffer[nMatches], this.vdouble__508_marginal_F[nMatches]), string.Format("vdouble__508_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__506_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__506 and vdouble__507</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__506</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__508_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__508_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__506 and vdouble__507</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__506 and vdouble__507</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool363'
			bool[] vbool363 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool363[nMatches] = true;
					Constrain.Equal<bool>(true, vbool363[nMatches]);
				}
			}
			// Create array for replicates of 'vbool366'
			bool[] vbool366 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool366[nMatches] = true;
					Constrain.Equal<bool>(true, vbool366[nMatches]);
				}
			}
			// Create array for replicates of 'vbool368'
			bool[] vbool368 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vbool368[nMatches] = true;
					Constrain.Equal<bool>(true, vbool368[nMatches]);
				}
			}
			// Create array for replicates of 'vbool370'
			bool[] vbool370 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
		...
		/// <summary>Computations that depend on the observed value of vdouble__506</summary>
		private void Changed_vdouble__506()
		{
			if (this.Changed_vdouble__506_isDone) {
				return ;
			}
			// Create array for 'vdouble__506_marginal' Forwards messages.
			this.vdouble__506_marginal_F = new DistributionStructArray<Gaussian,double>(3331);
			for(int nPlayers = 0; nPlayers<3331; nPlayers++) {
				this.vdouble__506_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__506_marginal' from DerivedVariable factor
			this.vdouble__506_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__506, this.vdouble__506_marginal_F);
			this.Changed_vdouble__506_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__507</summary>
		private void Changed_vdouble__507()
		{
			if (this.Changed_vdouble__507_isDone) {
				return ;
			}
			// Create array for 'vdouble__507_marginal' Forwards messages.
			this.vdouble__507_marginal_F = new DistributionStructArray<Gaussian,double>(3331);
			for(int nPlayers = 0; nPlayers<3331; nPlayers++) {
				this.vdouble__507_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__507_marginal' from DerivedVariable factor
			this.vdouble__507_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__507, this.vdouble__507_marginal_F);
			this.Changed_vdouble__507_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__508_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__508_use_B_nMatches__buffer'
			this.vdouble__508_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3331);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__507();
			this.Changed_vdouble__506();
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__503(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__506(numberOfIterations);
		...
		public object Marginal(string variableName)
		{
			...
			if (variableName=="vdouble__506") {
				return this.Vdouble__506Marginal();
			}
			if (variableName=="player_n_Time") {
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__506") {
				this.vdouble__506 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__507") {
				this.vdouble__507 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__506' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__506Marginal()
		{
			return this.vdouble__506_marginal_F;
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__508_marginal_F);
		}
