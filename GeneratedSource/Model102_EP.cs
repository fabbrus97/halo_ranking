...
namespace Models
{
	...
	public partial class Model102_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_vdouble__886 has executed. Set this to false to force re-execution of Changed_vdouble__886</summary>
		public bool Changed_vdouble__886_isDone;
		...
		/// <summary>Field backing the vdouble__886 property</summary>
		private double[] Vdouble__886;
		...
		public double[] skills__gamma_
		{
			...
			set {
				if ((value!=null)&&(value.Length!=6572)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6572)+" was expected for variable \'skills__gamma_\'");
				}
		...
		/// <summary>The externally-specified value of 'vdouble__886'</summary>
		public double[] vdouble__886
		{
			get {
				return this.Vdouble__886;
			}
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vdouble__886\'");
				}
				this.Vdouble__886 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__886_isDone = false;
			}
		}
		...
		public int[][] vint____138
		{
			...
			set {
				if ((value!=null)&&(value.Length!=6572)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6572)+" was expected for variable \'vint____138\'");
				}
		...
		private void Changed_skills__gamma_()
		{
			...
			this.skills__gamma__marginal_F = new DistributionStructArray<Gaussian,double>(6572);
		...
		/// <summary>Computations that depend on the observed value of vdouble__886</summary>
		private void Changed_vdouble__886()
		{
			if (this.Changed_vdouble__886_isDone) {
				return ;
			}
			// Create array for 'vdouble__886_marginal' Forwards messages.
			this.vdouble__886_marginal_F = new DistributionStructArray<Gaussian,double>(200);
			for(int index378 = 0; index378<200; index378++) {
				this.vdouble__886_marginal_F[index378] = Gaussian.Uniform();
			}
			// Message to 'vdouble__886_marginal' from DerivedVariable factor
			this.vdouble__886_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__886, this.vdouble__886_marginal_F);
			this.Changed_vdouble__886_isDone = true;
		}
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__886") {
				this.vdouble__886 = (double[])value;
				return ;
			}
			if (variableName=="vbool__137") {
