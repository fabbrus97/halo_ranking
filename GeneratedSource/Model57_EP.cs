...
namespace Models
{
	...
	public partial class Model57_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__483 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__483</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__483_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__489 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__489</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__489_isDone;
		...
		/// <summary>True if Changed_vdouble__489 has executed. Set this to false to force re-execution of Changed_vdouble__489</summary>
		public bool Changed_vdouble__489_isDone;
		/// <summary>True if Changed_vdouble__490 has executed. Set this to false to force re-execution of Changed_vdouble__490</summary>
		public bool Changed_vdouble__490_isDone;
		...
		/// <summary>Field backing the vdouble__489 property</summary>
		private double[] Vdouble__489;
		...
		/// <summary>Field backing the vdouble__490 property</summary>
		private double[] Vdouble__490;
		...
		public RpropBufferData[] vdouble__491_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__483_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__489_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__489'</summary>
		public double[] vdouble__489
		{
			get {
				return this.Vdouble__489;
			}
			set {
				if ((value!=null)&&(value.Length!=3422)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3422)+" was expected for variable \'vdouble__489\'");
				}
				this.Vdouble__489 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__489_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__483_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__490'</summary>
		public double[] vdouble__490
		{
			get {
				return this.Vdouble__490;
			}
			set {
				if ((value!=null)&&(value.Length!=3422)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3422)+" was expected for variable \'vdouble__490\'");
				}
				this.Vdouble__490 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__490_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__483_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__489 and vdouble__490</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__483(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__483_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3422);
			for(int nPlayers = 0; nPlayers<3422; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3422);
			...
			for(int nPlayers = 0; nPlayers<3422; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__489[nPlayers], this.Vdouble__490[nPlayers]);
			}
			...
			Gaussian[] vdouble1366_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1366_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1366_B'
			Gaussian[] vdouble1366_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1366_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble1364_F'
			Gaussian[] vdouble1364_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1364_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1364_B'
			Gaussian[] vdouble1364_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1364_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1362_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1362_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1362_B'
			Gaussian[] vdouble1362_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1362_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool353_B'
			Bernoulli[] vbool353_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool353_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool353' from Not factor
					vbool353_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1360_F'
			Gaussian[] vdouble1360_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
			...
			Gaussian[] vdouble1360_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1360_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool350_B'
			Bernoulli[] vbool350_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool350_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool350' from Not factor
					vbool350_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble1366' from Difference factor
						vdouble1366_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1366' from IsPositive factor
						vdouble1366_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1366_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1366_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble1364' from Difference factor
						vdouble1364_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble1364' from IsPositive factor
						vdouble1364_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1364_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1364_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1362' from Difference factor
						vdouble1362_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1362' from IsPositive factor
						vdouble1362_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool353_B[nMatches], vdouble1362_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1362_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						vdouble1360_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1360' from IsPositive factor
						vdouble1360_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool350_B[nMatches], vdouble1360_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1360_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__483_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__489</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__489(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__489_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__491_F;
			// Create array for 'vdouble__491' Forwards messages.
			vdouble__491_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__491_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____116_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____116_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1334_F'
			Gaussian[][][] vdouble1334_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1332_F'
			Gaussian[][][] vdouble1332_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1338_F'
			Gaussian[] vdouble1338_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1339_F'
			Gaussian[] vdouble1339_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				// Create array for 'vdouble____116' Forwards messages.
				vdouble____116_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble1332_F'
				vdouble1332_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1334_F'
				vdouble1334_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____116' Forwards messages.
					vdouble____116_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble1332_F'
					vdouble1332_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1334_F'
					vdouble1334_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____116_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1332_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1332' from Gaussian factor
						vdouble1332_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__489[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1334_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1334' from Product factor
						vdouble1334_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1332_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____116' from Ratio factor
						vdouble____116_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1334_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1338_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1338' from Sum factor
				vdouble1338_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____116_F[nMatches][0]);
				vdouble1339_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1339' from Sum factor
				vdouble1339_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____116_F[nMatches][1]);
				// Message to 'vdouble__491' from Difference factor
				vdouble__491_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1338_F[nMatches], vdouble1339_F[nMatches]), string.Format("vdouble__491_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__491_use_B_reduced;
			vdouble__491_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__491_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__491_use_B_reduced, vdouble__491_F[nMatches], this.vdouble__491_marginal_F[nMatches], this.vdouble__491_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__491_marginal' from VariablePoint factor
					this.vdouble__491_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__491_use_B_reduced, vdouble__491_F[nMatches], this.vdouble__491_use_B_nMatches__buffer[nMatches], this.vdouble__491_marginal_F[nMatches]), string.Format("vdouble__491_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__489_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__489 and vdouble__490</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__489</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__491_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__491_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__489 and vdouble__490</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__489 and vdouble__490</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool351'
			bool[] vbool351 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool351[nMatches] = true;
					Constrain.Equal<bool>(true, vbool351[nMatches]);
				}
			}
			// Create array for replicates of 'vbool354'
			bool[] vbool354 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
		...
		/// <summary>Computations that depend on the observed value of vdouble__489</summary>
		private void Changed_vdouble__489()
		{
			if (this.Changed_vdouble__489_isDone) {
				return ;
			}
			// Create array for 'vdouble__489_marginal' Forwards messages.
			this.vdouble__489_marginal_F = new DistributionStructArray<Gaussian,double>(3422);
			for(int nPlayers = 0; nPlayers<3422; nPlayers++) {
				this.vdouble__489_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__489_marginal' from DerivedVariable factor
			this.vdouble__489_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__489, this.vdouble__489_marginal_F);
			this.Changed_vdouble__489_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__490</summary>
		private void Changed_vdouble__490()
		{
			if (this.Changed_vdouble__490_isDone) {
				return ;
			}
			// Create array for 'vdouble__490_marginal' Forwards messages.
			this.vdouble__490_marginal_F = new DistributionStructArray<Gaussian,double>(3422);
			for(int nPlayers = 0; nPlayers<3422; nPlayers++) {
				this.vdouble__490_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__490_marginal' from DerivedVariable factor
			this.vdouble__490_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__490, this.vdouble__490_marginal_F);
			this.Changed_vdouble__490_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__491_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__491_use_B_nMatches__buffer'
			this.vdouble__491_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3422);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__490();
			this.Changed_vdouble__489();
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__483(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__489(numberOfIterations);
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__489") {
				this.vdouble__489 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__490") {
				this.vdouble__490 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__491_marginal_F);
		}
