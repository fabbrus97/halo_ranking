...
namespace Models
{
	...
	public partial class Model63_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__543 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__543</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__543_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__540 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__540</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__540_isDone;
		...
		/// <summary>True if Changed_vdouble__540 has executed. Set this to false to force re-execution of Changed_vdouble__540</summary>
		public bool Changed_vdouble__540_isDone;
		/// <summary>True if Changed_vdouble__541 has executed. Set this to false to force re-execution of Changed_vdouble__541</summary>
		public bool Changed_vdouble__541_isDone;
		...
		/// <summary>Message to marginal of 'vdouble__540'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__540_marginal_F;
		/// <summary>Field backing the vdouble__541 property</summary>
		private double[] Vdouble__541;
		...
		/// <summary>Message to marginal of 'vdouble__542'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__542_marginal_F;
		/// <summary>Buffer for VariablePointOp_Rprop.MarginalAverageConditional</summary>
		public RpropBufferData[] vdouble__542_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__543_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__540_isDone = false;
			}
		}
		...
		public double[] vdouble__540
		{
			...
			set {
				if ((value!=null)&&(value.Length!=3446)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3446)+" was expected for variable \'vdouble__540\'");
				}
				this.Vdouble__540 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__540_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__543_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__541'</summary>
		public double[] vdouble__541
		{
			get {
				return this.Vdouble__541;
			}
			set {
				if ((value!=null)&&(value.Length!=3446)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3446)+" was expected for variable \'vdouble__541\'");
				}
				this.Vdouble__541 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__541_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__543_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__540 and vdouble__541</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__543(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__543_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3446);
			for(int nPlayers = 0; nPlayers<3446; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3446);
			...
			for(int nPlayers = 0; nPlayers<3446; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__540[nPlayers], this.Vdouble__541[nPlayers]);
			}
			...
			Gaussian[] vdouble1504_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
			...
			Gaussian[] vdouble1504_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
			...
			Gaussian[] vdouble1502_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1502_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1502_B'
			Gaussian[] vdouble1502_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1502_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1500_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1500_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1500_B'
			Gaussian[] vdouble1500_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1500_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool389_B'
			Bernoulli[] vbool389_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool389_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool389' from Not factor
					vbool389_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1498_F'
			Gaussian[] vdouble1498_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1498_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1498_B'
			Gaussian[] vdouble1498_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1498_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool386_B'
			Bernoulli[] vbool386_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						...
						vdouble1504_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1504' from IsPositive factor
						vdouble1504_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1504_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1504_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble1502' from Difference factor
						vdouble1502_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble1502' from IsPositive factor
						vdouble1502_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1502_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1502_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1500' from Difference factor
						vdouble1500_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1500' from IsPositive factor
						vdouble1500_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool389_B[nMatches], vdouble1500_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1500_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1498' from Difference factor
						vdouble1498_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1498' from IsPositive factor
						vdouble1498_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool386_B[nMatches], vdouble1498_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1498_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__543_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__540</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__540(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__540_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__542_F;
			// Create array for 'vdouble__542' Forwards messages.
			vdouble__542_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__542_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____128_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____128_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1472_F'
			Gaussian[][][] vdouble1472_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1470_F'
			Gaussian[][][] vdouble1470_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1476_F'
			Gaussian[] vdouble1476_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1477_F'
			Gaussian[] vdouble1477_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				// Create array for 'vdouble____128' Forwards messages.
				vdouble____128_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble1470_F'
				vdouble1470_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1472_F'
				vdouble1472_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____128' Forwards messages.
					vdouble____128_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble1470_F'
					vdouble1470_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1472_F'
					vdouble1472_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____128_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1470_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1470' from Gaussian factor
						vdouble1470_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__540[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1472_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1472' from Product factor
						vdouble1472_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1470_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____128' from Ratio factor
						vdouble____128_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1472_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1476_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1476' from Sum factor
				vdouble1476_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____128_F[nMatches][0]);
				vdouble1477_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1477' from Sum factor
				vdouble1477_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____128_F[nMatches][1]);
				// Message to 'vdouble__542' from Difference factor
				vdouble__542_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1476_F[nMatches], vdouble1477_F[nMatches]), string.Format("vdouble__542_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__542_use_B_reduced;
			vdouble__542_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__542_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__542_use_B_reduced, vdouble__542_F[nMatches], this.vdouble__542_marginal_F[nMatches], this.vdouble__542_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__542_marginal' from VariablePoint factor
					this.vdouble__542_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__542_use_B_reduced, vdouble__542_F[nMatches], this.vdouble__542_use_B_nMatches__buffer[nMatches], this.vdouble__542_marginal_F[nMatches]), string.Format("vdouble__542_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__540_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__540 and vdouble__541</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__540</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__542_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__542_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__540 and vdouble__541</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__540 and vdouble__541</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool392'
			bool[] vbool392 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vbool392[nMatches] = true;
					Constrain.Equal<bool>(true, vbool392[nMatches]);
				}
			}
			// Create array for replicates of 'vbool394'
			bool[] vbool394 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool394[nMatches] = true;
					Constrain.Equal<bool>(true, vbool394[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__540</summary>
		private void Changed_vdouble__540()
		{
			if (this.Changed_vdouble__540_isDone) {
				return ;
			}
			// Create array for 'vdouble__540_marginal' Forwards messages.
			this.vdouble__540_marginal_F = new DistributionStructArray<Gaussian,double>(3446);
			for(int nPlayers = 0; nPlayers<3446; nPlayers++) {
				this.vdouble__540_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__540_marginal' from DerivedVariable factor
			this.vdouble__540_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__540, this.vdouble__540_marginal_F);
			this.Changed_vdouble__540_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__541</summary>
		private void Changed_vdouble__541()
		{
			if (this.Changed_vdouble__541_isDone) {
				return ;
			}
			// Create array for 'vdouble__541_marginal' Forwards messages.
			this.vdouble__541_marginal_F = new DistributionStructArray<Gaussian,double>(3446);
			for(int nPlayers = 0; nPlayers<3446; nPlayers++) {
				this.vdouble__541_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__541_marginal' from DerivedVariable factor
			this.vdouble__541_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__541, this.vdouble__541_marginal_F);
			this.Changed_vdouble__541_isDone = true;
		}
		...
		private void Constant()
		{
			...
			// Create array for 'vdouble__542_marginal' Forwards messages.
			this.vdouble__542_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__542_use_B_nMatches__buffer'
			this.vdouble__542_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3446);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__541();
			this.Changed_vdouble__540();
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__543(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__540(numberOfIterations);
		...
		public object Marginal(string variableName)
		{
			...
			if (variableName=="vdouble__542") {
				return this.Vdouble__542Marginal();
			}
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__541") {
				this.vdouble__541 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		{
			return this.vdouble__540_marginal_F;
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__542' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__542Marginal()
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__542_marginal_F);
		}
