...
namespace Models
{
	...
	public partial class Model35_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__303 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__303</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__303_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__302 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__302</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__302_isDone;
		...
		/// <summary>True if Changed_vdouble__302 has executed. Set this to false to force re-execution of Changed_vdouble__302</summary>
		public bool Changed_vdouble__302_isDone;
		/// <summary>True if Changed_vdouble__303 has executed. Set this to false to force re-execution of Changed_vdouble__303</summary>
		public bool Changed_vdouble__303_isDone;
		...
		/// <summary>Field backing the vdouble__302 property</summary>
		private double[] Vdouble__302;
		...
		/// <summary>Field backing the vdouble__303 property</summary>
		private double[] Vdouble__303;
		...
		public RpropBufferData[] vdouble__304_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__303_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__302_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__302'</summary>
		public double[] vdouble__302
		{
			get {
				return this.Vdouble__302;
			}
			set {
				if ((value!=null)&&(value.Length!=3381)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3381)+" was expected for variable \'vdouble__302\'");
				}
				this.Vdouble__302 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__302_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__303_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__303'</summary>
		public double[] vdouble__303
		{
			get {
				return this.Vdouble__303;
			}
			set {
				if ((value!=null)&&(value.Length!=3381)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3381)+" was expected for variable \'vdouble__303\'");
				}
				this.Vdouble__303 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__303_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__303_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__302 and vdouble__303</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__303(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__303_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3381);
			for(int nPlayers = 0; nPlayers<3381; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3381);
			...
			for(int nPlayers = 0; nPlayers<3381; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__302[nPlayers], this.Vdouble__303[nPlayers]);
			}
			...
			Gaussian[] vdouble860_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble860_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble860_B'
			Gaussian[] vdouble860_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble860_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble858_F'
			Gaussian[] vdouble858_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble858_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble858_B'
			Gaussian[] vdouble858_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble858_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble856_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble856_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble856_B'
			Gaussian[] vdouble856_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble856_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool221_B'
			Bernoulli[] vbool221_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool221_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool221' from Not factor
					vbool221_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble854_F'
			Gaussian[] vdouble854_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble854_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble854_B'
			Gaussian[] vdouble854_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble854_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool218_B'
			Bernoulli[] vbool218_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool218_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool218' from Not factor
					vbool218_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble860' from Difference factor
						vdouble860_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble860' from IsPositive factor
						vdouble860_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble860_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble860_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble858' from Difference factor
						vdouble858_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble858' from IsPositive factor
						vdouble858_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble858_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble858_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble856' from Difference factor
						vdouble856_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble856' from IsPositive factor
						vdouble856_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool221_B[nMatches], vdouble856_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble856_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble854' from Difference factor
						vdouble854_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble854' from IsPositive factor
						vdouble854_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool218_B[nMatches], vdouble854_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble854_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__303_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__302</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__302(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__302_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__304_F;
			// Create array for 'vdouble__304' Forwards messages.
			vdouble__304_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__304_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____72_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____72_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble828_F'
			Gaussian[][][] vdouble828_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble826_F'
			Gaussian[][][] vdouble826_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble832_F'
			Gaussian[] vdouble832_F = new Gaussian[500];
			// Create array for replicates of 'vdouble833_F'
			Gaussian[] vdouble833_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				...
				// Create array for replicates of 'vdouble826_F'
				vdouble826_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble828_F'
				vdouble828_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____72' Forwards messages.
					...
					// Create array for replicates of 'vdouble826_F'
					vdouble826_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble828_F'
					vdouble828_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____72_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble826_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble826' from Gaussian factor
						vdouble826_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__302[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble828_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble828' from Product factor
						vdouble828_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble826_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____72' from Ratio factor
						vdouble____72_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble828_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble832_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble832' from Sum factor
				vdouble832_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____72_F[nMatches][0]);
				vdouble833_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble833' from Sum factor
				vdouble833_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____72_F[nMatches][1]);
				// Message to 'vdouble__304' from Difference factor
				vdouble__304_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble832_F[nMatches], vdouble833_F[nMatches]), string.Format("vdouble__304_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__304_use_B_reduced;
			vdouble__304_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__304_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__304_use_B_reduced, vdouble__304_F[nMatches], this.vdouble__304_marginal_F[nMatches], this.vdouble__304_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__304_marginal' from VariablePoint factor
					this.vdouble__304_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__304_use_B_reduced, vdouble__304_F[nMatches], this.vdouble__304_use_B_nMatches__buffer[nMatches], this.vdouble__304_marginal_F[nMatches]), string.Format("vdouble__304_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__302_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__302 and vdouble__303</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__302</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__304_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__304_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__302 and vdouble__303</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__302 and vdouble__303</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool222'
			bool[] vbool222 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool222[nMatches] = true;
					Constrain.Equal<bool>(true, vbool222[nMatches]);
				}
			}
			// Create array for replicates of 'vbool224'
			bool[] vbool224 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vbool224[nMatches] = true;
					Constrain.Equal<bool>(true, vbool224[nMatches]);
				}
			}
			// Create array for replicates of 'vbool226'
			bool[] vbool226 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool226[nMatches] = true;
					Constrain.Equal<bool>(true, vbool226[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__302</summary>
		private void Changed_vdouble__302()
		{
			if (this.Changed_vdouble__302_isDone) {
				return ;
			}
			// Create array for 'vdouble__302_marginal' Forwards messages.
			this.vdouble__302_marginal_F = new DistributionStructArray<Gaussian,double>(3381);
			for(int nPlayers = 0; nPlayers<3381; nPlayers++) {
				this.vdouble__302_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__302_marginal' from DerivedVariable factor
			this.vdouble__302_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__302, this.vdouble__302_marginal_F);
			this.Changed_vdouble__302_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__303</summary>
		private void Changed_vdouble__303()
		{
			if (this.Changed_vdouble__303_isDone) {
				return ;
			}
			// Create array for 'vdouble__303_marginal' Forwards messages.
			this.vdouble__303_marginal_F = new DistributionStructArray<Gaussian,double>(3381);
			for(int nPlayers = 0; nPlayers<3381; nPlayers++) {
				this.vdouble__303_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__303_marginal' from DerivedVariable factor
			this.vdouble__303_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__303, this.vdouble__303_marginal_F);
			this.Changed_vdouble__303_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__304_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__304_use_B_nMatches__buffer'
			this.vdouble__304_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3381);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__303();
			this.Changed_vdouble__302();
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__303(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__302(numberOfIterations);
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__302") {
				this.vdouble__302 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__303") {
				this.vdouble__303 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__304_marginal_F);
		}
