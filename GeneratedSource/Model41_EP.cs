...
namespace Models
{
	...
	public partial class Model41_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__353 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__353</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__353_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__353 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__353</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__353_isDone;
		...
		/// <summary>True if Changed_vdouble__353 has executed. Set this to false to force re-execution of Changed_vdouble__353</summary>
		public bool Changed_vdouble__353_isDone;
		/// <summary>True if Changed_vdouble__354 has executed. Set this to false to force re-execution of Changed_vdouble__354</summary>
		public bool Changed_vdouble__354_isDone;
		...
		/// <summary>Field backing the vdouble__353 property</summary>
		private double[] Vdouble__353;
		/// <summary>Message to marginal of 'vdouble__353'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__353_marginal_F;
		...
		public RpropBufferData[] vdouble__355_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__353_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__353_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__353'</summary>
		public double[] vdouble__353
		{
			get {
				return this.Vdouble__353;
			}
			set {
				if ((value!=null)&&(value.Length!=3419)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3419)+" was expected for variable \'vdouble__353\'");
				}
				this.Vdouble__353 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__353_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__353_isDone = false;
		...
		public double[] vdouble__354
		{
			...
			set {
				if ((value!=null)&&(value.Length!=3419)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3419)+" was expected for variable \'vdouble__354\'");
				}
				this.Vdouble__354 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__354_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__353_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__353 and vdouble__354</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__353(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__353_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3419);
			for(int nPlayers = 0; nPlayers<3419; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3419);
			...
			for(int nPlayers = 0; nPlayers<3419; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__353[nPlayers], this.Vdouble__354[nPlayers]);
			}
			...
			Gaussian[] vdouble998_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble998_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble998_B'
			Gaussian[] vdouble998_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble998_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble996_F'
			Gaussian[] vdouble996_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble996_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble996_B'
			Gaussian[] vdouble996_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble996_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble994_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble994_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble994_B'
			Gaussian[] vdouble994_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble994_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool257_B'
			Bernoulli[] vbool257_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool257_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool257' from Not factor
					vbool257_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble992_F'
			Gaussian[] vdouble992_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble992_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble992_B'
			Gaussian[] vdouble992_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble992_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool254_B'
			Bernoulli[] vbool254_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool254_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool254' from Not factor
					vbool254_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble998' from Difference factor
						vdouble998_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble998' from IsPositive factor
						vdouble998_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble998_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble998_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble996' from Difference factor
						vdouble996_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble996' from IsPositive factor
						vdouble996_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble996_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble996_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble994' from Difference factor
						vdouble994_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble994' from IsPositive factor
						vdouble994_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool257_B[nMatches], vdouble994_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble994_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble992' from Difference factor
						vdouble992_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble992' from IsPositive factor
						vdouble992_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool254_B[nMatches], vdouble992_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble992_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__353_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__353</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__353(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__353_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__355_F;
			// Create array for 'vdouble__355' Forwards messages.
			vdouble__355_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__355_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____84_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____84_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble966_F'
			Gaussian[][][] vdouble966_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble964_F'
			Gaussian[][][] vdouble964_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble970_F'
			Gaussian[] vdouble970_F = new Gaussian[500];
			// Create array for replicates of 'vdouble971_F'
			Gaussian[] vdouble971_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				// Create array for 'vdouble____84' Forwards messages.
				vdouble____84_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble964_F'
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____84' Forwards messages.
					vdouble____84_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble964_F'
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____84_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble964_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble964' from Gaussian factor
						vdouble964_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__353[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble966_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble966' from Product factor
						vdouble966_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble964_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____84' from Ratio factor
						vdouble____84_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble966_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble970_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble970' from Sum factor
				vdouble970_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____84_F[nMatches][0]);
				vdouble971_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble971' from Sum factor
				vdouble971_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____84_F[nMatches][1]);
				// Message to 'vdouble__355' from Difference factor
				vdouble__355_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble970_F[nMatches], vdouble971_F[nMatches]), string.Format("vdouble__355_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__355_use_B_reduced;
			vdouble__355_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__355_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__355_use_B_reduced, vdouble__355_F[nMatches], this.vdouble__355_marginal_F[nMatches], this.vdouble__355_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__355_marginal' from VariablePoint factor
					this.vdouble__355_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__355_use_B_reduced, vdouble__355_F[nMatches], this.vdouble__355_use_B_nMatches__buffer[nMatches], this.vdouble__355_marginal_F[nMatches]), string.Format("vdouble__355_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__353_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__353 and vdouble__354</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__353</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__355_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__355_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__353 and vdouble__354</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__353 and vdouble__354</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool260'
			bool[] vbool260 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vbool260[nMatches] = true;
					Constrain.Equal<bool>(true, vbool260[nMatches]);
				}
			}
			// Create array for replicates of 'vbool262'
			bool[] vbool262 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool262[nMatches] = true;
					Constrain.Equal<bool>(true, vbool262[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__353</summary>
		private void Changed_vdouble__353()
		{
			if (this.Changed_vdouble__353_isDone) {
				return ;
			}
			// Create array for 'vdouble__353_marginal' Forwards messages.
			this.vdouble__353_marginal_F = new DistributionStructArray<Gaussian,double>(3419);
			for(int nPlayers = 0; nPlayers<3419; nPlayers++) {
				this.vdouble__353_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__353_marginal' from DerivedVariable factor
			this.vdouble__353_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__353, this.vdouble__353_marginal_F);
			this.Changed_vdouble__353_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__354</summary>
		private void Changed_vdouble__354()
		{
			if (this.Changed_vdouble__354_isDone) {
				return ;
			}
			// Create array for 'vdouble__354_marginal' Forwards messages.
			this.vdouble__354_marginal_F = new DistributionStructArray<Gaussian,double>(3419);
			for(int nPlayers = 0; nPlayers<3419; nPlayers++) {
				this.vdouble__354_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__354_marginal' from DerivedVariable factor
			this.vdouble__354_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__354, this.vdouble__354_marginal_F);
			this.Changed_vdouble__354_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__355_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__355_use_B_nMatches__buffer'
			this.vdouble__355_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3419);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__354();
			this.Changed_vdouble__353();
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__353(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__353(numberOfIterations);
		...
		public object Marginal(string variableName)
		{
			...
			if (variableName=="vdouble__353") {
				return this.Vdouble__353Marginal();
			}
			if (variableName=="player_n_Time") {
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__353") {
				this.vdouble__353 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__354") {
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__353' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__353Marginal()
		{
			return this.vdouble__353_marginal_F;
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__355_marginal_F);
		}
