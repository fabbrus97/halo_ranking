...
namespace Models
{
	...
	public partial class Model65_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__553 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__553</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__553_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__557 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__557</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__557_isDone;
		...
		/// <summary>True if Changed_vdouble__557 has executed. Set this to false to force re-execution of Changed_vdouble__557</summary>
		public bool Changed_vdouble__557_isDone;
		/// <summary>True if Changed_vdouble__558 has executed. Set this to false to force re-execution of Changed_vdouble__558</summary>
		public bool Changed_vdouble__558_isDone;
		...
		/// <summary>Field backing the vdouble__557 property</summary>
		private double[] Vdouble__557;
		...
		/// <summary>Message to marginal of 'vdouble__558'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__558_marginal_F;
		...
		public RpropBufferData[] vdouble__559_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__553_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__557_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__557'</summary>
		public double[] vdouble__557
		{
			get {
				return this.Vdouble__557;
			}
			set {
				if ((value!=null)&&(value.Length!=3486)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3486)+" was expected for variable \'vdouble__557\'");
				}
				this.Vdouble__557 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__557_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__553_isDone = false;
		...
		public double[] vdouble__558
		{
			...
			set {
				if ((value!=null)&&(value.Length!=3486)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3486)+" was expected for variable \'vdouble__558\'");
				}
				this.Vdouble__558 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__558_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__553_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__557 and vdouble__558</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__553(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__553_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3486);
			for(int nPlayers = 0; nPlayers<3486; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3486);
			...
			for(int nPlayers = 0; nPlayers<3486; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__557[nPlayers], this.Vdouble__558[nPlayers]);
			}
			...
			// Create array for replicates of 'vdouble1550_F'
			Gaussian[] vdouble1550_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1550_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1550_B'
			Gaussian[] vdouble1550_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1550_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble1548_F'
			Gaussian[] vdouble1548_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1548_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1548_B'
			Gaussian[] vdouble1548_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1548_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble1546_F'
			Gaussian[] vdouble1546_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1546_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1546_B'
			Gaussian[] vdouble1546_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1546_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool401_B'
			Bernoulli[] vbool401_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool401_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool401' from Not factor
					vbool401_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1544_F'
			Gaussian[] vdouble1544_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1544_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1544_B'
			Gaussian[] vdouble1544_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1544_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool398_B'
			Bernoulli[] vbool398_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool398_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool398' from Not factor
					vbool398_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble1550' from Difference factor
						vdouble1550_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1550' from IsPositive factor
						vdouble1550_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1550_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1550_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble1548' from Difference factor
						vdouble1548_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble1548' from IsPositive factor
						vdouble1548_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1548_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1548_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1546' from Difference factor
						vdouble1546_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1546' from IsPositive factor
						vdouble1546_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool401_B[nMatches], vdouble1546_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1546_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1544' from Difference factor
						vdouble1544_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1544' from IsPositive factor
						vdouble1544_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool398_B[nMatches], vdouble1544_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1544_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__553_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__557</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__557(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__557_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__559_F;
			// Create array for 'vdouble__559' Forwards messages.
			vdouble__559_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__559_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____132_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____132_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1518_F'
			Gaussian[][][] vdouble1518_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1516_F'
			Gaussian[][][] vdouble1516_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1522_F'
			Gaussian[] vdouble1522_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1523_F'
			Gaussian[] vdouble1523_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				...
				// Create array for replicates of 'vdouble1518_F'
				vdouble1518_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____132' Forwards messages.
					...
					// Create array for replicates of 'vdouble1518_F'
					vdouble1518_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						// Message to 'vdouble1516' from Gaussian factor
						vdouble1516_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__557[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1518_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1518' from Product factor
						vdouble1518_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1516_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____132' from Ratio factor
						vdouble____132_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1518_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1522_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1522' from Sum factor
				vdouble1522_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____132_F[nMatches][0]);
				vdouble1523_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1523' from Sum factor
				vdouble1523_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____132_F[nMatches][1]);
				// Message to 'vdouble__559' from Difference factor
				vdouble__559_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1522_F[nMatches], vdouble1523_F[nMatches]), string.Format("vdouble__559_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__559_use_B_reduced;
			vdouble__559_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__559_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__559_use_B_reduced, vdouble__559_F[nMatches], this.vdouble__559_marginal_F[nMatches], this.vdouble__559_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__559_marginal' from VariablePoint factor
					this.vdouble__559_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__559_use_B_reduced, vdouble__559_F[nMatches], this.vdouble__559_use_B_nMatches__buffer[nMatches], this.vdouble__559_marginal_F[nMatches]), string.Format("vdouble__559_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__557_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__557 and vdouble__558</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__557</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__559_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__559_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__557 and vdouble__558</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__557 and vdouble__558</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool402'
			bool[] vbool402 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool402[nMatches] = true;
					Constrain.Equal<bool>(true, vbool402[nMatches]);
				}
			}
			// Create array for replicates of 'vbool404'
			bool[] vbool404 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
		...
		/// <summary>Computations that depend on the observed value of vdouble__557</summary>
		private void Changed_vdouble__557()
		{
			if (this.Changed_vdouble__557_isDone) {
				return ;
			}
			// Create array for 'vdouble__557_marginal' Forwards messages.
			this.vdouble__557_marginal_F = new DistributionStructArray<Gaussian,double>(3486);
			for(int nPlayers = 0; nPlayers<3486; nPlayers++) {
				this.vdouble__557_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__557_marginal' from DerivedVariable factor
			this.vdouble__557_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__557, this.vdouble__557_marginal_F);
			this.Changed_vdouble__557_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__558</summary>
		private void Changed_vdouble__558()
		{
			if (this.Changed_vdouble__558_isDone) {
				return ;
			}
			// Create array for 'vdouble__558_marginal' Forwards messages.
			this.vdouble__558_marginal_F = new DistributionStructArray<Gaussian,double>(3486);
			for(int nPlayers = 0; nPlayers<3486; nPlayers++) {
				this.vdouble__558_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__558_marginal' from DerivedVariable factor
			this.vdouble__558_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__558, this.vdouble__558_marginal_F);
			this.Changed_vdouble__558_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__559_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__559_use_B_nMatches__buffer'
			this.vdouble__559_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3486);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__558();
			this.Changed_vdouble__557();
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__553(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__557(numberOfIterations);
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__557") {
				this.vdouble__557 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__558") {
		...
		{
			return this.vdouble__557_marginal_F;
		}
		...
		{
			return this.vdouble__558_marginal_F;
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__559_marginal_F);
		}
