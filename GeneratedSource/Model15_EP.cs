...
namespace Models
{
	...
	public partial class Model15_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_vdouble__132 has executed. Set this to false to force re-execution of Changed_vdouble__132</summary>
		public bool Changed_vdouble__132_isDone;
		...
		/// <summary>Message to marginal of 'vdouble__132'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__132_marginal_F;
		...
		public double[] skills__gamma_
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7191)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7191)+" was expected for variable \'skills__gamma_\'");
				}
		...
		public double[] vdouble__132
		{
			...
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vdouble__132\'");
				}
				this.Vdouble__132 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__132_isDone = false;
			}
		}
		...
		public int[][] vint____22
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7191)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7191)+" was expected for variable \'vint____22\'");
				}
		...
		private void Changed_skills__gamma_()
		{
			...
			this.skills__gamma__marginal_F = new DistributionStructArray<Gaussian,double>(7191);
		...
		/// <summary>Computations that depend on the observed value of vdouble__132</summary>
		private void Changed_vdouble__132()
		{
			if (this.Changed_vdouble__132_isDone) {
				return ;
			}
			// Create array for 'vdouble__132_marginal' Forwards messages.
			this.vdouble__132_marginal_F = new DistributionStructArray<Gaussian,double>(200);
			for(int index59 = 0; index59<200; index59++) {
				this.vdouble__132_marginal_F[index59] = Gaussian.Uniform();
			}
			// Message to 'vdouble__132_marginal' from DerivedVariable factor
			this.vdouble__132_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__132, this.vdouble__132_marginal_F);
			this.Changed_vdouble__132_isDone = true;
		}
		...
		{
			return this.vdouble__132_marginal_F;
		}
