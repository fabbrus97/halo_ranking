...
namespace Models
{
	...
	public partial class Model6_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_vdouble__54 has executed. Set this to false to force re-execution of Changed_vdouble__54</summary>
		public bool Changed_vdouble__54_isDone;
		...
		/// <summary>Message to marginal of 'vdouble__54'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__54_marginal_F;
		...
		public double[] skills__gamma_
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7335)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7335)+" was expected for variable \'skills__gamma_\'");
				}
		...
		public double[] vdouble__54
		{
			...
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vdouble__54\'");
				}
				this.Vdouble__54 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__54_isDone = false;
			}
		}
		...
		public int[][] vint____10
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7335)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7335)+" was expected for variable \'vint____10\'");
				}
		...
		private void Changed_skills__gamma_()
		{
			...
			this.skills__gamma__marginal_F = new DistributionStructArray<Gaussian,double>(7335);
		...
		/// <summary>Computations that depend on the observed value of vdouble__54</summary>
		private void Changed_vdouble__54()
		{
			if (this.Changed_vdouble__54_isDone) {
				return ;
			}
			// Create array for 'vdouble__54_marginal' Forwards messages.
			this.vdouble__54_marginal_F = new DistributionStructArray<Gaussian,double>(200);
			for(int index26 = 0; index26<200; index26++) {
				this.vdouble__54_marginal_F[index26] = Gaussian.Uniform();
			}
			// Message to 'vdouble__54_marginal' from DerivedVariable factor
			this.vdouble__54_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__54, this.vdouble__54_marginal_F);
			this.Changed_vdouble__54_isDone = true;
		}
		...
		{
			return this.vdouble__54_marginal_F;
		}
