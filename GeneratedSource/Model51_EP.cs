...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 17:10 on venerdì 24 giugno 2022.
	/// </remarks>
	public partial class Model51_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410 has executed. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410_isDone;
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410 has performed initialisation. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410_isInitialised;
		/// <summary>True if Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449 has executed. Set this to false to force re-execution of Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449</summary>
		public bool Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449_isDone;
		...
		/// <summary>True if Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449 has executed. Set this to false to force re-execution of Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449</summary>
		public bool Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449_isDone;
		...
		/// <summary>True if Changed_PlayerIndex_PlayerInTeam_vdouble__449 has executed. Set this to false to force re-execution of Changed_PlayerIndex_PlayerInTeam_vdouble__449</summary>
		public bool Changed_PlayerIndex_PlayerInTeam_vdouble__449_isDone;
		...
		/// <summary>True if Changed_vbool__69 has executed. Set this to false to force re-execution of Changed_vbool__69</summary>
		public bool Changed_vbool__69_isDone;
		/// <summary>True if Changed_vdouble__444 has executed. Set this to false to force re-execution of Changed_vdouble__444</summary>
		public bool Changed_vdouble__444_isDone;
		...
		/// <summary>Field backing the vbool__69 property</summary>
		private bool[] Vbool__69;
		/// <summary>Message to marginal of 'vbool__69'</summary>
		public DistributionStructArray<Bernoulli,bool> vbool__69_marginal_F;
		...
		public Bernoulli vbool257_rep_B_toDef;
		public Bernoulli[] vbool257_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli vbool257_rep_F_marginal;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli[] vbool257_rep_rep_B_toDef;
		public Bernoulli[][] vbool257_rep_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli[] vbool257_rep_rep_F_marginal;
		public Bernoulli[][][] vbool257_rep_rep_rep_B;
		/// <summary>Buffer for ReplicateOp_Divide.Marginal&lt;Bernoulli&gt;</summary>
		public Bernoulli[][] vbool257_rep_rep_rep_B_toDef;
		public Bernoulli[][][] vbool257_rep_rep_rep_F;
		/// <summary>Buffer for ReplicateOp_Divide.UsesAverageConditional&lt;Bernoulli&gt;</summary>
		public Bernoulli[][] vbool257_rep_rep_rep_F_marginal;
		...
		/// <summary>Message to marginal of 'vdouble__444'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__444_marginal_F;
		...
		public double[][] vdouble1562_reduced;
		public double[][] vdouble1569_reduced;
		public double[][] vdouble1570_reduced;
		public Gaussian[][][] vdouble1571_F;
		public Gaussian[][][] vdouble1572_F;
		public Gaussian[][][] vdouble1582_F;
		public Gaussian[][][] vdouble1592_F;
		public Gaussian[][][] vdouble1599_B;
		public Gaussian[][][] vdouble1599_F;
		public Gaussian[][][] vdouble1601_B;
		public Gaussian[][][] vdouble1601_F;
		public Gaussian[][][] vdouble1603_F;
		/// <summary>Message from use of 'vdouble1603'</summary>
		public Gaussian[][][] vdouble1603_use_B;
		public Gaussian[][][] vdouble1605_B;
		public Gaussian[][][] vdouble1605_F;
		...
		public double[][][] deathcount
		{
			...
			set {
				...
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410_isInitialised = false;
		...
		public double[] Match_time_m
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_5_isInitialised = false;
				this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410_isDone = false;
		...
		public double[][][] p_time_m__t__n
		{
			...
			set {
				...
				this.Changed_Match_time_m_p_time_m__t__n_PlayerInTeam_isDone = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_5_isInitialised = false;
				this.Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449_isDone = false;
				this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_quit_vdoubl11_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam1_isDone = false;
		...
		public int[][][] PlayerIndex
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_5_isInitialised = false;
				this.Changed_PlayerIndex_PlayerInTeam_vdouble__449_isDone = false;
				this.Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449_isDone = false;
				this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_quit_vdoubl11_isDone = false;
		...
		public double[] skills__gamma_
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7085)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7085)+" was expected for variable \'skills__gamma_\'");
				}
		...
		public double[] skills__tau_
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7085)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7085)+" was expected for variable \'skills__tau_\'");
				}
		...
		/// <summary>The externally-specified value of 'vbool__69'</summary>
		public bool[] vbool__69
		{
			get {
				return this.Vbool__69;
			}
			set {
				if ((value!=null)&&(value.Length!=7085)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7085)+" was expected for variable \'vbool__69\'");
				}
				this.Vbool__69 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vbool__69_isDone = false;
			}
		}
		...
		public double[] vdouble__444
		{
			...
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vdouble__444\'");
				}
				this.Vdouble__444 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__444_isDone = false;
			}
		}
		...
		public double[] vdouble__449
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7085)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7085)+" was expected for variable \'vdouble__449\'");
				}
		...
		public int[][] vint____70
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7085)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7085)+" was expected for variable \'vint____70\'");
				}
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of deathcount and killcount and Match_time_m and numberOfIterations and p_time_m__t__n and PlayerIndex and PlayerInTeam and quit and team2wins and vdouble__449</summary>
		...
		private void Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam1(int numberOfIterations)
		{
			...
			Gaussian[] vdouble1612_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1612_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1612_B'
			Gaussian[] vdouble1612_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1612_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1614_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1614_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1614_B'
			Gaussian[] vdouble1614_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1614_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble1576_F'
			Gaussian[][][] vdouble1576_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1576_F'
				vdouble1576_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1576_F'
					vdouble1576_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==1) {
							vdouble1576_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			double[][] vdouble1574_reduced = new double[1000][];
			double[][] vdouble1575_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				vdouble1574_reduced[nMatches] = new double[2];
				vdouble1575_reduced[nMatches] = new double[2];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					vdouble1574_reduced[nMatches][nTeamsPerMatch] = default(double);
					vdouble1575_reduced[nMatches][nTeamsPerMatch] = default(double);
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							vdouble1574_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][0]);
							vdouble1575_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(vdouble1574_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
			// Create array for replicates of 'vdouble1577_F'
			Gaussian[][][] vdouble1577_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1577_F'
				vdouble1577_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1577_F'
					vdouble1577_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==1) {
							vdouble1577_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			...
			Gaussian[][][] vdouble1593_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1593_F'
				vdouble1593_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1593_F'
					vdouble1593_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1593_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			// Create array for replicates of 'vdouble1596_F'
			Gaussian[][][] vdouble1596_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1596_F'
				vdouble1596_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1596_F'
					vdouble1596_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1596_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble1596_use_B'
			Gaussian[][][] vdouble1596_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1596_use_B'
				vdouble1596_use_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1596_use_B'
					vdouble1596_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1596_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			// Create array for replicates of 'vdouble1590_B'
			Gaussian[][][] vdouble1590_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1590_B'
				vdouble1590_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1590_B'
					vdouble1590_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1590_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
			...
			// Create array for replicates of 'vdouble1590_F'
			Gaussian[][][] vdouble1590_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1590_F'
				vdouble1590_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1590_F'
					vdouble1590_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1590_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble1592_B'
			Gaussian[][][] vdouble1592_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1592_B'
				vdouble1592_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1592_B'
					vdouble1592_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1592_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble1583_F'
			Gaussian[][][] vdouble1583_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1583_F'
				vdouble1583_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1583_F'
					vdouble1583_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1583_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			// Create array for replicates of 'vdouble1586_F'
			Gaussian[][][] vdouble1586_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1586_F'
				vdouble1586_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1586_F'
					vdouble1586_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1586_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble1586_use_B'
			Gaussian[][][] vdouble1586_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1586_use_B'
				vdouble1586_use_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1586_use_B'
					vdouble1586_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1586_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			// Create array for replicates of 'vdouble1580_B'
			Gaussian[][][] vdouble1580_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1580_B'
				vdouble1580_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1580_B'
					vdouble1580_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1580_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble1580_F'
			Gaussian[][][] vdouble1580_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1580_F'
				vdouble1580_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1580_F'
					vdouble1580_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble1580_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			...
			// Create array for replicates of 'vdouble1577_B'
			Gaussian[][][] vdouble1577_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1577_B'
				vdouble1577_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1577_B'
					vdouble1577_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==1) {
							vdouble1577_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			// Create array for replicates of 'vdouble1576_B'
			Gaussian[][][] vdouble1576_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1576_B'
				vdouble1576_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1576_B'
					vdouble1576_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==1) {
							vdouble1576_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			...
			// Create array for replicates of 'vdouble1572_B'
			Gaussian[][][] vdouble1572_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1572_B'
				vdouble1572_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1572_B'
					vdouble1572_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble1572_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			// Create array for replicates of 'vdouble1571_B'
			Gaussian[][][] vdouble1571_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1571_B'
				vdouble1571_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1571_B'
					vdouble1571_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble1571_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							// Message to 'vdouble1599' from Difference factor
							this.vdouble1599_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][3], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble1601' from Difference factor
							this.vdouble1601_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble1599_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 15.0);
							// Message to 'vdouble1603' from Gaussian factor
							this.vdouble1603_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.vdouble1601_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.01);
							// Message to 'vdouble1605' from Difference factor
							this.vdouble1605_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(0.0, this.vdouble1603_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Under_performing' from IsPositive factor
							this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = IsPositiveOp.IsPositiveAverageConditional(this.vdouble1605_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vbool261' from And factor
							this.vbool261_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanAndOp.AndAverageConditional(this.vbool257_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vbool258_rep_rep_rep' from Or factor
							this.vbool258_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanOrOp.AAverageConditional(this.Quit[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool261_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						}
				...
				this.vbool258_rep_F_marginal = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool258_rep_B_toDef, this.vBernoulli35, this.vbool258_rep_F_marginal);
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.vbool261_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanOrOp.BAverageConditional(this.Quit[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool258_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vbool257_rep_rep_rep' from And factor
							this.vbool257_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanAndOp.AAverageConditional(this.vbool261_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						}
						this.vbool257_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool257_rep_rep_rep_B[nMatches][nTeamsPerMatch], this.vbool257_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch]);
					}
					this.vbool257_rep_rep_B_toDef[nMatches] = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool257_rep_rep_rep_B_toDef[nMatches], this.vbool257_rep_rep_B_toDef[nMatches]);
				}
				this.vbool257_rep_B_toDef = ReplicateOp_Divide.ToDef<Bernoulli>(this.vbool257_rep_rep_B_toDef, this.vbool257_rep_B_toDef);
				this.vbool257_rep_F_marginal = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool257_rep_B_toDef, this.vBernoulli34, this.vbool257_rep_F_marginal);
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							// Message to 'vdouble1580' from Product factor
							vdouble1580_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(1.1E-05, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble1583' from Plus factor
							vdouble1583_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(vdouble1580_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1582_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Product factor
							death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1583_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1586' from Gaussian factor
							vdouble1586_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1586_use' from Max factor
							vdouble1586_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Killcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, vdouble1586_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Gaussian factor
							death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(vdouble1586_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1583' from Product factor
							vdouble1583_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1582' from Plus factor
							vdouble1582_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(vdouble1583_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble1580_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0] = GaussianProductOpBase.BAverageConditional(vdouble1582_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -9.1000000000000003E-05);
						}
					}
					// Message to 'vbool257_rep' from Replicate factor
					this.vbool257_rep_F[nMatches] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool257_rep_rep_B_toDef[nMatches], this.vbool257_rep_F_marginal, nMatches, this.vbool257_rep_F[nMatches]);
					this.vbool257_rep_rep_F_marginal[nMatches] = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool257_rep_rep_B_toDef[nMatches], this.vbool257_rep_F[nMatches], this.vbool257_rep_rep_F_marginal[nMatches]);
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						// Message to 'vbool257_rep_rep' from Replicate factor
						this.vbool257_rep_rep_F[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool257_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch], this.vbool257_rep_rep_F_marginal[nMatches], nTeamsPerMatch, this.vbool257_rep_rep_F[nMatches][nTeamsPerMatch]);
						this.vbool257_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.Marginal<Bernoulli>(this.vbool257_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch], this.vbool257_rep_rep_F[nMatches][nTeamsPerMatch], this.vbool257_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch]);
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'vbool257_rep_rep_rep' from Replicate factor
							this.vbool257_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = ReplicateOp_Divide.UsesAverageConditional<Bernoulli>(this.vbool257_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool257_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch], nPlayersMinusPerTeam, this.vbool257_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Under_performing' from And factor
							this.Under_performing_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = BooleanAndOp.BAverageConditional(this.vbool261_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vbool257_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1605' from IsPositive factor
							this.vdouble1605_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = IsPositiveOp_Proper.XAverageConditional(this.Under_performing_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1605_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1603_use' from Difference factor
							this.vdouble1603_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(0.0, this.vdouble1605_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1601' from Gaussian factor
							this.vdouble1601_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble1603_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.01);
							// Message to 'vdouble1599' from Difference factor
							this.vdouble1599_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble1601_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 15.0);
							// Message to 'Perfomance_opposing_team_uses' from Difference factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = DoublePlusOp.BAverageConditional(this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][3], this.vdouble1599_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							// Message to 'vdouble1590' from Product factor
							vdouble1590_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-5.1E-05, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble1593' from Plus factor
							vdouble1593_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(vdouble1590_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1592_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1594' from Product factor
							vdouble1594_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1593_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1596' from Gaussian factor
							vdouble1596_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(vdouble1594_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1596_use' from Max factor
							vdouble1596_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Deathcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, vdouble1596_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1594' from Gaussian factor
							vdouble1594_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(vdouble1596_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1593' from Product factor
							vdouble1593_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(vdouble1594_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1592' from Plus factor
							vdouble1592_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(vdouble1593_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble1590_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble1592_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 9.5000000000000005E-05);
							// Message to 'player_perf_t__n_uses' from Replicate factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==0) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'vdouble1572' from Product factor
								vdouble1572_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1570_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1571' from Ratio factor
								vdouble1571_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble1572_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1571' from Sum factor
								this.vdouble1571_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_0_0_' from Sum factor
								this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble1571_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1571_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble1572' from Ratio factor
								this.vdouble1572_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble1571_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_0_' from Product factor
								this.Perfomance_opposing_team_0__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1570_reduced[nMatches][nTeamsPerMatch], this.vdouble1572_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble1614' from Difference factor
						vdouble1614_F[nMatches] = DoublePlusOp.AAverageConditional(-0.11293766717953034, Diff_F[nMatches]);
						// Message to 'vdouble1614' from IsPositive factor
						vdouble1614_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1614_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.11293766717953034, vdouble1614_B[nMatches]);
					...
					if (this.Team2wins[nMatches]==0) {
						...
						vdouble1612_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.11293766717953034);
						// Message to 'vdouble1612' from IsPositive factor
						vdouble1612_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1612_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1612_B[nMatches], 0.11293766717953034);
						// Message to 'Diff' from Copy factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==1) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'vdouble1576' from Sum factor
								vdouble1576_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble1577' from Ratio factor
								vdouble1577_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1576_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_1_' from Product factor
								this.Perfomance_opposing_team_1__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1575_reduced[nMatches][nTeamsPerMatch], vdouble1577_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								...
								// Message to 'vdouble1577' from Product factor
								vdouble1577_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_uses_B_toDef2[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble1575_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1576' from Ratio factor
								vdouble1576_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble1577_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'player_perf_t__n_1_1_' from Sum factor
								this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble1576_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], vdouble1576_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'Perfomance_opposing_team_uses' from Replicate factor
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][3] = DoublePlusOp.SumAverageConditional(this.vdouble1599_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							if (nTeamsPerMatch==0) {
								// Message to 'Perfomance_opposing_team_uses' from Replicate factor
							...
							// Message to 'vdouble1582' from Product factor
							this.vdouble1582_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-9.1000000000000003E-05, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							if (nTeamsPerMatch==0) {
								// Message to 'Perfomance_opposing_team_uses' from Replicate factor
							...
							// Message to 'vdouble1592' from Product factor
							this.vdouble1592_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(9.5000000000000005E-05, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
						}
						if (nTeamsPerMatch==1) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'vdouble1580' from Plus factor
							vdouble1580_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(vdouble1583_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1582_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble1580_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 1.1E-05);
							// Message to 'vdouble1590' from Plus factor
							vdouble1590_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(vdouble1593_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1592_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = GaussianProductOpBase.BAverageConditional(vdouble1590_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -5.1E-05);
			...
			// Message to 'vbool257_marginal' from Variable factor
			this.vbool257_marginal_F = VariableOp.MarginalAverageConditional<Bernoulli>(this.vbool257_rep_B_toDef, this.vBernoulli34, this.vbool257_marginal_F);
			this.vbool258_marginal_F = Bernoulli.Uniform();
			// Message to 'vbool258_marginal' from Variable factor
			this.vbool258_marginal_F = VariableOp.MarginalAverageConditional<Bernoulli>(this.vbool258_rep_B_toDef, this.vBernoulli35, this.vbool258_marginal_F);
		...
		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and quit and vdouble__449 and must reset on changes to deathcount and killcount and team2wins</summary>
		...
		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__449 and must reset on changes to deathcount and killcount and quit and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410(bool initialise)
		{
			if (this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410_isDone&&((!initialise)||this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410_isDone = true;
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__449</summary>
		private void Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449()
		{
			if (this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449_isDone) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449_isDone = true;
		}
		...
		private void Changed_Match_time_m_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble1562_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						if (nTeamsPerMatch==0) {
							this.vdouble1570_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble1569_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and quit and team2wins and vdouble__449</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde9(bool initialise)
		{
			...
			this.vbool257_rep_F_marginal = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vBernoulli34);
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vbool257_rep_F[nMatches] = Bernoulli.Uniform();
				this.vbool257_rep_rep_F_marginal[nMatches] = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vbool257_rep_F[nMatches]);
				this.vbool257_rep_rep_B_toDef[nMatches] = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vbool257_rep_F[nMatches]);
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					this.vbool257_rep_rep_F[nMatches][nTeamsPerMatch] = Bernoulli.Uniform();
					this.vbool257_rep_rep_rep_F_marginal[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vbool257_rep_rep_F[nMatches][nTeamsPerMatch]);
					this.vbool257_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vbool257_rep_rep_F[nMatches][nTeamsPerMatch]);
			...
			this.vbool258_rep_B_toDef = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vBernoulli35);
			this.vbool258_rep_F_marginal = ReplicateOp_Divide.MarginalInit<Bernoulli>(this.vBernoulli35);
			for(int nMatches = 0; nMatches<1000; nMatches++) {
			...
			this.vbool257_rep_B_toDef = ReplicateOp_Divide.ToDefInit<Bernoulli>(this.vBernoulli34);
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and quit and team2wins and vdouble__449</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_5(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							this.vdouble1571_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble1572_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						this.vdouble1592_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						this.vbool257_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						...
						this.vdouble1605_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1603_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1601_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1599_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						this.vdouble1599_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1601_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1603_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1605_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.Under_performing_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
						this.vbool257_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Bernoulli.Uniform();
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__449</summary>
		private void Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449()
		{
			if (this.Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449_isDone) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449_isDone = true;
		}
		...
		private void Changed_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						this.vdouble1562_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][nTeamsPerMatch]);
						if (nTeamsPerMatch==0) {
							this.vdouble1569_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][1]);
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of PlayerIndex and PlayerInTeam and vdouble__449</summary>
		private void Changed_PlayerIndex_PlayerInTeam_vdouble__449()
		{
			if (this.Changed_PlayerIndex_PlayerInTeam_vdouble__449_isDone) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.perf_from_ds_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__449[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
					}
				}
			}
			this.Changed_PlayerIndex_PlayerInTeam_vdouble__449_isDone = true;
		}
		...
		private void Changed_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					this.vdouble1562_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble1569_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble1570_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble1571_F'
					this.vdouble1571_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1572_F'
					this.vdouble1572_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1592_F'
					this.vdouble1592_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for 'vbool257_rep_rep_rep' Forwards messages.
					this.vbool257_rep_rep_rep_F[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1605_B'
					this.vdouble1605_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1603_use_B'
					this.vdouble1603_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1601_B'
					this.vdouble1601_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1599_B'
					this.vdouble1599_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					// Create array for replicates of 'vdouble1599_F'
					this.vdouble1599_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1601_F'
					this.vdouble1601_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1605_F'
					this.vdouble1605_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for 'vbool257_rep_rep_rep' Backwards messages.
					this.vbool257_rep_rep_rep_B[nMatches][nTeamsPerMatch] = new Bernoulli[this.playerInTeam[nMatches][nTeamsPerMatch]];
				}
			}
		...
		private void Changed_skills__gamma_()
		{
			...
			this.skills__gamma__marginal_F = new DistributionStructArray<Gaussian,double>(7085);
			for(int nPlayers = 0; nPlayers<7085; nPlayers++) {
		...
		private void Changed_skills__tau_()
		{
			...
			this.skills__tau__marginal_F = new DistributionStructArray<Gaussian,double>(7085);
			for(int nPlayers = 0; nPlayers<7085; nPlayers++) {
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool264'
			bool[] vbool264 = new bool[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool264[nMatches] = true;
					Constrain.Equal<bool>(true, vbool264[nMatches]);
				}
			}
			// Create array for replicates of 'vbool266'
			bool[] vbool266 = new bool[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vbool266[nMatches] = true;
					Constrain.Equal<bool>(true, vbool266[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vbool__69</summary>
		private void Changed_vbool__69()
		{
			if (this.Changed_vbool__69_isDone) {
				return ;
			}
			// Create array for 'vbool__69_marginal' Forwards messages.
			this.vbool__69_marginal_F = new DistributionStructArray<Bernoulli,bool>(7085);
			for(int nPlayers = 0; nPlayers<7085; nPlayers++) {
				this.vbool__69_marginal_F[nPlayers] = Bernoulli.Uniform();
			}
			// Message to 'vbool__69_marginal' from DerivedVariable factor
			this.vbool__69_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Bernoulli,bool>,bool[]>(this.Vbool__69, this.vbool__69_marginal_F);
			this.Changed_vbool__69_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__444</summary>
		private void Changed_vdouble__444()
		{
			if (this.Changed_vdouble__444_isDone) {
				return ;
			}
			// Create array for 'vdouble__444_marginal' Forwards messages.
			this.vdouble__444_marginal_F = new DistributionStructArray<Gaussian,double>(200);
			for(int index191 = 0; index191<200; index191++) {
				this.vdouble__444_marginal_F[index191] = Gaussian.Uniform();
			}
			// Message to 'vdouble__444_marginal' from DerivedVariable factor
			this.vdouble__444_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__444, this.vdouble__444_marginal_F);
			this.Changed_vdouble__444_isDone = true;
		}
		...
		private void Changed_vdouble__449()
		{
			...
			this.vdouble__449_marginal_F = new DistributionStructArray<Gaussian,double>(7085);
			for(int nPlayers = 0; nPlayers<7085; nPlayers++) {
				this.vdouble__449_marginal_F[nPlayers] = Gaussian.Uniform();
			}
		...
		private void Constant()
		{
			...
			this.vBernoulli34 = Bernoulli.FromLogOdds(0.84729786038720345);
			// Create array for replicates of 'perf_from_ds_F'
			...
			this.vdouble1562_reduced = new double[1000][];
			this.Avg_play_time_team_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble1562_reduced[nMatches] = new double[2];
				this.Avg_play_time_team_reduced[nMatches] = new double[2];
			}
			this.vdouble1569_reduced = new double[1000][];
			this.vdouble1570_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble1569_reduced[nMatches] = new double[2];
				this.vdouble1570_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble1571_F'
			this.vdouble1571_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1571_F'
				this.vdouble1571_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1572_F'
			this.vdouble1572_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1572_F'
				this.vdouble1572_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'Perfomance_opposing_team_0__F'
			...
			// Create array for replicates of 'vdouble1592_F'
			this.vdouble1592_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1592_F'
				this.vdouble1592_F[nMatches] = new Gaussian[2][];
			}
			...
			// Create array for 'vbool257_rep' Forwards messages.
			this.vbool257_rep_F = new Bernoulli[1000];
			// Create array for replicates of 'vbool257_rep_rep_F_marginal'
			this.vbool257_rep_rep_F_marginal = new Bernoulli[1000];
			// Create array for replicates of 'vbool257_rep_rep_B_toDef'
			this.vbool257_rep_rep_B_toDef = new Bernoulli[1000];
			// Create array for replicates of 'vbool257_rep_rep_F'
			this.vbool257_rep_rep_F = new Bernoulli[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for 'vbool257_rep_rep' Forwards messages.
				this.vbool257_rep_rep_F[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool257_rep_rep_rep_F_marginal'
			this.vbool257_rep_rep_rep_F_marginal = new Bernoulli[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool257_rep_rep_rep_F_marginal'
				this.vbool257_rep_rep_rep_F_marginal[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool257_rep_rep_rep_B_toDef'
			this.vbool257_rep_rep_rep_B_toDef = new Bernoulli[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool257_rep_rep_rep_B_toDef'
				this.vbool257_rep_rep_rep_B_toDef[nMatches] = new Bernoulli[2];
			}
			// Create array for replicates of 'vbool257_rep_rep_rep_F'
			this.vbool257_rep_rep_rep_F = new Bernoulli[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool257_rep_rep_rep_F'
				this.vbool257_rep_rep_rep_F[nMatches] = new Bernoulli[2][];
			}
			this.vBernoulli35 = Bernoulli.FromLogOdds(-0.84729786038720356);
			// Create array for replicates of 'vbool261_F'
			...
			// Create array for replicates of 'vdouble1605_B'
			this.vdouble1605_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1605_B'
				this.vdouble1605_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1603_use_B'
			this.vdouble1603_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1603_use_B'
				this.vdouble1603_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1601_B'
			this.vdouble1601_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1601_B'
				this.vdouble1601_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1599_B'
			this.vdouble1599_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1599_B'
				this.vdouble1599_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1582_F'
			...
			// Create array for replicates of 'vdouble1599_F'
			this.vdouble1599_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1599_F'
				this.vdouble1599_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1601_F'
			this.vdouble1601_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1601_F'
				this.vdouble1601_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1603_F'
			...
			// Create array for replicates of 'vdouble1605_F'
			this.vdouble1605_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1605_F'
				this.vdouble1605_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'Under_performing_F'
			...
			// Create array for replicates of 'vbool257_rep_rep_rep_B'
			this.vbool257_rep_rep_rep_B = new Bernoulli[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vbool257_rep_rep_rep_B'
				this.vbool257_rep_rep_rep_B[nMatches] = new Bernoulli[2][];
			}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vbool__69();
			this.Changed_vdouble__444();
			...
			this.Changed_PlayerIndex_PlayerInTeam_vdouble__449();
			this.Changed_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449();
			this.Changed_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__449();
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4410(initialise);
		...
		/// <summary>
		/// Returns the marginal distribution for 'vbool__69' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Bernoulli,bool> Vbool__69Marginal()
		{
			return this.vbool__69_marginal_F;
		}
		...
		{
			return this.vdouble__444_marginal_F;
		}
