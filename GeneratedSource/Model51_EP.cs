...
namespace Models
{
	...
	public partial class Model51_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__433 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__433</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__433_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__438 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__438</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__438_isDone;
		...
		/// <summary>True if Changed_vdouble__438 has executed. Set this to false to force re-execution of Changed_vdouble__438</summary>
		public bool Changed_vdouble__438_isDone;
		/// <summary>True if Changed_vdouble__439 has executed. Set this to false to force re-execution of Changed_vdouble__439</summary>
		public bool Changed_vdouble__439_isDone;
		...
		/// <summary>Message to marginal of 'vdouble__438'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__438_marginal_F;
		/// <summary>Field backing the vdouble__439 property</summary>
		private double[] Vdouble__439;
		...
		public RpropBufferData[] vdouble__440_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__433_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__438_isDone = false;
			}
		}
		...
		public double[] vdouble__438
		{
			...
			set {
				if ((value!=null)&&(value.Length!=3361)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3361)+" was expected for variable \'vdouble__438\'");
				}
				this.Vdouble__438 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__438_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__433_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__439'</summary>
		public double[] vdouble__439
		{
			get {
				return this.Vdouble__439;
			}
			set {
				if ((value!=null)&&(value.Length!=3361)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3361)+" was expected for variable \'vdouble__439\'");
				}
				this.Vdouble__439 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__439_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__433_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__438 and vdouble__439</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__433(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__433_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3361);
			for(int nPlayers = 0; nPlayers<3361; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3361);
			...
			for(int nPlayers = 0; nPlayers<3361; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__438[nPlayers], this.Vdouble__439[nPlayers]);
			}
			...
			Gaussian[] vdouble1228_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1228_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1228_B'
			Gaussian[] vdouble1228_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1228_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1226_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1226_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1226_B'
			Gaussian[] vdouble1226_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1226_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble1224_F'
			Gaussian[] vdouble1224_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1224_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1224_B'
			Gaussian[] vdouble1224_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1224_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool317_B'
			Bernoulli[] vbool317_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool317_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool317' from Not factor
					vbool317_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1222_F'
			Gaussian[] vdouble1222_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1222_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1222_B'
			Gaussian[] vdouble1222_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1222_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool314_B'
			Bernoulli[] vbool314_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool314_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool314' from Not factor
					vbool314_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble1228' from Difference factor
						vdouble1228_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1228' from IsPositive factor
						vdouble1228_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1228_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1228_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble1226' from Difference factor
						vdouble1226_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble1226' from IsPositive factor
						vdouble1226_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1226_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1226_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1224' from Difference factor
						vdouble1224_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1224' from IsPositive factor
						vdouble1224_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool317_B[nMatches], vdouble1224_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1224_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1222' from Difference factor
						vdouble1222_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1222' from IsPositive factor
						vdouble1222_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool314_B[nMatches], vdouble1222_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1222_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__433_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__438</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__438(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__438_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__440_F;
			// Create array for 'vdouble__440' Forwards messages.
			vdouble__440_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__440_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____104_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____104_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1196_F'
			Gaussian[][][] vdouble1196_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1194_F'
			Gaussian[][][] vdouble1194_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1200_F'
			Gaussian[] vdouble1200_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1201_F'
			Gaussian[] vdouble1201_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				// Create array for 'vdouble____104' Forwards messages.
				vdouble____104_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble1194_F'
				vdouble1194_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1196_F'
				vdouble1196_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____104' Forwards messages.
					vdouble____104_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble1194_F'
					vdouble1194_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1196_F'
					vdouble1196_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____104_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1194_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1194' from Gaussian factor
						vdouble1194_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__438[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1196_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1196' from Product factor
						vdouble1196_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1194_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____104' from Ratio factor
						vdouble____104_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1196_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1200_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1200' from Sum factor
				vdouble1200_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____104_F[nMatches][0]);
				vdouble1201_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1201' from Sum factor
				vdouble1201_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____104_F[nMatches][1]);
				// Message to 'vdouble__440' from Difference factor
				vdouble__440_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1200_F[nMatches], vdouble1201_F[nMatches]), string.Format("vdouble__440_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__440_use_B_reduced;
			vdouble__440_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__440_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__440_use_B_reduced, vdouble__440_F[nMatches], this.vdouble__440_marginal_F[nMatches], this.vdouble__440_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__440_marginal' from VariablePoint factor
					this.vdouble__440_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__440_use_B_reduced, vdouble__440_F[nMatches], this.vdouble__440_use_B_nMatches__buffer[nMatches], this.vdouble__440_marginal_F[nMatches]), string.Format("vdouble__440_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__438_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__438 and vdouble__439</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__438</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__440_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__440_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__438 and vdouble__439</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__438 and vdouble__439</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool318'
			bool[] vbool318 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool318[nMatches] = true;
					Constrain.Equal<bool>(true, vbool318[nMatches]);
				}
			}
			// Create array for replicates of 'vbool320'
			bool[] vbool320 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vbool320[nMatches] = true;
					Constrain.Equal<bool>(true, vbool320[nMatches]);
				}
			}
			// Create array for replicates of 'vbool322'
			bool[] vbool322 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool322[nMatches] = true;
					Constrain.Equal<bool>(true, vbool322[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__438</summary>
		private void Changed_vdouble__438()
		{
			if (this.Changed_vdouble__438_isDone) {
				return ;
			}
			// Create array for 'vdouble__438_marginal' Forwards messages.
			this.vdouble__438_marginal_F = new DistributionStructArray<Gaussian,double>(3361);
			for(int nPlayers = 0; nPlayers<3361; nPlayers++) {
				this.vdouble__438_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__438_marginal' from DerivedVariable factor
			this.vdouble__438_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__438, this.vdouble__438_marginal_F);
			this.Changed_vdouble__438_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__439</summary>
		private void Changed_vdouble__439()
		{
			if (this.Changed_vdouble__439_isDone) {
				return ;
			}
			// Create array for 'vdouble__439_marginal' Forwards messages.
			this.vdouble__439_marginal_F = new DistributionStructArray<Gaussian,double>(3361);
			for(int nPlayers = 0; nPlayers<3361; nPlayers++) {
				this.vdouble__439_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__439_marginal' from DerivedVariable factor
			this.vdouble__439_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__439, this.vdouble__439_marginal_F);
			this.Changed_vdouble__439_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__440_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__440_use_B_nMatches__buffer'
			this.vdouble__440_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3361);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__439();
			this.Changed_vdouble__438();
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__433(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__438(numberOfIterations);
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__439") {
				this.vdouble__439 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		{
			return this.vdouble__438_marginal_F;
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__440_marginal_F);
		}
