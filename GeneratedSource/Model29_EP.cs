...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 15:55 on giovedì 7 luglio 2022.
	/// </remarks>
	public partial class Model29_EP : IGeneratedAlgorithm
	{
		...
		public double[][] vdouble1310_reduced;
		public double[][] vdouble1317_reduced;
		public double[][] vdouble1318_reduced;
		public Gaussian[][][] vdouble1319_F;
		public Gaussian[][][] vdouble1320_F;
		public double[][] vdouble1322_reduced;
		public double[][] vdouble1323_reduced;
		public Gaussian[][][] vdouble1324_B;
		public Gaussian[][][] vdouble1324_F;
		public Gaussian[][][] vdouble1325_B;
		public Gaussian[][][] vdouble1325_F;
		public Gaussian[][][] vdouble1328_F;
		public Gaussian[][][] vdouble1330_B;
		public Gaussian[][][] vdouble1330_F;
		public Gaussian[][][] vdouble1331_B;
		public Gaussian[][][] vdouble1331_F;
		public Gaussian[][][] vdouble1334_F;
		/// <summary>Message from use of 'vdouble1334'</summary>
		public Gaussian[][][] vdouble1334_use_B;
		public Gaussian[][][] vdouble1338_F;
		public Gaussian[][][] vdouble1340_B;
		public Gaussian[][][] vdouble1340_F;
		public Gaussian[][][] vdouble1341_B;
		public Gaussian[][][] vdouble1341_F;
		public Gaussian[][][] vdouble1344_F;
		/// <summary>Message from use of 'vdouble1344'</summary>
		public Gaussian[][][] vdouble1344_use_B;
		#endregion
		...
		private void Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3(int numberOfIterations)
		{
			...
			// Create array for replicates of 'vdouble1319_B'
			Gaussian[][][] vdouble1319_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1319_B'
				vdouble1319_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1319_B'
					vdouble1319_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble1319_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1357_F[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1357_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1355_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1355_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1355_B'
			Gaussian[] vdouble1355_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1355_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1353_F[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1353_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1351_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1351_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1351_B'
			Gaussian[] vdouble1351_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1351_B[nMatches] = Gaussian.Uniform();
				}
			}
				...
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.vdouble1328_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(2.5567203850565789, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble1331' from Plus factor
							this.vdouble1331_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble1328_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1330_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Product factor
							this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1331_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1334' from Gaussian factor
							this.vdouble1334_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1334_use' from Max factor
							this.vdouble1334_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Killcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble1334_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Gaussian factor
							this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble1334_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1331' from Product factor
							this.vdouble1331_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1330' from Plus factor
							this.vdouble1330_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble1331_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1328_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0] = GaussianProductOpBase.BAverageConditional(this.vdouble1330_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -0.54459509911730619);
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							this.vdouble1338_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-2.7928178121382596, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble1341' from Plus factor
							this.vdouble1341_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble1338_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1340_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Product factor
							this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1341_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1344' from Gaussian factor
							this.vdouble1344_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1344_use' from Max factor
							this.vdouble1344_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Deathcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble1344_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Gaussian factor
							this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble1344_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1341' from Product factor
							this.vdouble1341_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1340' from Plus factor
							this.vdouble1340_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble1341_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1338_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(this.vdouble1340_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.79084835337752024);
							// Message to 'player_perf_t__n_uses' from Replicate factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==0) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'vdouble1319' from Sum factor
								this.vdouble1319_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								...
								vdouble1320_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1318_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1319' from Ratio factor
								vdouble1319_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble1320_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'player_perf_t__n_0_0_' from Sum factor
								this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble1319_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1319_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							}
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble1357' from Difference factor
						vdouble1357_F[nMatches] = DoublePlusOp.AAverageConditional(-0.001, Diff_F[nMatches]);
						// Message to 'vdouble1357' from IsPositive factor
						vdouble1357_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1357_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.001, vdouble1357_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble1355' from Difference factor
						vdouble1355_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.001);
						// Message to 'vdouble1355' from IsPositive factor
						vdouble1355_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1355_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1355_B[nMatches], 0.001);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1353' from Difference factor
						vdouble1353_F[nMatches] = DoublePlusOp.AAverageConditional(-0.001, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1353' from IsPositive factor
						vdouble1353_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool185_B[nMatches], vdouble1353_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.001, vdouble1353_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						vdouble1351_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.001);
						// Message to 'vdouble1351' from IsPositive factor
						vdouble1351_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool182_B[nMatches], vdouble1351_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1351_B[nMatches], 0.001);
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==1) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'Perfomance_opposing_team' from Replicate factor
								this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = ReplicateOp_NoDivide.DefAverageConditional<Gaussian>(this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble1325' from Product factor
								this.vdouble1325_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1323_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1324' from Ratio factor
								this.vdouble1324_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(this.vdouble1325_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1324' from Sum factor
								this.vdouble1324_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_1_1_' from Sum factor
								this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(this.vdouble1324_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1324_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble1325' from Ratio factor
								this.vdouble1325_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble1324_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_1_' from Product factor
								this.Perfomance_opposing_team_1__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1323_reduced[nMatches][nTeamsPerMatch], this.vdouble1325_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							if (nTeamsPerMatch==0) {
								// Message to 'vdouble1320' from Ratio factor
								this.vdouble1320_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble1319_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_0_' from Product factor
								this.Perfomance_opposing_team_0__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1318_reduced[nMatches][nTeamsPerMatch], this.vdouble1320_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							...
							// Message to 'vdouble1330' from Product factor
							this.vdouble1330_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-0.54459509911730619, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							// Message to 'vdouble1328' from Plus factor
							vdouble1328_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble1331_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1330_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble1328_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 2.5567203850565789);
							// Message to 'vdouble1340' from Product factor
							this.vdouble1340_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(0.79084835337752024, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
						}
						if (nTeamsPerMatch==1) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							vdouble1338_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble1341_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1340_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = GaussianProductOpBase.BAverageConditional(vdouble1338_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -2.7928178121382596);
		...
		private void Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__373(int numberOfIterations)
		{
			...
			// Create array for replicates of 'vdouble1286_F'
			Gaussian[][][] vdouble1286_F = new Gaussian[1000][][];
			// Create array for replicates of 'vdouble1288_F'
			Gaussian[][][] vdouble1288_F = new Gaussian[1000][][];
			// Create array for replicates of 'vdouble1292_F'
			Gaussian[] vdouble1292_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				...
				// Create array for replicates of 'vdouble1286_F'
				vdouble1286_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1288_F'
				vdouble1288_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____122' Forwards messages.
					...
					// Create array for replicates of 'vdouble1288_F'
					vdouble1288_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1286_F'
					vdouble1286_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____122_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1286_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1286' from Gaussian factor
						vdouble1286_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__373[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1288_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1288' from Product factor
						vdouble1288_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1286_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____122' from Ratio factor
						vdouble____122_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1288_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.match_time_m[nMatches]);
					}
				}
				vdouble1292_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1292' from Sum factor
				vdouble1292_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____122_F[nMatches][0]);
				vdouble1293_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1293' from Sum factor
				vdouble1293_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____122_F[nMatches][1]);
				// Message to 'vdouble__375' from Difference factor
				vdouble__375_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1292_F[nMatches], vdouble1293_F[nMatches]), string.Format("vdouble__375_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble1323_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble1322_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
						this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble1310_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						if (nTeamsPerMatch==0) {
							this.vdouble1318_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble1317_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble1330_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==1) {
							...
							this.vdouble1325_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble1330_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						this.vdouble1334_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1334_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==0) {
							...
							this.vdouble1319_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							for(int _a3 = 0; _a3<this.playerInTeam[nMatches][0]; _a3++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble1340_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1338_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1341_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1344_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1344_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==1) {
							...
							this.vdouble1325_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
		...
		private void Changed_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble1322_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][0]);
						}
						this.vdouble1310_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][nTeamsPerMatch]);
					}
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
					...
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==0) {
							this.vdouble1317_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][1]);
						}
					}
				}
			}
		...
		private void Changed_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					// Create array for replicates of 'vdouble1330_F'
					this.vdouble1330_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble1322_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble1323_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble1325_F'
					this.vdouble1325_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble1310_reduced[nMatches][nTeamsPerMatch] = default(double);
					...
					// Create array for replicates of 'vdouble1330_B'
					this.vdouble1330_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1334_use_B'
					this.vdouble1334_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1334_F'
					this.vdouble1334_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble1317_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble1318_reduced[nMatches][nTeamsPerMatch] = default(double);
					...
					// Create array for replicates of 'vdouble1319_F'
					this.vdouble1319_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					if (nTeamsPerMatch==0) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble1340_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble1341_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1344_use_B'
					this.vdouble1344_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1344_F'
					this.vdouble1344_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1325_B'
					this.vdouble1325_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				}
			}
		...
		private void Constant()
		{
			...
			// Create array for replicates of 'vdouble1330_F'
			this.vdouble1330_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1330_F'
				this.vdouble1330_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'Perfomance_opposing_team_uses_F'
			...
			this.vdouble1322_reduced = new double[1000][];
			this.vdouble1323_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble1322_reduced[nMatches] = new double[2];
				this.vdouble1323_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble1325_F'
			this.vdouble1325_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1325_F'
				this.vdouble1325_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1324_F'
			...
			this.vdouble1310_reduced = new double[1000][];
			this.Avg_play_time_team_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble1310_reduced[nMatches] = new double[2];
			...
			// Create array for replicates of 'vdouble1330_B'
			this.vdouble1330_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1330_B'
				this.vdouble1330_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1331_B'
			...
			// Create array for replicates of 'vdouble1334_use_B'
			this.vdouble1334_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1334_use_B'
				this.vdouble1334_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1334_F'
			this.vdouble1334_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1334_F'
				this.vdouble1334_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_F'
			...
			this.vdouble1318_reduced = new double[1000][];
			this.vdouble1317_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble1317_reduced[nMatches] = new double[2];
				this.vdouble1318_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble1320_F'
			...
			// Create array for replicates of 'vdouble1319_F'
			this.vdouble1319_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1319_F'
				this.vdouble1319_F[nMatches] = new Gaussian[2][];
			}
			...
			// Create array for replicates of 'vdouble1340_B'
			this.vdouble1340_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1340_B'
				this.vdouble1340_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1338_F'
			...
			// Create array for replicates of 'vdouble1341_B'
			this.vdouble1341_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1341_B'
				this.vdouble1341_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'death_count_m__t__n_B'
			...
			// Create array for replicates of 'vdouble1344_use_B'
			this.vdouble1344_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1344_use_B'
				this.vdouble1344_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1344_F'
			this.vdouble1344_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1344_F'
				this.vdouble1344_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'death_count_m__t__n_F'
			...
			// Create array for replicates of 'vdouble1325_B'
			this.vdouble1325_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1325_B'
				this.vdouble1325_B[nMatches] = new Gaussian[2][];
			}
