...
namespace Models
{
	...
	public partial class Model47_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__403 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__403</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__403_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__404 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__404</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__404_isDone;
		...
		/// <summary>True if Changed_vdouble__404 has executed. Set this to false to force re-execution of Changed_vdouble__404</summary>
		public bool Changed_vdouble__404_isDone;
		...
		/// <summary>Field backing the vdouble__404 property</summary>
		private double[] Vdouble__404;
		/// <summary>Message to marginal of 'vdouble__404'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__404_marginal_F;
		...
		public RpropBufferData[] vdouble__406_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__403_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__404_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__404'</summary>
		public double[] vdouble__404
		{
			get {
				return this.Vdouble__404;
			}
			set {
				if ((value!=null)&&(value.Length!=3407)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3407)+" was expected for variable \'vdouble__404\'");
				}
				this.Vdouble__404 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__404_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__403_isDone = false;
		...
		public double[] vdouble__405
		{
			...
			set {
				if ((value!=null)&&(value.Length!=3407)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3407)+" was expected for variable \'vdouble__405\'");
				}
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__404 and vdouble__405</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__403(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__403_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3407);
			for(int nPlayers = 0; nPlayers<3407; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3407);
			...
			for(int nPlayers = 0; nPlayers<3407; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__404[nPlayers], this.Vdouble__405[nPlayers]);
			}
			...
			Gaussian[] vdouble1136_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1136_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1136_B'
			Gaussian[] vdouble1136_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1136_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble1134_F'
			Gaussian[] vdouble1134_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1134_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1134_B'
			Gaussian[] vdouble1134_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1134_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1132_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1132_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1132_B'
			Gaussian[] vdouble1132_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1132_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool293_B'
			Bernoulli[] vbool293_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool293_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool293' from Not factor
					vbool293_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1130_F'
			Gaussian[] vdouble1130_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1130_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1130_B'
			Gaussian[] vdouble1130_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1130_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool290_B'
			Bernoulli[] vbool290_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool290_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool290' from Not factor
					vbool290_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble1136' from Difference factor
						vdouble1136_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1136' from IsPositive factor
						vdouble1136_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1136_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1136_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble1134' from Difference factor
						vdouble1134_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble1134' from IsPositive factor
						vdouble1134_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1134_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1134_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1132' from Difference factor
						vdouble1132_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1132' from IsPositive factor
						vdouble1132_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool293_B[nMatches], vdouble1132_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1132_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1130' from Difference factor
						vdouble1130_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1130' from IsPositive factor
						vdouble1130_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool290_B[nMatches], vdouble1130_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1130_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__403_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__404</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__404(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__404_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__406_F;
			// Create array for 'vdouble__406' Forwards messages.
			vdouble__406_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__406_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____96_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____96_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1104_F'
			Gaussian[][][] vdouble1104_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1102_F'
			Gaussian[][][] vdouble1102_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1108_F'
			Gaussian[] vdouble1108_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1109_F'
			Gaussian[] vdouble1109_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				// Create array for 'vdouble____96' Forwards messages.
				vdouble____96_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble1102_F'
				vdouble1102_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1104_F'
				vdouble1104_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____96' Forwards messages.
					vdouble____96_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble1102_F'
					vdouble1102_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1104_F'
					vdouble1104_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____96_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1102_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1102' from Gaussian factor
						vdouble1102_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__404[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1104_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1104' from Product factor
						vdouble1104_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1102_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____96' from Ratio factor
						vdouble____96_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1104_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1108_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1108' from Sum factor
				vdouble1108_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____96_F[nMatches][0]);
				vdouble1109_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1109' from Sum factor
				vdouble1109_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____96_F[nMatches][1]);
				// Message to 'vdouble__406' from Difference factor
				vdouble__406_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1108_F[nMatches], vdouble1109_F[nMatches]), string.Format("vdouble__406_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__406_use_B_reduced;
			vdouble__406_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__406_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__406_use_B_reduced, vdouble__406_F[nMatches], this.vdouble__406_marginal_F[nMatches], this.vdouble__406_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__406_marginal' from VariablePoint factor
					this.vdouble__406_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__406_use_B_reduced, vdouble__406_F[nMatches], this.vdouble__406_use_B_nMatches__buffer[nMatches], this.vdouble__406_marginal_F[nMatches]), string.Format("vdouble__406_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__404_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__404 and vdouble__405</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__404</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__406_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__406_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__404 and vdouble__405</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__404 and vdouble__405</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool291'
			bool[] vbool291 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool291[nMatches] = true;
					Constrain.Equal<bool>(true, vbool291[nMatches]);
				}
			}
			// Create array for replicates of 'vbool294'
			bool[] vbool294 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
		...
		/// <summary>Computations that depend on the observed value of vdouble__404</summary>
		private void Changed_vdouble__404()
		{
			if (this.Changed_vdouble__404_isDone) {
				return ;
			}
			// Create array for 'vdouble__404_marginal' Forwards messages.
			this.vdouble__404_marginal_F = new DistributionStructArray<Gaussian,double>(3407);
			for(int nPlayers = 0; nPlayers<3407; nPlayers++) {
				this.vdouble__404_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__404_marginal' from DerivedVariable factor
			this.vdouble__404_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__404, this.vdouble__404_marginal_F);
			this.Changed_vdouble__404_isDone = true;
		}
		...
		private void Changed_vdouble__405()
		{
			...
			this.vdouble__405_marginal_F = new DistributionStructArray<Gaussian,double>(3407);
			for(int nPlayers = 0; nPlayers<3407; nPlayers++) {
		...
		private void Constant()
		{
			...
			this.vdouble__406_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__406_use_B_nMatches__buffer'
			this.vdouble__406_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3407);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__403(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__404(numberOfIterations);
		...
		public object Marginal(string variableName)
		{
			...
			if (variableName=="vdouble__404") {
				return this.Vdouble__404Marginal();
			}
			if (variableName=="player_n_Time") {
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__404") {
				this.vdouble__404 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__405") {
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__404' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__404Marginal()
		{
			return this.vdouble__404_marginal_F;
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__406_marginal_F);
		}
