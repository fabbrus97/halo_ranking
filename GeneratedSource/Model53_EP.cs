...
namespace Models
{
	...
	public partial class Model53_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__453 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__453</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__453_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__455 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__455</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__455_isDone;
		...
		/// <summary>True if Changed_vdouble__456 has executed. Set this to false to force re-execution of Changed_vdouble__456</summary>
		public bool Changed_vdouble__456_isDone;
		...
		/// <summary>Message to marginal of 'vdouble__456'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__456_marginal_F;
		...
		public RpropBufferData[] vdouble__457_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__453_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__455_isDone = false;
			}
		}
		...
		public double[] vdouble__455
		{
			...
			set {
				if ((value!=null)&&(value.Length!=3448)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3448)+" was expected for variable \'vdouble__455\'");
				}
		...
		public double[] vdouble__456
		{
			...
			set {
				if ((value!=null)&&(value.Length!=3448)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3448)+" was expected for variable \'vdouble__456\'");
				}
				this.Vdouble__456 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__456_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__453_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__455 and vdouble__456</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__453(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__453_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3448);
			for(int nPlayers = 0; nPlayers<3448; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3448);
			...
			for(int nPlayers = 0; nPlayers<3448; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__455[nPlayers], this.Vdouble__456[nPlayers]);
			}
			...
			Gaussian[] vdouble1274_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
			...
			Gaussian[] vdouble1274_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
			...
			Gaussian[] vdouble1272_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
			...
			Gaussian[] vdouble1272_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
			...
			Gaussian[] vdouble1270_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
			...
			Gaussian[] vdouble1270_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
			...
			Bernoulli[] vbool329_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool329_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool329' from Not factor
					vbool329_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1268_F'
			Gaussian[] vdouble1268_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
			...
			Gaussian[] vdouble1268_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1268_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool326_B'
			Bernoulli[] vbool326_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool326_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool326' from Not factor
					vbool326_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						...
						vdouble1274_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						...
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1274_B[nMatches]);
					...
					if (this.Team2wins[nMatches]==0) {
						...
						vdouble1272_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						...
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1272_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						vdouble1270_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1270' from IsPositive factor
						vdouble1270_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool329_B[nMatches], vdouble1270_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1270_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						vdouble1268_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1268' from IsPositive factor
						vdouble1268_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool326_B[nMatches], vdouble1268_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1268_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__453_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__455</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__455(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__455_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__457_F;
			// Create array for 'vdouble__457' Forwards messages.
			vdouble__457_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__457_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____108_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____108_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1242_F'
			Gaussian[][][] vdouble1242_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1240_F'
			Gaussian[][][] vdouble1240_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1246_F'
			Gaussian[] vdouble1246_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1247_F'
			Gaussian[] vdouble1247_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				// Create array for 'vdouble____108' Forwards messages.
				vdouble____108_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble1240_F'
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____108' Forwards messages.
					vdouble____108_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble1240_F'
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____108_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1240_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1240' from Gaussian factor
						vdouble1240_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__455[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1242_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1242' from Product factor
						vdouble1242_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1240_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____108' from Ratio factor
						vdouble____108_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1242_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1246_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1246' from Sum factor
				vdouble1246_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____108_F[nMatches][0]);
				vdouble1247_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1247' from Sum factor
				vdouble1247_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____108_F[nMatches][1]);
				// Message to 'vdouble__457' from Difference factor
				vdouble__457_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1246_F[nMatches], vdouble1247_F[nMatches]), string.Format("vdouble__457_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__457_use_B_reduced;
			vdouble__457_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__457_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__457_use_B_reduced, vdouble__457_F[nMatches], this.vdouble__457_marginal_F[nMatches], this.vdouble__457_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__457_marginal' from VariablePoint factor
					this.vdouble__457_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__457_use_B_reduced, vdouble__457_F[nMatches], this.vdouble__457_use_B_nMatches__buffer[nMatches], this.vdouble__457_marginal_F[nMatches]), string.Format("vdouble__457_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__455_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__455 and vdouble__456</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__455</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__457_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__457_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__455 and vdouble__456</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__455 and vdouble__456</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool327'
			bool[] vbool327 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool327[nMatches] = true;
					Constrain.Equal<bool>(true, vbool327[nMatches]);
				}
			}
			// Create array for replicates of 'vbool330'
			bool[] vbool330 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
		...
		private void Changed_vdouble__455()
		{
			...
			this.vdouble__455_marginal_F = new DistributionStructArray<Gaussian,double>(3448);
			for(int nPlayers = 0; nPlayers<3448; nPlayers++) {
		...
		/// <summary>Computations that depend on the observed value of vdouble__456</summary>
		private void Changed_vdouble__456()
		{
			if (this.Changed_vdouble__456_isDone) {
				return ;
			}
			// Create array for 'vdouble__456_marginal' Forwards messages.
			this.vdouble__456_marginal_F = new DistributionStructArray<Gaussian,double>(3448);
			for(int nPlayers = 0; nPlayers<3448; nPlayers++) {
				this.vdouble__456_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__456_marginal' from DerivedVariable factor
			this.vdouble__456_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__456, this.vdouble__456_marginal_F);
			this.Changed_vdouble__456_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__457_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__457_use_B_nMatches__buffer'
			this.vdouble__457_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3448);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__453(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__455(numberOfIterations);
		...
		{
			return this.vdouble__456_marginal_F;
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__457_marginal_F);
		}
