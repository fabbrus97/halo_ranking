...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 15:43 on giovedì 7 luglio 2022.
	/// </remarks>
	public partial class Model_EP : IGeneratedAlgorithm
	{
		...
		public Bernoulli[] vbool9_B;
		public Gamma[][][] vc_Times_p_time_F;
		/// <summary>Messages from uses of 'vc_Times_p_time'</summary>
		public Gamma[][][][] vc_Times_p_time_uses_B;
		public Gaussian vdouble12_F;
		/// <summary>Message to marginal of 'vdouble12'</summary>
		public Gaussian vdouble12_marginal_F;
		public Gaussian[] vdouble12_rep_F;
		public Gaussian[][] vdouble12_rep_rep_F;
		public Gaussian[][][] vdouble12_rep_rep_rep_F;
		/// <summary>Message from use of 'vdouble12'</summary>
		public Gaussian vdouble12_use_B;
		/// <summary>Buffer for VariablePointOp_Rprop.MarginalAverageConditional</summary>
		public RpropBufferData vdouble12_use_B_buffer;
		/// <summary>Message to use of 'vdouble12'</summary>
		public Gaussian vdouble12_use_F;
		public Gaussian vdouble17_F;
		/// <summary>Message to marginal of 'vdouble17'</summary>
		public Gaussian vdouble17_marginal_F;
		public Gaussian[] vdouble17_rep_F;
		public Gaussian[][] vdouble17_rep_rep_F;
		public Gaussian[][][] vdouble17_rep_rep_rep_F;
		/// <summary>Message from use of 'vdouble17'</summary>
		public Gaussian vdouble17_use_B;
		/// <summary>Buffer for VariablePointOp_Rprop.MarginalAverageConditional</summary>
		public RpropBufferData vdouble17_use_B_buffer;
		/// <summary>Message to use of 'vdouble17'</summary>
		public Gaussian vdouble17_use_F;
		public double[][] vdouble40_reduced;
		public double[][] vdouble46_reduced;
		public double[][] vdouble47_reduced;
		...
		public double[][] vdouble52_reduced;
		public Gaussian[][][] vdouble53_F;
		public Gaussian[][][] vdouble54_F;
		public Gaussian[][][] vdouble56_B;
		public Gaussian[][][] vdouble56_F;
		public Gaussian[][][] vdouble57_B;
		public Gaussian[][][] vdouble57_F;
		public Gaussian[][][] vdouble58_B;
		public Gaussian[][][] vdouble58_F;
		public Gaussian[][][] vdouble61_F;
		/// <summary>Message from use of 'vdouble61'</summary>
		public Gaussian[][][] vdouble61_use_B;
		...
		private void Changed_deathcount_draw_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerI8(int numberOfIterations)
		{
			...
			// Create array for replicates of 'vdouble12_rep_rep_rep_B'
			Gaussian[][][] vdouble12_rep_rep_rep_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble12_rep_rep_rep_B'
				vdouble12_rep_rep_rep_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble12_rep_rep_rep' Backwards messages.
					vdouble12_rep_rep_rep_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble12_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble12_rep_rep_rep_B_toDef'
			Gaussian[][] vdouble12_rep_rep_rep_B_toDef = new Gaussian[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble12_rep_rep_rep_B_toDef'
				vdouble12_rep_rep_rep_B_toDef[nMatches] = new Gaussian[2];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					vdouble12_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicatePointOp.ToDefInit<Gaussian>(this.vdouble12_rep_rep_F[nMatches][nTeamsPerMatch]);
				}
			}
			// Create array for replicates of 'vdouble12_rep_rep_B'
			Gaussian[][] vdouble12_rep_rep_B = new Gaussian[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for 'vdouble12_rep_rep' Backwards messages.
				vdouble12_rep_rep_B[nMatches] = new Gaussian[2];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					vdouble12_rep_rep_B[nMatches][nTeamsPerMatch] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble12_rep_rep_B_toDef'
			Gaussian[] vdouble12_rep_rep_B_toDef = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				vdouble12_rep_rep_B_toDef[nMatches] = ReplicatePointOp.ToDefInit<Gaussian>(this.vdouble12_rep_F[nMatches]);
			}
			Gaussian[] vdouble12_rep_B;
			// Create array for 'vdouble12_rep' Backwards messages.
			vdouble12_rep_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				vdouble12_rep_B[nMatches] = Gaussian.Uniform();
			}
			Gaussian vdouble12_rep_B_toDef;
			vdouble12_rep_B_toDef = ReplicatePointOp.ToDefInit<Gaussian>(this.vdouble12_use_F);
			...
			// Create array for replicates of 'vdouble17_rep_rep_rep_B'
			Gaussian[][][] vdouble17_rep_rep_rep_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble17_rep_rep_rep_B'
				vdouble17_rep_rep_rep_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble17_rep_rep_rep' Backwards messages.
					vdouble17_rep_rep_rep_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble17_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
			// Create array for replicates of 'vdouble17_rep_rep_rep_B_toDef'
			Gaussian[][] vdouble17_rep_rep_rep_B_toDef = new Gaussian[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble17_rep_rep_rep_B_toDef'
				vdouble17_rep_rep_rep_B_toDef[nMatches] = new Gaussian[2];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					vdouble17_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicatePointOp.ToDefInit<Gaussian>(this.vdouble17_rep_rep_F[nMatches][nTeamsPerMatch]);
				}
			}
			// Create array for replicates of 'vdouble17_rep_rep_B'
			Gaussian[][] vdouble17_rep_rep_B = new Gaussian[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for 'vdouble17_rep_rep' Backwards messages.
				vdouble17_rep_rep_B[nMatches] = new Gaussian[2];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					vdouble17_rep_rep_B[nMatches][nTeamsPerMatch] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble17_rep_rep_B_toDef'
			Gaussian[] vdouble17_rep_rep_B_toDef = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				vdouble17_rep_rep_B_toDef[nMatches] = ReplicatePointOp.ToDefInit<Gaussian>(this.vdouble17_rep_F[nMatches]);
			}
			Gaussian[] vdouble17_rep_B;
			// Create array for 'vdouble17_rep' Backwards messages.
			vdouble17_rep_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				vdouble17_rep_B[nMatches] = Gaussian.Uniform();
			}
			Gaussian vdouble17_rep_B_toDef;
			vdouble17_rep_B_toDef = ReplicatePointOp.ToDefInit<Gaussian>(this.vdouble17_use_F);
			...
			// Create array for replicates of 'vdouble54_B'
			Gaussian[][][] vdouble54_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble54_B'
				vdouble54_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble54_B'
					vdouble54_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==1) {
							vdouble54_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			// Create array for replicates of 'vdouble53_B'
			Gaussian[][][] vdouble53_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble53_B'
				vdouble53_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble53_B'
					vdouble53_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==1) {
							vdouble53_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.vdouble69_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOp.SampleAverageConditional(this.vdouble69_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble69_use' from Max factor
							this.vdouble69_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Deathcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble69_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Gaussian factor
							this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOp.MeanAverageConditional(this.vdouble69_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble66' from Product factor
							this.vdouble66_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble65' from Plus factor
							this.vdouble65_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble66_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble64_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to '_w_d_o_rep_rep_rep' from Product factor
							_w_d_o_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Tracing.FireEvent<Gaussian>(GaussianProductOp.AAverageConditional(this.vdouble65_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this._w_d_o_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]), string.Format("_w_d_o_rep_rep_rep_B[{0}]", new object[1] {nPlayersMinusPerTeam}), this.OnMessageUpdated, false);
						}
				...
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'vdouble61' from Gaussian factor
							this.vdouble61_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOp.SampleAverageConditional(this.vdouble61_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							// Message to 'vdouble61_use' from Max factor
							this.vdouble61_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Killcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble61_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Gaussian factor
							this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOp.MeanAverageConditional(this.vdouble61_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							// Message to 'vdouble58' from Product factor
							this.vdouble58_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble57' from Plus factor
							this.vdouble57_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble58_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble56_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble12_rep_rep_rep' from Product factor
							vdouble12_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Tracing.FireEvent<Gaussian>(GaussianProductOp.AAverageConditional(this.vdouble57_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble12_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]), string.Format("vdouble12_rep_rep_rep_B[{0}]", new object[1] {nPlayersMinusPerTeam}), this.OnMessageUpdated, false);
						}
						vdouble12_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicatePointOp.ToDef<Gaussian>(vdouble12_rep_rep_rep_B[nMatches][nTeamsPerMatch], vdouble12_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch]);
						// Message to 'vdouble12_rep_rep' from Replicate factor
						vdouble12_rep_rep_B[nMatches][nTeamsPerMatch] = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(vdouble12_rep_rep_B[nMatches][nTeamsPerMatch], vdouble12_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch]), string.Format("vdouble12_rep_rep_B[{0}]", new object[1] {nTeamsPerMatch}), this.OnMessageUpdated, false);
					}
					vdouble12_rep_rep_B_toDef[nMatches] = ReplicatePointOp.ToDef<Gaussian>(vdouble12_rep_rep_B[nMatches], vdouble12_rep_rep_B_toDef[nMatches]);
					// Message to 'vdouble12_rep' from Replicate factor
					vdouble12_rep_B[nMatches] = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(vdouble12_rep_B[nMatches], vdouble12_rep_rep_B_toDef[nMatches]), string.Format("vdouble12_rep_B[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				vdouble12_rep_B_toDef = ReplicatePointOp.ToDef<Gaussian>(vdouble12_rep_B, vdouble12_rep_B_toDef);
				// Message to 'vdouble12_use' from Replicate factor
				this.vdouble12_use_B = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(this.vdouble12_use_B, vdouble12_rep_B_toDef), "vdouble12_use_B", this.OnMessageUpdated, false);
				this.vdouble12_use_B_buffer = VariablePointOp_Rprop.Buffer(this.vdouble12_use_B, this.vdouble12_F, this.vdouble12_marginal_F, this.vdouble12_use_B_buffer);
				// Message to 'vdouble12_marginal' from VariablePoint factor
				this.vdouble12_marginal_F = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(this.vdouble12_use_B, this.vdouble12_F, this.vdouble12_use_B_buffer, this.vdouble12_marginal_F), "vdouble12_marginal_F", this.OnMessageUpdated, false);
				// Message to 'vdouble12_use' from VariablePoint factor
				this.vdouble12_use_F = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(this.vdouble12_use_F, this.vdouble12_marginal_F), "vdouble12_use_F", this.OnMessageUpdated, false);
				for(int nMatches = 0; nMatches<1000; nMatches++) {
				...
				this.vdouble17_use_B_buffer = VariablePointOp_Rprop.Buffer(this.vdouble17_use_B, this.vdouble17_F, this.vdouble17_marginal_F, this.vdouble17_use_B_buffer);
				// Message to 'vdouble17_marginal' from VariablePoint factor
				this.vdouble17_marginal_F = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(this.vdouble17_use_B, this.vdouble17_F, this.vdouble17_use_B_buffer, this.vdouble17_marginal_F), "vdouble17_marginal_F", this.OnMessageUpdated, false);
				// Message to 'vdouble17_use' from VariablePoint factor
				this.vdouble17_use_F = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(this.vdouble17_use_F, this.vdouble17_marginal_F), "vdouble17_use_F", this.OnMessageUpdated, false);
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					// Message to 'vdouble17_rep' from Replicate factor
					this.vdouble17_rep_F[nMatches] = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(this.vdouble17_rep_F[nMatches], this.vdouble17_use_F), string.Format("vdouble17_rep_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						// Message to 'vdouble17_rep_rep' from Replicate factor
						this.vdouble17_rep_rep_F[nMatches][nTeamsPerMatch] = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(this.vdouble17_rep_rep_F[nMatches][nTeamsPerMatch], this.vdouble17_rep_F[nMatches]), string.Format("vdouble17_rep_rep_F[{0}]", new object[1] {nTeamsPerMatch}), this.OnMessageUpdated, false);
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'vdouble17_rep_rep_rep' from Replicate factor
							this.vdouble17_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(this.vdouble17_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble17_rep_rep_F[nMatches][nTeamsPerMatch]), string.Format("vdouble17_rep_rep_rep_F[{0}]", new object[1] {nPlayersMinusPerTeam}), this.OnMessageUpdated, false);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOp.BAverageConditional(this.vdouble65_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this._w_d_o_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0] = GaussianProductOp.BAverageConditional(this.vdouble57_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble12_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
						}
						if (nTeamsPerMatch==0) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'vdouble48' from Sum factor
								this.vdouble48_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble49' from Ratio factor
								this.vdouble49_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble48_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								...
								this.vdouble49_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble47_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble48' from Ratio factor
								this.vdouble48_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(this.vdouble49_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'player_perf_t__n_0_0_' from Sum factor
								this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(this.vdouble48_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble48_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							}
					...
					// Message to 'vdouble12_rep' from Replicate factor
					this.vdouble12_rep_F[nMatches] = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(this.vdouble12_rep_F[nMatches], this.vdouble12_use_F), string.Format("vdouble12_rep_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
					// Message to '_w_d_o_rep' from Replicate factor
					...
					if (this.Draw[nMatches]==2) {
						...
						this.vdouble82_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062759999999999996, this.Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble82' from IsPositive factor
						this.vdouble82_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(this.vbool9_B[nMatches], this.vdouble82_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062759999999999996, this.vdouble82_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						this.vdouble80_F[nMatches] = DoublePlusOp.AAverageConditional(this.Diff_2__uses_F[nMatches][0], 0.062759999999999996);
						// Message to 'vdouble80' from IsPositive factor
						this.vdouble80_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(this.vbool6_B[nMatches], this.vdouble80_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(this.vdouble80_B[nMatches], 0.062759999999999996);
					...
					if (this.Draw[nMatches]==1) {
						...
						this.vdouble78_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062759999999999996, this.Diff_F[nMatches]);
						...
						this.Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062759999999999996, this.vdouble78_B[nMatches]);
						// Message to 'Diff' from Copy factor
					...
					if (this.Draw[nMatches]==0) {
						...
						this.vdouble76_F[nMatches] = DoublePlusOp.AAverageConditional(this.Diff_F[nMatches], 0.062759999999999996);
						// Message to 'vdouble76' from IsPositive factor
						this.vdouble76_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), this.vdouble76_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						this.Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(this.vdouble76_B[nMatches], 0.062759999999999996);
						// Message to 'Diff' from Copy factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						...
						// Message to 'vdouble12_rep_rep' from Replicate factor
						this.vdouble12_rep_rep_F[nMatches][nTeamsPerMatch] = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(this.vdouble12_rep_rep_F[nMatches][nTeamsPerMatch], this.vdouble12_rep_F[nMatches]), string.Format("vdouble12_rep_rep_F[{0}]", new object[1] {nTeamsPerMatch}), this.OnMessageUpdated, false);
						if (nTeamsPerMatch==1) {
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							if (nTeamsPerMatch==0) {
								...
								this.Perfomance_opposing_team_0__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble47_reduced[nMatches][nTeamsPerMatch], this.vdouble49_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							...
							// Message to 'vdouble12_rep_rep_rep' from Replicate factor
							this.vdouble12_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(this.vdouble12_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble12_rep_rep_F[nMatches][nTeamsPerMatch]), string.Format("vdouble12_rep_rep_rep_F[{0}]", new object[1] {nPlayersMinusPerTeam}), this.OnMessageUpdated, false);
							if (nTeamsPerMatch==1) {
								// Message to 'vdouble53' from Sum factor
								this.vdouble53_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble54' from Ratio factor
								this.vdouble54_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble53_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_1_' from Product factor
								this.Perfomance_opposing_team_1__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble52_reduced[nMatches][nTeamsPerMatch], this.vdouble54_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'Perfomance_opposing_team_uses' from Replicate factor
								...
								// Message to 'Perfomance_opposing_team' from Replicate factor
								this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = ReplicateOp_NoDivide.DefAverageConditional<Gaussian>(this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble54' from Product factor
								vdouble54_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble52_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble53' from Ratio factor
								vdouble53_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble54_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'player_perf_t__n_1_1_' from Sum factor
								this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble53_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble53_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'Perfomance_opposing_team_uses' from Replicate factor
							...
							// Message to 'vdouble57' from Product factor
							this.vdouble57_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOp.ProductAverageConditional(this.vdouble57_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble12_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							...
							// Message to 'vdouble65' from Product factor
							this.vdouble65_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOp.ProductAverageConditional(this.vdouble65_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this._w_d_o_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
						}
						if (nTeamsPerMatch==1) {
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.vdouble56_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble58_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble57_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOp.BAverageConditional(this.vdouble56_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this._w_k_p_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
						}
					}
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							// Message to 'vdouble64' from Plus factor
							this.vdouble64_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble66_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble65_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = GaussianProductOp.BAverageConditional(this.vdouble64_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble17_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
				...
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							_w_k_p_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Tracing.FireEvent<Gaussian>(GaussianProductOp.AAverageConditional(this.vdouble56_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this._w_k_p_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]), string.Format("_w_k_p_rep_rep_rep_B[{0}]", new object[1] {nPlayersMinusPerTeam}), this.OnMessageUpdated, false);
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							// Message to 'vdouble64' from Product factor
							this.vdouble64_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOp.ProductAverageConditional(this.vdouble64_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble17_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble17_rep_rep_rep' from Product factor
							vdouble17_rep_rep_rep_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Tracing.FireEvent<Gaussian>(GaussianProductOp.AAverageConditional(this.vdouble64_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble17_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]), string.Format("vdouble17_rep_rep_rep_B[{0}]", new object[1] {nPlayersMinusPerTeam}), this.OnMessageUpdated, false);
							// Message to 'vdouble66' from Plus factor
							this.vdouble66_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble64_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble65_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Product factor
							this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble66_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vc_Times_p_time_uses' from Gaussian factor
							this.vc_Times_p_time_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianOp.PrecisionAverageConditional(this.vdouble69_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble56' from Product factor
							this.vdouble56_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOp.ProductAverageConditional(this.vdouble56_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this._w_k_p_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble58' from Plus factor
							this.vdouble58_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble56_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble57_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Product factor
							this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble58_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vc_Times_p_time_uses' from Gaussian factor
							this.vc_Times_p_time_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0] = GaussianOp.PrecisionAverageConditional(this.vdouble61_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						...
						vdouble17_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch] = ReplicatePointOp.ToDef<Gaussian>(vdouble17_rep_rep_rep_B[nMatches][nTeamsPerMatch], vdouble17_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch]);
						// Message to 'vdouble17_rep_rep' from Replicate factor
						vdouble17_rep_rep_B[nMatches][nTeamsPerMatch] = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(vdouble17_rep_rep_B[nMatches][nTeamsPerMatch], vdouble17_rep_rep_rep_B_toDef[nMatches][nTeamsPerMatch]), string.Format("vdouble17_rep_rep_B[{0}]", new object[1] {nTeamsPerMatch}), this.OnMessageUpdated, false);
					...
					vdouble17_rep_rep_B_toDef[nMatches] = ReplicatePointOp.ToDef<Gaussian>(vdouble17_rep_rep_B[nMatches], vdouble17_rep_rep_B_toDef[nMatches]);
					// Message to 'vdouble17_rep' from Replicate factor
					vdouble17_rep_B[nMatches] = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(vdouble17_rep_B[nMatches], vdouble17_rep_rep_B_toDef[nMatches]), string.Format("vdouble17_rep_B[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				...
				vdouble17_rep_B_toDef = ReplicatePointOp.ToDef<Gaussian>(vdouble17_rep_B, vdouble17_rep_B_toDef);
				// Message to 'vdouble17_use' from Replicate factor
				this.vdouble17_use_B = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(this.vdouble17_use_B, vdouble17_rep_B_toDef), "vdouble17_use_B", this.OnMessageUpdated, false);
			...
			Gaussian vdouble12_B = Gaussian.Uniform();
			// Message to 'vdouble12' from VariablePoint factor
			vdouble12_B = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(vdouble12_B, this.vdouble12_marginal_F), "vdouble12_B", this.OnMessageUpdated, false);
			// Message to '_w_k_o_use' from Difference factor
			_w_k_o_use_B = DoublePlusOp.BAverageConditional(0.0, vdouble12_B);
			...
			Gaussian vdouble17_B = Gaussian.Uniform();
			// Message to 'vdouble17' from VariablePoint factor
			vdouble17_B = Tracing.FireEvent<Gaussian>(ArrayHelper.SetTo<Gaussian>(vdouble17_B, this.vdouble17_marginal_F), "vdouble17_B", this.OnMessageUpdated, false);
			// Message to '_w_d_p_use' from Difference factor
			_w_d_p_use_B = DoublePlusOp.BAverageConditional(0.0, vdouble17_B);
		...
		private void Changed_draw()
		{
			...
			this.vdouble76_F = new Gaussian[1000];
			// Create array for replicates of 'vdouble76_B'
			this.vdouble76_B = new Gaussian[1000];
			...
			// Create array for replicates of 'vbool9_B'
			this.vbool9_B = new Bernoulli[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Draw[nMatches]==2) {
					this.vbool9_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool9' from Not factor
					this.vbool9_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Draw[nMatches]==2) {
					this.vbool6_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool6' from Not factor
					this.vbool6_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			// Create array for replicates of 'vbool2'
			bool[] vbool2 = new bool[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Draw[nMatches]==0) {
					vbool2[nMatches] = true;
					Constrain.Equal<bool>(true, vbool2[nMatches]);
				}
			}
			// Create array for replicates of 'vbool4'
			bool[] vbool4 = new bool[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Draw[nMatches]==1) {
					vbool4[nMatches] = true;
					Constrain.Equal<bool>(true, vbool4[nMatches]);
				}
			}
		...
		private void Changed_draw_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_Playe5(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Draw[nMatches]==0) {
					...
					this.vdouble76_B[nMatches] = Gaussian.Uniform();
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble40_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						if (nTeamsPerMatch==1) {
							this.vdouble52_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble51_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
						if (nTeamsPerMatch==0) {
							this.vdouble47_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble46_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
		...
		private void Changed_numberOfIterationsDecreased_Init_deathcount_draw_killcount_Match_time_m_p_time_m__t__n_Playe1(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble12_rep_rep_F[nMatches][nTeamsPerMatch] = Gaussian.Uniform();
				}
				this.vdouble12_rep_F[nMatches] = Gaussian.Uniform();
			}
			this.vdouble12_use_F = Gaussian.Uniform();
			this.vdouble12_use_B = Gaussian.Uniform();
			this.vdouble12_use_B_buffer = VariablePointOp_Rprop.BufferInit();
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					this.vdouble17_rep_rep_F[nMatches][nTeamsPerMatch] = Gaussian.Uniform();
				}
				this.vdouble17_rep_F[nMatches] = Gaussian.Uniform();
			}
			this.vdouble17_use_F = Gaussian.Uniform();
			this.vdouble17_use_B = Gaussian.Uniform();
			this.vdouble17_use_B_buffer = VariablePointOp_Rprop.BufferInit();
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (nTeamsPerMatch==1) {
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.vdouble53_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
						...
						this.vdouble61_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						this.vdouble57_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble12_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble57_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						this.vdouble17_rep_rep_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
		...
		private void Changed_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						this.vdouble40_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][nTeamsPerMatch]);
						if (nTeamsPerMatch==1) {
							this.vdouble51_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][0]);
						}
						if (nTeamsPerMatch==0) {
							this.vdouble46_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][1]);
						}
					}
				}
			}
		...
		private void Changed_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble53_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble52_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble46_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble47_reduced[nMatches][nTeamsPerMatch] = default(double);
					...
					// Create array for replicates of 'vdouble61_use_B'
					this.vdouble61_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble57_B'
					this.vdouble57_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for 'vdouble12_rep_rep_rep' Forwards messages.
					this.vdouble12_rep_rep_rep_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble57_F'
					this.vdouble57_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for 'vdouble17_rep_rep_rep' Forwards messages.
					this.vdouble17_rep_rep_rep_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
		...
		private void Constant()
		{
			...
			// Create array for replicates of 'vdouble53_F'
			this.vdouble53_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble53_F'
				this.vdouble53_F[nMatches] = new Gaussian[2][];
			}
			this.vdouble40_reduced = new double[1000][];
			...
			this.vdouble51_reduced = new double[1000][];
			this.vdouble52_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble51_reduced[nMatches] = new double[2];
				this.vdouble52_reduced[nMatches] = new double[2];
			}
			this.vdouble46_reduced = new double[1000][];
			this.vdouble47_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble46_reduced[nMatches] = new double[2];
				this.vdouble47_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble48_F'
			...
			// Create array for replicates of 'vdouble49_F'
			this.vdouble49_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble49_F'
			...
			this.vdouble17_F = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(0.0, this._w_d_p_F), "vdouble17_F", this.OnMessageUpdated, false);
			// Create array for replicates of 'vdouble65_F'
			...
			this.vdouble12_F = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(0.0, this._w_k_o_F), "vdouble12_F", this.OnMessageUpdated, false);
			// Create array for replicates of 'vdouble61_F'
			...
			// Create array for replicates of 'vdouble61_use_B'
			this.vdouble61_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble61_use_B'
				this.vdouble61_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_B'
			...
			// Create array for replicates of 'vdouble57_B'
			this.vdouble57_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble57_B'
				this.vdouble57_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble12_rep_rep_F'
			this.vdouble12_rep_rep_F = new Gaussian[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for 'vdouble12_rep_rep' Forwards messages.
				this.vdouble12_rep_rep_F[nMatches] = new Gaussian[2];
			}
			// Create array for 'vdouble12_rep' Forwards messages.
			this.vdouble12_rep_F = new Gaussian[1000];
			// Create array for replicates of 'vdouble12_rep_rep_rep_F'
			this.vdouble12_rep_rep_rep_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble12_rep_rep_rep_F'
				this.vdouble12_rep_rep_rep_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble57_F'
			this.vdouble57_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble57_F'
				this.vdouble57_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble56_B'
			this.vdouble56_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble56_B'
			...
			// Create array for replicates of 'vdouble69_use_B'
			this.vdouble69_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble69_use_B'
			...
			// Create array for replicates of 'vdouble17_rep_rep_F'
			this.vdouble17_rep_rep_F = new Gaussian[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for 'vdouble17_rep_rep' Forwards messages.
				this.vdouble17_rep_rep_F[nMatches] = new Gaussian[2];
			}
			// Create array for 'vdouble17_rep' Forwards messages.
			this.vdouble17_rep_F = new Gaussian[1000];
			// Create array for replicates of 'vdouble17_rep_rep_rep_F'
			this.vdouble17_rep_rep_rep_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble17_rep_rep_rep_F'
				this.vdouble17_rep_rep_rep_F[nMatches] = new Gaussian[2][];
			}
			...
			// Create array for replicates of 'vdouble65_B'
			this.vdouble65_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble65_B'
			...
			// Create array for replicates of 'vdouble49_B'
			this.vdouble49_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble49_B'
