...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 12:19 on giovedì 7 luglio 2022.
	/// </remarks>
	public partial class Model55_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__473 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__473</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__473_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__472 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__472</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__472_isDone;
		...
		/// <summary>True if Changed_vdouble__472 has executed. Set this to false to force re-execution of Changed_vdouble__472</summary>
		public bool Changed_vdouble__472_isDone;
		...
		/// <summary>Field backing the vdouble__472 property</summary>
		private double[] Vdouble__472;
		...
		/// <summary>Message to marginal of 'vdouble__474'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__474_marginal_F;
		/// <summary>Buffer for VariablePointOp_Rprop.MarginalAverageConditional</summary>
		public RpropBufferData[] vdouble__474_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__473_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__472_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__472'</summary>
		public double[] vdouble__472
		{
			get {
				return this.Vdouble__472;
			}
			set {
				if ((value!=null)&&(value.Length!=3462)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3462)+" was expected for variable \'vdouble__472\'");
				}
				this.Vdouble__472 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__472_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__473_isDone = false;
		...
		public double[] vdouble__473
		{
			...
			set {
				if ((value!=null)&&(value.Length!=3462)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3462)+" was expected for variable \'vdouble__473\'");
				}
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__472 and vdouble__473</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__473(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__473_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3462);
			for(int nPlayers = 0; nPlayers<3462; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3462);
			...
			for(int nPlayers = 0; nPlayers<3462; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__472[nPlayers], this.Vdouble__473[nPlayers]);
			}
			...
			Gaussian[] vdouble1320_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1320_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1320_B'
			Gaussian[] vdouble1320_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1320_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1318_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1318_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1318_B'
			Gaussian[] vdouble1318_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1318_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1316_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1316_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1316_B'
			Gaussian[] vdouble1316_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1316_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool341_B'
			Bernoulli[] vbool341_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool341_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool341' from Not factor
					vbool341_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1314_F'
			Gaussian[] vdouble1314_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1314_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1314_B'
			Gaussian[] vdouble1314_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1314_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool338_B'
			Bernoulli[] vbool338_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool338_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool338' from Not factor
					vbool338_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						...
						vdouble1320_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1320' from IsPositive factor
						vdouble1320_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1320_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1320_B[nMatches]);
					...
					if (this.Team2wins[nMatches]==0) {
						...
						vdouble1318_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble1318' from IsPositive factor
						vdouble1318_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1318_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1318_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1316' from Difference factor
						vdouble1316_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1316' from IsPositive factor
						vdouble1316_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool341_B[nMatches], vdouble1316_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1316_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1314' from Difference factor
						vdouble1314_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1314' from IsPositive factor
						vdouble1314_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool338_B[nMatches], vdouble1314_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1314_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__473_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__472</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__472(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__472_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__474_F;
			// Create array for 'vdouble__474' Forwards messages.
			vdouble__474_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__474_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____112_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____112_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1288_F'
			Gaussian[][][] vdouble1288_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1286_F'
			Gaussian[][][] vdouble1286_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1292_F'
			Gaussian[] vdouble1292_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1293_F'
			Gaussian[] vdouble1293_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						vdouble1286_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__472[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1288_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1288' from Product factor
						vdouble1288_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1286_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____112' from Ratio factor
						vdouble____112_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1288_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1292_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1292' from Sum factor
				vdouble1292_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____112_F[nMatches][0]);
				vdouble1293_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1293' from Sum factor
				vdouble1293_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____112_F[nMatches][1]);
				// Message to 'vdouble__474' from Difference factor
				vdouble__474_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1292_F[nMatches], vdouble1293_F[nMatches]), string.Format("vdouble__474_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__474_use_B_reduced;
			vdouble__474_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__474_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__474_use_B_reduced, vdouble__474_F[nMatches], this.vdouble__474_marginal_F[nMatches], this.vdouble__474_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__474_marginal' from VariablePoint factor
					this.vdouble__474_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__474_use_B_reduced, vdouble__474_F[nMatches], this.vdouble__474_use_B_nMatches__buffer[nMatches], this.vdouble__474_marginal_F[nMatches]), string.Format("vdouble__474_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__472_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__472 and vdouble__473</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__472</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__474_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__474_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__472 and vdouble__473</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__472 and vdouble__473</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool342'
			bool[] vbool342 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool342[nMatches] = true;
					Constrain.Equal<bool>(true, vbool342[nMatches]);
				}
			}
			// Create array for replicates of 'vbool344'
			bool[] vbool344 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vbool344[nMatches] = true;
					Constrain.Equal<bool>(true, vbool344[nMatches]);
				}
			}
			// Create array for replicates of 'vbool346'
			bool[] vbool346 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool346[nMatches] = true;
					Constrain.Equal<bool>(true, vbool346[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__472</summary>
		private void Changed_vdouble__472()
		{
			if (this.Changed_vdouble__472_isDone) {
				return ;
			}
			// Create array for 'vdouble__472_marginal' Forwards messages.
			this.vdouble__472_marginal_F = new DistributionStructArray<Gaussian,double>(3462);
			for(int nPlayers = 0; nPlayers<3462; nPlayers++) {
				this.vdouble__472_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__472_marginal' from DerivedVariable factor
			this.vdouble__472_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__472, this.vdouble__472_marginal_F);
			this.Changed_vdouble__472_isDone = true;
		}
		...
		private void Changed_vdouble__473()
		{
			...
			this.vdouble__473_marginal_F = new DistributionStructArray<Gaussian,double>(3462);
			for(int nPlayers = 0; nPlayers<3462; nPlayers++) {
		...
		private void Constant()
		{
			...
			// Create array for 'vdouble__474_marginal' Forwards messages.
			this.vdouble__474_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__474_use_B_nMatches__buffer'
			this.vdouble__474_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3462);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__473(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__472(numberOfIterations);
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__472") {
				this.vdouble__472 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__473") {
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__474_marginal_F);
		}
