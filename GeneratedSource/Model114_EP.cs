...
namespace Models
{
	...
	public partial class Model114_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_matchTime_numberOfIterations_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010 has executed. Set this to false to force re-execution of Changed_matchTime_numberOfIterations_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010</summary>
		public bool Changed_matchTime_numberOfIterations_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isDone;
		/// <summary>True if Changed_numberOfIterations_PlayerIndex_PlayerInTeam_time_passed_vdouble__1010_vdouble__1011_vint__263 has executed. Set this to false to force re-execution of Changed_numberOfIterations_PlayerIndex_PlayerInTeam_time_passed_vdouble__1010_vdouble__1011_vint__263</summary>
		public bool Changed_numberOfIterations_PlayerIndex_PlayerInTeam_time_passed_vdouble__1010_vdouble__1011_vint__263_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010</summary>
		public bool Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010</summary>
		public bool Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isInitialised;
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015_isInitialised;
		...
		public double[] matchTime
		{
			...
			set {
				if ((value!=null)&&(value.Length!=521)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+521)+" was expected for variable \'matchTime\'");
				}
				this.MatchTime = value;
				this.numberOfIterationsDone = 0;
				this.Changed_matchTime_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isInitialised = false;
				this.Changed_matchTime_numberOfIterations_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isDone = false;
			}
		}
		...
		public int[][][] PlayerIndex
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015_isDone = false;
				this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_time_passed_vdouble__1010_vdouble__1011_vint__263_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isInitialised = false;
				this.Changed_matchTime_numberOfIterations_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isDone = false;
			}
		}
		...
		public double[][][] playerTime
		{
			...
			set {
				if ((value!=null)&&(value.Length!=521)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+521)+" was expected for variable \'playerTime\'");
				}
		...
		public double[][][] time_passed
		{
			...
			set {
				...
				this.numberOfIterationsDone = 0;
				this.Changed_PlayerInTeam_time_passed_isDone = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015_isInitialised = false;
				this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_time_passed_vdouble__1010_vdouble__1011_vint__263_isDone = false;
			}
		}
		...
		private void Changed_matchTime()
		{
			...
			this.matchTime_marginal_F = new DistributionStructArray<Gaussian,double>(521);
		...
		/// <summary>Computations that depend on the observed value of matchTime and numberOfIterations and PlayerIndex and PlayerInTeam and playerTime and vdouble__1010</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_matchTime_numberOfIterations_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010(int numberOfIterations)
		{
			if (this.Changed_matchTime_numberOfIterations_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isDone) {
				return ;
			}
			...
			for(int nMatches = 0; nMatches<521; nMatches++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						vdouble3411_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble3409_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.PlayerTime[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____292' from Ratio factor
						vdouble____292_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble3411_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.MatchTime[nMatches]);
					}
				}
			...
			this.Changed_matchTime_numberOfIterations_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isDone = true;
		}
		...
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_numberOfIterations_PlayerIndex_PlayerInTeam_time_passed_vdouble__1010_vdouble__1011_vint__263(int numberOfIterations)
		{
			if (this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_time_passed_vdouble__1010_vdouble__1011_vint__263_isDone) {
				return ;
			}
			...
			this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_time_passed_vdouble__1010_vdouble__1011_vint__263_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to matchTime and PlayerIndex and PlayerInTeam and playerTime and vdouble__1010</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<521; nMatches++) {
			...
			this.Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isDone = true;
			this.Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isInitialised = true;
		}
		...
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<521; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015_isDone = true;
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015_isInitialised = true;
		}
		...
		private void Changed_PlayerInTeam_playerTime()
		{
			...
			this.playerTime_marginal_F = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,double[][]>(521);
			for(int nMatches = 0; nMatches<521; nMatches++) {
				// Create array for 'playerTime_marginal' Forwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			if (numberOfIterations!=this.numberOfIterationsDone) {
				if (numberOfIterations<this.numberOfIterationsDone) {
					this.numberOfIterationsDone = 0;
					this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015_isDone = false;
					this.Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isDone = false;
				}
				this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_time_passed_vdouble__1010_vdouble__1011_vint__263_isDone = false;
				this.Changed_matchTime_numberOfIterations_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010_isDone = false;
			}
			...
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__266_Init_time_passed_vdouble__1015(initialise);
			this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_time_passed_vdouble__1010_vdouble__1011_vint__263(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_matchTime_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010(initialise);
			this.Changed_matchTime_numberOfIterations_PlayerIndex_PlayerInTeam_playerTime_vdouble__1010(numberOfIterations);
