...
namespace Models
{
	...
	public partial class Model5_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73 has executed. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73</summary>
		public bool Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_isDone;
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311 has executed. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311_isDone;
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311 has performed initialisation. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311_isInitialised;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10</summary>
		public bool Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10</summary>
		public bool Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10_isInitialised;
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9_isInitialised;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8</summary>
		public bool Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8</summary>
		public bool Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8_isInitialised;
		...
		/// <summary>True if Changed_vdouble__73 has executed. Set this to false to force re-execution of Changed_vdouble__73</summary>
		public bool Changed_vdouble__73_isDone;
		/// <summary>True if Changed_vdouble__73_vdouble__74 has executed. Set this to false to force re-execution of Changed_vdouble__73_vdouble__74</summary>
		public bool Changed_vdouble__73_vdouble__74_isDone;
		/// <summary>True if Changed_vdouble__74 has executed. Set this to false to force re-execution of Changed_vdouble__74</summary>
		public bool Changed_vdouble__74_isDone;
		...
		/// <summary>Field backing the vdouble__73 property</summary>
		private double[] Vdouble__73;
		/// <summary>Message to marginal of 'vdouble__73'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__73_marginal_F;
		/// <summary>Field backing the vdouble__74 property</summary>
		private double[] Vdouble__74;
		...
		public RpropBufferData[] vdouble__75_use_B_nMatches__buffer;
		public double[][] vdouble278_reduced;
		public double[][] vdouble285_reduced;
		public double[][] vdouble286_reduced;
		public Gaussian[][][] vdouble287_F;
		public Gaussian[][][] vdouble288_F;
		public double[][] vdouble290_reduced;
		public double[][] vdouble291_reduced;
		public Gaussian[][][] vdouble292_B;
		public Gaussian[][][] vdouble292_F;
		public Gaussian[][][] vdouble293_B;
		public Gaussian[][][] vdouble293_F;
		public Gaussian[][][] vdouble296_F;
		public Gaussian[][][] vdouble298_B;
		public Gaussian[][][] vdouble298_F;
		public Gaussian[][][] vdouble299_B;
		public Gaussian[][][] vdouble299_F;
		public Gaussian[][][] vdouble302_F;
		/// <summary>Message from use of 'vdouble302'</summary>
		public Gaussian[][][] vdouble302_use_B;
		public Gaussian[][][] vdouble306_F;
		public Gaussian[][][] vdouble308_B;
		public Gaussian[][][] vdouble308_F;
		public Gaussian[][][] vdouble309_B;
		public Gaussian[][][] vdouble309_F;
		public Gaussian[][][] vdouble312_F;
		/// <summary>Message from use of 'vdouble312'</summary>
		public Gaussian[][][] vdouble312_use_B;
		#endregion
		...
		public double[][][] deathcount
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10_isInitialised = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311_isInitialised = false;
		...
		public double[] Match_time_m
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10_isInitialised = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3_isDone = false;
				...
				this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_isDone = false;
			}
		}
		...
		public double[][][] p_time_m__t__n
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3_isDone = false;
		...
		public int[][][] PlayerIndex
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9_isDone = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__73'</summary>
		public double[] vdouble__73
		{
			get {
				return this.Vdouble__73;
			}
			set {
				if ((value!=null)&&(value.Length!=6693)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6693)+" was expected for variable \'vdouble__73\'");
				}
				this.Vdouble__73 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__73_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_17_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_7_isInitialised = false;
				this.Changed_vdouble__73_vdouble__74_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8_isDone = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9_isDone = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__74'</summary>
		public double[] vdouble__74
		{
			get {
				return this.Vdouble__74;
			}
			set {
				if ((value!=null)&&(value.Length!=6693)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6693)+" was expected for variable \'vdouble__74\'");
				}
				this.Vdouble__74 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__74_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_17_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_7_isInitialised = false;
				this.Changed_vdouble__73_vdouble__74_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of deathcount and killcount and Match_time_m and numberOfIterations and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins and vdouble__73 and vdouble__74</summary>
		...
		private void Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3(int numberOfIterations)
		{
			...
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(6693);
			...
			// Create array for replicates of 'vdouble288_B'
			Gaussian[][][] vdouble288_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble288_B'
				vdouble288_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble288_B'
					vdouble288_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble288_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			// Create array for replicates of 'vdouble287_B'
			Gaussian[][][] vdouble287_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble287_B'
				vdouble287_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble287_B'
					vdouble287_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble287_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble325_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble325_B'
			Gaussian[] vdouble325_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble325_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble323_F[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble323_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble321_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble321_F[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble321_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool41_B'
			Bernoulli[] vbool41_B = new Bernoulli[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool41_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool41' from Not factor
					vbool41_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble319_F[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble319_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool38_B'
			Bernoulli[] vbool38_B = new Bernoulli[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool38_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool38' from Not factor
					vbool38_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
				...
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.vdouble296_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(2.5567203850565789, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble299' from Plus factor
							this.vdouble299_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble296_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble298_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Product factor
							this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble299_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble302' from Gaussian factor
							this.vdouble302_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble302_use' from Max factor
							this.vdouble302_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Killcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble302_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Gaussian factor
							this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble302_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble299' from Product factor
							this.vdouble299_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble298' from Plus factor
							this.vdouble298_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble299_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble296_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0] = GaussianProductOpBase.BAverageConditional(this.vdouble298_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -0.54459509911730619);
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							this.vdouble306_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-2.7928178121382596, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble309' from Plus factor
							this.vdouble309_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble306_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble308_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Product factor
							this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble309_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble312' from Gaussian factor
							this.vdouble312_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble312_use' from Max factor
							this.vdouble312_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Deathcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble312_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Gaussian factor
							this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble312_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble309' from Product factor
							this.vdouble309_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble308' from Plus factor
							this.vdouble308_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble309_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble306_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(this.vdouble308_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.79084835337752024);
							// Message to 'player_perf_t__n_uses' from Replicate factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==0) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'vdouble288' from Product factor
								vdouble288_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble286_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble287' from Ratio factor
								vdouble287_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble288_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble287' from Sum factor
								this.vdouble287_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_0_0_' from Sum factor
								this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble287_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble287_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble288' from Ratio factor
								this.vdouble288_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble287_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_0_' from Product factor
								this.Perfomance_opposing_team_0__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble286_reduced[nMatches][nTeamsPerMatch], this.vdouble288_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							}
					...
					if (this.Team2wins[nMatches]==1) {
						...
						vdouble325_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062759999999999996, Diff_F[nMatches]);
						// Message to 'vdouble325' from IsPositive factor
						vdouble325_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble325_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062759999999999996, vdouble325_B[nMatches]);
					...
					if (this.Team2wins[nMatches]==0) {
						...
						vdouble323_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062759999999999996);
						// Message to 'vdouble323' from IsPositive factor
						vdouble323_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble323_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble323_B[nMatches], 0.062759999999999996);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble321' from Difference factor
						vdouble321_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062759999999999996, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble321' from IsPositive factor
						vdouble321_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool41_B[nMatches], vdouble321_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062759999999999996, vdouble321_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble319' from Difference factor
						vdouble319_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062759999999999996);
						// Message to 'vdouble319' from IsPositive factor
						vdouble319_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool38_B[nMatches], vdouble319_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble319_B[nMatches], 0.062759999999999996);
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==1) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'Perfomance_opposing_team' from Replicate factor
								this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = ReplicateOp_NoDivide.DefAverageConditional<Gaussian>(this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble293' from Product factor
								this.vdouble293_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble291_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble292' from Ratio factor
								this.vdouble292_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(this.vdouble293_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble292' from Sum factor
								this.vdouble292_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_1_1_' from Sum factor
								this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(this.vdouble292_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble292_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble293' from Ratio factor
								this.vdouble293_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble292_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_1_' from Product factor
								this.Perfomance_opposing_team_1__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble291_reduced[nMatches][nTeamsPerMatch], this.vdouble293_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							// Message to 'vdouble298' from Product factor
							this.vdouble298_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-0.54459509911730619, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							// Message to 'vdouble296' from Plus factor
							vdouble296_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble299_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble298_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble308' from Product factor
							this.vdouble308_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(0.79084835337752024, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble306' from Plus factor
							vdouble306_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble309_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble308_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						}
						if (nTeamsPerMatch==1) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble296_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 2.5567203850565789);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = GaussianProductOpBase.BAverageConditional(vdouble306_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -2.7928178121382596);
			...
			for(int nPlayers = 0; nPlayers<6693; nPlayers++) {
		...
		/// <summary>Computations that depend on the observed value of deathcount and killcount and Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__73 and vdouble__74 and must reset on changes to team2wins</summary>
		...
		/// <summary>Computations that depend on the observed value of killcount and Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__73 and vdouble__74 and must reset on changes to deathcount and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterations and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__73</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73(int numberOfIterations)
		{
			if (this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__75_F;
			// Create array for 'vdouble__75' Forwards messages.
			vdouble__75_F = new DistributionStructArray<Gaussian,double>(1000);
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				vdouble__75_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____26_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____26_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[1000];
			// Create array for replicates of 'vdouble263_F'
			Gaussian[] vdouble263_F = new Gaussian[1000];
			// Create array for replicates of 'vdouble262_F'
			Gaussian[] vdouble262_F = new Gaussian[1000];
			// Create array for replicates of 'vdouble258_F'
			Gaussian[][][] vdouble258_F = new Gaussian[1000][][];
			// Create array for replicates of 'vdouble256_F'
			Gaussian[][][] vdouble256_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for 'vdouble____26' Forwards messages.
				vdouble____26_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble258_F'
				vdouble258_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble256_F'
				vdouble256_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____26' Forwards messages.
					vdouble____26_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble256_F'
					vdouble256_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble258_F'
					vdouble258_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____26_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble256_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble256' from Gaussian factor
						vdouble256_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__73[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble258_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble258' from Product factor
						vdouble258_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble256_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____26' from Ratio factor
						vdouble____26_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble258_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.match_time_m[nMatches]);
					}
				}
				vdouble262_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble262' from Sum factor
				vdouble262_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____26_F[nMatches][0]);
				vdouble263_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble263' from Sum factor
				vdouble263_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____26_F[nMatches][1]);
				// Message to 'vdouble__75' from Difference factor
				vdouble__75_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble262_F[nMatches], vdouble263_F[nMatches]), string.Format("vdouble__75_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__75_use_B_reduced;
			vdouble__75_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					this.vdouble__75_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__75_use_B_reduced, vdouble__75_F[nMatches], this.vdouble__75_marginal_F[nMatches], this.vdouble__75_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__75_marginal' from VariablePoint factor
					this.vdouble__75_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__75_use_B_reduced, vdouble__75_F[nMatches], this.vdouble__75_use_B_nMatches__buffer[nMatches], this.vdouble__75_marginal_F[nMatches]), string.Format("vdouble__75_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__73 and vdouble__74 and must reset on changes to deathcount and killcount and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311(bool initialise)
		{
			if (this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311_isDone&&((!initialise)||this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311_isDone = true;
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311_isInitialised = true;
		}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble291_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble290_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
						this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble278_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						if (nTeamsPerMatch==0) {
							this.vdouble286_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble285_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins and vdouble__73 and vdouble__74</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__73</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdoubl2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble__75_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__75_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__73 and vdouble__74 and must reset on changes to deathcount and killcount and Match_time_m and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10_isDone = true;
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerIndex and PlayerInTeam and vdouble__73 and vdouble__74 and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Message to 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' from GetDeepJaggedItems factor
			...
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9_isDone = true;
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and team2wins and vdouble__73 and vdouble__74</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble299_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble298_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==1) {
							...
							this.vdouble293_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble292_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							for(int _a4 = 0; _a4<this.playerInTeam[nMatches][1]; _a4++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble298_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble299_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble302_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble302_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==0) {
							...
							this.vdouble288_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble287_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							for(int _a3 = 0; _a3<this.playerInTeam[nMatches][0]; _a3++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble308_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble306_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble309_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble312_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						this.vdouble309_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble308_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						if (nTeamsPerMatch==1) {
							this.vdouble292_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble293_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__73 and vdouble__74</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and vdouble__73 and vdouble__74 and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8_isInitialised)) {
				return ;
			}
			this.skills_prior_use_F_marginal = GetDeepJaggedItemsOp<double>.Marginal<DistributionStructArray<Gaussian,double>,Gaussian>(this.skills_prior_F, this.skills_prior_use_B, this.skills_prior_use_F_marginal);
			this.Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8_isDone = true;
			this.Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8_isInitialised = true;
		}
		...
		private void Changed_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble290_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][0]);
						}
						this.vdouble278_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][nTeamsPerMatch]);
					}
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
					...
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==0) {
							this.vdouble285_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][1]);
						}
					}
				}
			}
		...
		private void Changed_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					// Create array for replicates of 'vdouble299_F'
					this.vdouble299_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble298_F'
					this.vdouble298_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble290_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble291_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble293_F'
					this.vdouble293_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble292_F'
					this.vdouble292_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					if (nTeamsPerMatch==1) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble278_reduced[nMatches][nTeamsPerMatch] = default(double);
					...
					// Create array for replicates of 'vdouble298_B'
					this.vdouble298_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble299_B'
					this.vdouble299_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble302_use_B'
					this.vdouble302_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble302_F'
					this.vdouble302_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble285_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble286_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble288_F'
					this.vdouble288_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble287_F'
					this.vdouble287_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					if (nTeamsPerMatch==0) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					// Create array for replicates of 'vdouble308_B'
					this.vdouble308_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble309_B'
					this.vdouble309_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble312_use_B'
					this.vdouble312_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble309_F'
					this.vdouble309_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble308_F'
					this.vdouble308_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble292_B'
					this.vdouble292_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble293_B'
					this.vdouble293_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				}
			}
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool42'
			bool[] vbool42 = new bool[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool42[nMatches] = true;
					Constrain.Equal<bool>(true, vbool42[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__73</summary>
		private void Changed_vdouble__73()
		{
			if (this.Changed_vdouble__73_isDone) {
				return ;
			}
			// Create array for 'vdouble__73_marginal' Forwards messages.
			this.vdouble__73_marginal_F = new DistributionStructArray<Gaussian,double>(6693);
			for(int nPlayers = 0; nPlayers<6693; nPlayers++) {
				this.vdouble__73_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__73_marginal' from DerivedVariable factor
			this.vdouble__73_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__73, this.vdouble__73_marginal_F);
			this.Changed_vdouble__73_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__73 and vdouble__74</summary>
		private void Changed_vdouble__73_vdouble__74()
		{
			if (this.Changed_vdouble__73_vdouble__74_isDone) {
				return ;
			}
			for(int nPlayers = 0; nPlayers<6693; nPlayers++) {
				// Message to 'skills_prior' from Gaussian factor
				this.skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__73[nPlayers], this.Vdouble__74[nPlayers]);
			}
			this.Changed_vdouble__73_vdouble__74_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__74</summary>
		private void Changed_vdouble__74()
		{
			if (this.Changed_vdouble__74_isDone) {
				return ;
			}
			// Create array for 'vdouble__74_marginal' Forwards messages.
			this.vdouble__74_marginal_F = new DistributionStructArray<Gaussian,double>(6693);
			for(int nPlayers = 0; nPlayers<6693; nPlayers++) {
				this.vdouble__74_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__74_marginal' from DerivedVariable factor
			this.vdouble__74_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__74, this.vdouble__74_marginal_F);
			this.Changed_vdouble__74_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__75_marginal_F = new DistributionStructArray<Gaussian,double>(1000);
			// Create array for replicates of 'vdouble__75_use_B_nMatches__buffer'
			this.vdouble__75_use_B_nMatches__buffer = new RpropBufferData[1000];
			// Create array for 'skills_prior' Forwards messages.
			this.skills_prior_F = new DistributionStructArray<Gaussian,double>(6693);
			for(int nPlayers = 0; nPlayers<6693; nPlayers++) {
				this.skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(6693);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Forwards messages.
			...
			// Create array for replicates of 'vdouble299_F'
			this.vdouble299_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble299_F'
				this.vdouble299_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble298_F'
			this.vdouble298_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble298_F'
				this.vdouble298_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'Perfomance_opposing_team_uses_F'
			...
			this.vdouble291_reduced = new double[1000][];
			this.vdouble290_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble290_reduced[nMatches] = new double[2];
				this.vdouble291_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble293_F'
			this.vdouble293_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble293_F'
				this.vdouble293_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble292_F'
			this.vdouble292_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble292_F'
				this.vdouble292_F[nMatches] = new Gaussian[2][];
			}
			...
			this.vdouble278_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble278_reduced[nMatches] = new double[2];
			...
			// Create array for replicates of 'vdouble298_B'
			this.vdouble298_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble298_B'
				this.vdouble298_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble299_B'
			this.vdouble299_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble299_B'
				this.vdouble299_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_B'
			...
			// Create array for replicates of 'vdouble302_use_B'
			this.vdouble302_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble302_use_B'
				this.vdouble302_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble302_F'
			this.vdouble302_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble302_F'
				this.vdouble302_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_F'
			...
			this.vdouble285_reduced = new double[1000][];
			this.vdouble286_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble285_reduced[nMatches] = new double[2];
				this.vdouble286_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble288_F'
			this.vdouble288_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble288_F'
				this.vdouble288_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble287_F'
			this.vdouble287_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble287_F'
				this.vdouble287_F[nMatches] = new Gaussian[2][];
			}
			...
			// Create array for replicates of 'vdouble308_B'
			this.vdouble308_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble308_B'
				this.vdouble308_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble306_F'
			...
			// Create array for replicates of 'vdouble309_B'
			this.vdouble309_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble309_B'
				this.vdouble309_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'death_count_m__t__n_B'
			...
			// Create array for replicates of 'vdouble312_use_B'
			this.vdouble312_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble312_use_B'
				this.vdouble312_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble312_F'
			...
			// Create array for replicates of 'vdouble309_F'
			this.vdouble309_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble309_F'
				this.vdouble309_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble308_F'
			this.vdouble308_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble308_F'
				this.vdouble308_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble292_B'
			this.vdouble292_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble292_B'
				this.vdouble292_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble293_B'
			this.vdouble293_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble293_B'
				this.vdouble293_B[nMatches] = new Gaussian[2][];
			}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__74();
			this.Changed_vdouble__73();
			...
			this.Changed_vdouble__73_vdouble__74();
			this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4(initialise);
			this.Changed_numberOfIterationsDecreased_vdouble__73_vdouble__74_Init_deathcount_killcount_Match_time_m_p8(initialise);
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_Init_deathcount9(initialise);
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73_vdouble__74_10(initialise);
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__7311(initialise);
			...
			this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__73(numberOfIterations);
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__73") {
				this.vdouble__73 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__74") {
				this.vdouble__74 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__75_marginal_F);
		}
