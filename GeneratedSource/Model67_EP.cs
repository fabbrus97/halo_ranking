...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 12:21 on giovedì 7 luglio 2022.
	/// </remarks>
	public partial class Model67_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__573 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__573</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__573_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__574 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__574</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__574_isDone;
		...
		/// <summary>True if Changed_vdouble__575 has executed. Set this to false to force re-execution of Changed_vdouble__575</summary>
		public bool Changed_vdouble__575_isDone;
		...
		/// <summary>Field backing the vdouble__575 property</summary>
		private double[] Vdouble__575;
		/// <summary>Message to marginal of 'vdouble__575'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__575_marginal_F;
		/// <summary>Message to marginal of 'vdouble__576'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__576_marginal_F;
		/// <summary>Buffer for VariablePointOp_Rprop.MarginalAverageConditional</summary>
		public RpropBufferData[] vdouble__576_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				if ((value!=null)&&(value.Length!=359)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+359)+" was expected for variable \'match_m_Time\'");
				}
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__573_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__574_isDone = false;
			}
		}
		...
		public double[][][] player_n_Time
		{
			...
			set {
				if ((value!=null)&&(value.Length!=359)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+359)+" was expected for variable \'player_n_Time\'");
				}
		...
		public double[] vdouble__574
		{
			...
			set {
				if ((value!=null)&&(value.Length!=2412)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+2412)+" was expected for variable \'vdouble__574\'");
				}
		...
		/// <summary>The externally-specified value of 'vdouble__575'</summary>
		public double[] vdouble__575
		{
			get {
				return this.Vdouble__575;
			}
			set {
				if ((value!=null)&&(value.Length!=2412)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+2412)+" was expected for variable \'vdouble__575\'");
				}
				this.Vdouble__575 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__575_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__573_isDone = false;
		...
		private void Changed_match_m_Time()
		{
			...
			this.match_m_Time_marginal_F = new DistributionStructArray<Gaussian,double>(359);
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__574 and vdouble__575</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__573(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__573_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(2412);
			...
			for(int nPlayers = 0; nPlayers<2412; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__574[nPlayers], this.Vdouble__575[nPlayers]);
			}
			...
			skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam__F = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,double[][]>(359);
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Forwards messages.
			...
			Gaussian[][][] perf_from_ds_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'perf_from_ds_F'
			...
			Gaussian[][][] perf_n_m_F = new Gaussian[359][][];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for replicates of 'perf_n_m_F'
			...
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] playerPerformance_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
			...
			Gaussian[] vdouble1596_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1596_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1596_B'
			Gaussian[] vdouble1596_B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1596_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1594_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1594_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1594_B'
			Gaussian[] vdouble1594_B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1594_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1592_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1592_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1592_B'
			Gaussian[] vdouble1592_B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1592_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool413_B'
			Bernoulli[] vbool413_B = new Bernoulli[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool413_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool413' from Not factor
					vbool413_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1590_F'
			Gaussian[] vdouble1590_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1590_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1590_B'
			Gaussian[] vdouble1590_B = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1590_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool410_B'
			Bernoulli[] vbool410_B = new Bernoulli[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool410_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool410' from Not factor
					vbool410_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] playerPerformance_B = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<359; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble1596' from Difference factor
						vdouble1596_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1596' from IsPositive factor
						vdouble1596_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1596_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1596_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble1594' from Difference factor
						vdouble1594_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble1594' from IsPositive factor
						vdouble1594_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1594_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1594_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1592' from Difference factor
						vdouble1592_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1592' from IsPositive factor
						vdouble1592_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool413_B[nMatches], vdouble1592_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1592_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1590' from Difference factor
						vdouble1590_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1590' from IsPositive factor
						vdouble1590_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool410_B[nMatches], vdouble1590_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1590_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__573_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__574</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__574(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__574_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__576_F;
			// Create array for 'vdouble__576' Forwards messages.
			vdouble__576_F = new DistributionStructArray<Gaussian,double>(359);
			for(int nMatches = 0; nMatches<359; nMatches++) {
				vdouble__576_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____136_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____136_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[359];
			// Create array for replicates of 'vdouble1564_F'
			Gaussian[][][] vdouble1564_F = new Gaussian[359][][];
			// Create array for replicates of 'vdouble1562_F'
			Gaussian[][][] vdouble1562_F = new Gaussian[359][][];
			// Create array for replicates of 'vdouble1568_F'
			Gaussian[] vdouble1568_F = new Gaussian[359];
			// Create array for replicates of 'vdouble1569_F'
			Gaussian[] vdouble1569_F = new Gaussian[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'vdouble____136' Forwards messages.
				vdouble____136_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble1562_F'
				vdouble1562_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1564_F'
				vdouble1564_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____136' Forwards messages.
					vdouble____136_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble1562_F'
					vdouble1562_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1564_F'
					vdouble1564_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____136_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1562_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1562' from Gaussian factor
						vdouble1562_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__574[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1564_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1564' from Product factor
						vdouble1564_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1562_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____136' from Ratio factor
						vdouble____136_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1564_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1568_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1568' from Sum factor
				vdouble1568_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____136_F[nMatches][0]);
				vdouble1569_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1569' from Sum factor
				vdouble1569_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____136_F[nMatches][1]);
				// Message to 'vdouble__576' from Difference factor
				vdouble__576_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1568_F[nMatches], vdouble1569_F[nMatches]), string.Format("vdouble__576_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__576_use_B_reduced;
			vdouble__576_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<359; nMatches++) {
					this.vdouble__576_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__576_use_B_reduced, vdouble__576_F[nMatches], this.vdouble__576_marginal_F[nMatches], this.vdouble__576_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__576_marginal' from VariablePoint factor
					this.vdouble__576_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__576_use_B_reduced, vdouble__576_F[nMatches], this.vdouble__576_use_B_nMatches__buffer[nMatches], this.vdouble__576_marginal_F[nMatches]), string.Format("vdouble__576_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__574_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__574 and vdouble__575</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__574</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<359; nMatches++) {
				this.vdouble__576_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__576_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__574 and vdouble__575</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__574 and vdouble__575</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_player_n_Time_PlayerInTeam()
		{
			...
			this.player_n_Time_marginal_F = new DistributionRefArray<DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,double[][]>(359);
			for(int nMatches = 0; nMatches<359; nMatches++) {
				// Create array for 'player_n_Time_marginal' Forwards messages.
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool411'
			bool[] vbool411 = new bool[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool411[nMatches] = true;
					Constrain.Equal<bool>(true, vbool411[nMatches]);
				}
			}
			// Create array for replicates of 'vbool414'
			bool[] vbool414 = new bool[359];
			for(int nMatches = 0; nMatches<359; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
		...
		private void Changed_vdouble__574()
		{
			...
			this.vdouble__574_marginal_F = new DistributionStructArray<Gaussian,double>(2412);
			for(int nPlayers = 0; nPlayers<2412; nPlayers++) {
				this.vdouble__574_marginal_F[nPlayers] = Gaussian.Uniform();
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__575</summary>
		private void Changed_vdouble__575()
		{
			if (this.Changed_vdouble__575_isDone) {
				return ;
			}
			// Create array for 'vdouble__575_marginal' Forwards messages.
			this.vdouble__575_marginal_F = new DistributionStructArray<Gaussian,double>(2412);
			for(int nPlayers = 0; nPlayers<2412; nPlayers++) {
				this.vdouble__575_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__575_marginal' from DerivedVariable factor
			this.vdouble__575_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__575, this.vdouble__575_marginal_F);
			this.Changed_vdouble__575_isDone = true;
		}
		...
		private void Constant()
		{
			...
			// Create array for 'vdouble__576_marginal' Forwards messages.
			this.vdouble__576_marginal_F = new DistributionStructArray<Gaussian,double>(359);
			// Create array for replicates of 'vdouble__576_use_B_nMatches__buffer'
			this.vdouble__576_use_B_nMatches__buffer = new RpropBufferData[359];
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__573(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__574(numberOfIterations);
		...
		{
			if (variableName=="vdouble__575") {
				return this.Vdouble__575Marginal();
			}
			if (variableName=="vdouble__574") {
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__575") {
				this.vdouble__575 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__575' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__575Marginal()
		{
			return this.vdouble__575_marginal_F;
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__576_marginal_F);
		}
