...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 17:12 on giovedì 7 luglio 2022.
	/// </remarks>
	public partial class Model19_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248 has executed. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248</summary>
		public bool Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_isDone;
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411 has executed. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411_isDone;
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411 has performed initialisation. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411_isInitialised;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410</summary>
		public bool Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410</summary>
		public bool Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410_isInitialised;
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9_isInitialised;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8</summary>
		public bool Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8</summary>
		public bool Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8_isInitialised;
		...
		/// <summary>True if Changed_vdouble__248 has executed. Set this to false to force re-execution of Changed_vdouble__248</summary>
		public bool Changed_vdouble__248_isDone;
		/// <summary>True if Changed_vdouble__248_vdouble__249 has executed. Set this to false to force re-execution of Changed_vdouble__248_vdouble__249</summary>
		public bool Changed_vdouble__248_vdouble__249_isDone;
		/// <summary>True if Changed_vdouble__249 has executed. Set this to false to force re-execution of Changed_vdouble__249</summary>
		public bool Changed_vdouble__249_isDone;
		...
		/// <summary>Field backing the vdouble__248 property</summary>
		private double[] Vdouble__248;
		/// <summary>Message to marginal of 'vdouble__248'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__248_marginal_F;
		/// <summary>Field backing the vdouble__249 property</summary>
		private double[] Vdouble__249;
		...
		public RpropBufferData[] vdouble__250_use_B_nMatches__buffer;
		public double[][] vdouble845_reduced;
		public double[][] vdouble852_reduced;
		public double[][] vdouble853_reduced;
		public Gaussian[][][] vdouble854_F;
		public Gaussian[][][] vdouble855_F;
		public double[][] vdouble857_reduced;
		public double[][] vdouble858_reduced;
		public Gaussian[][][] vdouble859_B;
		public Gaussian[][][] vdouble859_F;
		public Gaussian[][][] vdouble860_B;
		public Gaussian[][][] vdouble860_F;
		public Gaussian[][][] vdouble863_F;
		public Gaussian[][][] vdouble865_B;
		public Gaussian[][][] vdouble865_F;
		public Gaussian[][][] vdouble866_B;
		public Gaussian[][][] vdouble866_F;
		public Gaussian[][][] vdouble869_F;
		/// <summary>Message from use of 'vdouble869'</summary>
		public Gaussian[][][] vdouble869_use_B;
		public Gaussian[][][] vdouble873_F;
		public Gaussian[][][] vdouble875_B;
		public Gaussian[][][] vdouble875_F;
		public Gaussian[][][] vdouble876_B;
		public Gaussian[][][] vdouble876_F;
		public Gaussian[][][] vdouble879_F;
		/// <summary>Message from use of 'vdouble879'</summary>
		public Gaussian[][][] vdouble879_use_B;
		#endregion
		...
		public double[][][] deathcount
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410_isInitialised = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411_isInitialised = false;
		...
		public double[] Match_time_m
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410_isInitialised = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3_isDone = false;
				...
				this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_isDone = false;
			}
		}
		...
		public double[][][] p_time_m__t__n
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3_isDone = false;
		...
		public int[][][] PlayerIndex
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9_isDone = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__248'</summary>
		public double[] vdouble__248
		{
			get {
				return this.Vdouble__248;
			}
			set {
				if ((value!=null)&&(value.Length!=6675)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6675)+" was expected for variable \'vdouble__248\'");
				}
				this.Vdouble__248 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__248_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_17_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_7_isInitialised = false;
				this.Changed_vdouble__248_vdouble__249_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8_isDone = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9_isDone = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__249'</summary>
		public double[] vdouble__249
		{
			get {
				return this.Vdouble__249;
			}
			set {
				if ((value!=null)&&(value.Length!=6675)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6675)+" was expected for variable \'vdouble__249\'");
				}
				this.Vdouble__249 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__249_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_17_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_7_isInitialised = false;
				this.Changed_vdouble__248_vdouble__249_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of deathcount and killcount and Match_time_m and numberOfIterations and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins and vdouble__248 and vdouble__249</summary>
		...
		private void Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3(int numberOfIterations)
		{
			...
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(6675);
			...
			// Create array for replicates of 'vdouble855_B'
			Gaussian[][][] vdouble855_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble855_B'
				vdouble855_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble855_B'
					vdouble855_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble855_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			// Create array for replicates of 'vdouble854_B'
			Gaussian[][][] vdouble854_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble854_B'
				vdouble854_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble854_B'
					vdouble854_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble854_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			...
			// Create array for replicates of 'vdouble890_F'
			Gaussian[] vdouble890_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble890_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble890_B'
			Gaussian[] vdouble890_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble890_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble888_F'
			Gaussian[] vdouble888_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble888_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble888_B'
			Gaussian[] vdouble888_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble888_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool125_B'
			Bernoulli[] vbool125_B = new Bernoulli[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool125_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool125' from Not factor
					vbool125_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble886_F[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble886_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool122_B'
			Bernoulli[] vbool122_B = new Bernoulli[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool122_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool122' from Not factor
					vbool122_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
				...
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.vdouble863_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(2.5567203850565789, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble866' from Plus factor
							this.vdouble866_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble863_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble865_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Product factor
							this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble866_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble869' from Gaussian factor
							this.vdouble869_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble869_use' from Max factor
							this.vdouble869_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Killcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble869_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Gaussian factor
							this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble869_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble866' from Product factor
							this.vdouble866_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble865' from Plus factor
							this.vdouble865_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble866_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble863_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0] = GaussianProductOpBase.BAverageConditional(this.vdouble865_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -0.54459509911730619);
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							this.vdouble873_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-2.7928178121382596, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble876' from Plus factor
							this.vdouble876_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble873_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble875_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Product factor
							this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble876_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble879' from Gaussian factor
							this.vdouble879_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble879_use' from Max factor
							this.vdouble879_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Deathcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble879_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Gaussian factor
							this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble879_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble876' from Product factor
							this.vdouble876_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble875' from Plus factor
							this.vdouble875_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble876_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble873_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(this.vdouble875_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.79084835337752024);
							// Message to 'player_perf_t__n_uses' from Replicate factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==0) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'vdouble855' from Product factor
								vdouble855_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble853_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble854' from Ratio factor
								vdouble854_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble855_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble854' from Sum factor
								this.vdouble854_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_0_0_' from Sum factor
								this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble854_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble854_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble855' from Ratio factor
								this.vdouble855_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble854_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_0_' from Product factor
								this.Perfomance_opposing_team_0__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble853_reduced[nMatches][nTeamsPerMatch], this.vdouble855_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							}
					...
					if (this.Team2wins[nMatches]==1) {
						...
						vdouble892_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062759999999999996, Diff_F[nMatches]);
						...
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062759999999999996, vdouble892_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble890' from Difference factor
						vdouble890_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062759999999999996);
						// Message to 'vdouble890' from IsPositive factor
						vdouble890_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble890_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble890_B[nMatches], 0.062759999999999996);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble888' from Difference factor
						vdouble888_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062759999999999996, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble888' from IsPositive factor
						vdouble888_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool125_B[nMatches], vdouble888_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062759999999999996, vdouble888_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble886' from Difference factor
						vdouble886_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062759999999999996);
						// Message to 'vdouble886' from IsPositive factor
						vdouble886_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool122_B[nMatches], vdouble886_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble886_B[nMatches], 0.062759999999999996);
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==1) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								this.vdouble860_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble858_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble859' from Ratio factor
								this.vdouble859_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(this.vdouble860_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble859' from Sum factor
								this.vdouble859_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_1_1_' from Sum factor
								this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(this.vdouble859_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble859_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble860' from Ratio factor
								this.vdouble860_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble859_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_1_' from Product factor
								this.Perfomance_opposing_team_1__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble858_reduced[nMatches][nTeamsPerMatch], this.vdouble860_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							// Message to 'vdouble865' from Product factor
							this.vdouble865_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-0.54459509911730619, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							// Message to 'vdouble863' from Plus factor
							vdouble863_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble866_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble865_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble875' from Product factor
							this.vdouble875_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(0.79084835337752024, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble873' from Plus factor
							vdouble873_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble876_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble875_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						}
						if (nTeamsPerMatch==1) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble863_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 2.5567203850565789);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = GaussianProductOpBase.BAverageConditional(vdouble873_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -2.7928178121382596);
			...
			for(int nPlayers = 0; nPlayers<6675; nPlayers++) {
		...
		/// <summary>Computations that depend on the observed value of deathcount and killcount and Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__248 and vdouble__249 and must reset on changes to team2wins</summary>
		...
		/// <summary>Computations that depend on the observed value of killcount and Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__248 and vdouble__249 and must reset on changes to deathcount and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterations and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__248</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248(int numberOfIterations)
		{
			if (this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__250_F;
			// Create array for 'vdouble__250' Forwards messages.
			vdouble__250_F = new DistributionStructArray<Gaussian,double>(1000);
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				vdouble__250_F[nMatches] = Gaussian.Uniform();
			}
			...
			Gaussian[] vdouble830_F = new Gaussian[1000];
			// Create array for replicates of 'vdouble829_F'
			Gaussian[] vdouble829_F = new Gaussian[1000];
			// Create array for replicates of 'vdouble825_F'
			Gaussian[][][] vdouble825_F = new Gaussian[1000][][];
			// Create array for replicates of 'vdouble823_F'
			Gaussian[][][] vdouble823_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				...
				// Create array for replicates of 'vdouble823_F'
				vdouble823_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____82' Forwards messages.
					...
					// Create array for replicates of 'vdouble823_F'
					vdouble823_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble825_F'
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						vdouble823_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble823' from Gaussian factor
						vdouble823_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__248[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble825_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble825' from Product factor
						vdouble825_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble823_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____82' from Ratio factor
						vdouble____82_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble825_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.match_time_m[nMatches]);
					}
				}
				vdouble829_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble829' from Sum factor
				vdouble829_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____82_F[nMatches][0]);
				vdouble830_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble830' from Sum factor
				vdouble830_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____82_F[nMatches][1]);
				// Message to 'vdouble__250' from Difference factor
				vdouble__250_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble829_F[nMatches], vdouble830_F[nMatches]), string.Format("vdouble__250_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__250_use_B_reduced;
			vdouble__250_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					this.vdouble__250_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__250_use_B_reduced, vdouble__250_F[nMatches], this.vdouble__250_marginal_F[nMatches], this.vdouble__250_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__250_marginal' from VariablePoint factor
					this.vdouble__250_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__250_use_B_reduced, vdouble__250_F[nMatches], this.vdouble__250_use_B_nMatches__buffer[nMatches], this.vdouble__250_marginal_F[nMatches]), string.Format("vdouble__250_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__248 and vdouble__249 and must reset on changes to deathcount and killcount and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411(bool initialise)
		{
			if (this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411_isDone&&((!initialise)||this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411_isDone = true;
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411_isInitialised = true;
		}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble858_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble857_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
						this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble845_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						if (nTeamsPerMatch==0) {
							this.vdouble853_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble852_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins and vdouble__248 and vdouble__249</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__248</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdoubl2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble__250_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__250_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__248 and vdouble__249 and must reset on changes to deathcount and killcount and Match_time_m and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410_isDone = true;
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerIndex and PlayerInTeam and vdouble__248 and vdouble__249 and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Message to 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' from GetDeepJaggedItems factor
			...
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9_isDone = true;
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and team2wins and vdouble__248 and vdouble__249</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble863_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble866_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble865_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==1) {
							...
							this.vdouble860_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble859_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							for(int _a4 = 0; _a4<this.playerInTeam[nMatches][1]; _a4++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble865_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble866_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble869_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble869_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==0) {
							...
							this.vdouble855_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble854_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							for(int _a3 = 0; _a3<this.playerInTeam[nMatches][0]; _a3++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble875_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble873_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble876_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble879_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						this.vdouble876_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble875_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						if (nTeamsPerMatch==1) {
							this.vdouble859_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble860_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__248 and vdouble__249</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and vdouble__248 and vdouble__249 and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8_isInitialised)) {
				return ;
			}
			this.skills_prior_use_F_marginal = GetDeepJaggedItemsOp<double>.Marginal<DistributionStructArray<Gaussian,double>,Gaussian>(this.skills_prior_F, this.skills_prior_use_B, this.skills_prior_use_F_marginal);
			this.Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8_isDone = true;
			this.Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8_isInitialised = true;
		}
		...
		private void Changed_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble857_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][0]);
						}
						this.vdouble845_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][nTeamsPerMatch]);
					}
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
					...
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==0) {
							this.vdouble852_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][1]);
						}
					}
				}
			}
		...
		private void Changed_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble863_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble866_F'
					this.vdouble866_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble865_F'
					this.vdouble865_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble857_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble858_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble860_F'
					this.vdouble860_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble859_F'
					this.vdouble859_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					if (nTeamsPerMatch==1) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble845_reduced[nMatches][nTeamsPerMatch] = default(double);
					...
					// Create array for replicates of 'vdouble865_B'
					this.vdouble865_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble866_B'
					this.vdouble866_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble869_use_B'
					this.vdouble869_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble869_F'
					this.vdouble869_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble852_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble853_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble855_F'
					this.vdouble855_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble854_F'
					this.vdouble854_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					if (nTeamsPerMatch==0) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble875_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble873_F'
					this.vdouble873_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble876_B'
					this.vdouble876_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble879_use_B'
					this.vdouble879_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble876_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble875_F'
					this.vdouble875_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble859_B'
					this.vdouble859_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble860_B'
					this.vdouble860_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				}
			}
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool123'
			bool[] vbool123 = new bool[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool123[nMatches] = true;
					Constrain.Equal<bool>(true, vbool123[nMatches]);
				}
			}
			...
			// Create array for replicates of 'vbool130'
			bool[] vbool130 = new bool[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool130[nMatches] = true;
					Constrain.Equal<bool>(true, vbool130[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__248</summary>
		private void Changed_vdouble__248()
		{
			if (this.Changed_vdouble__248_isDone) {
				return ;
			}
			// Create array for 'vdouble__248_marginal' Forwards messages.
			this.vdouble__248_marginal_F = new DistributionStructArray<Gaussian,double>(6675);
			for(int nPlayers = 0; nPlayers<6675; nPlayers++) {
				this.vdouble__248_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__248_marginal' from DerivedVariable factor
			this.vdouble__248_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__248, this.vdouble__248_marginal_F);
			this.Changed_vdouble__248_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__248 and vdouble__249</summary>
		private void Changed_vdouble__248_vdouble__249()
		{
			if (this.Changed_vdouble__248_vdouble__249_isDone) {
				return ;
			}
			for(int nPlayers = 0; nPlayers<6675; nPlayers++) {
				// Message to 'skills_prior' from Gaussian factor
				this.skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__248[nPlayers], this.Vdouble__249[nPlayers]);
			}
			this.Changed_vdouble__248_vdouble__249_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__249</summary>
		private void Changed_vdouble__249()
		{
			if (this.Changed_vdouble__249_isDone) {
				return ;
			}
			// Create array for 'vdouble__249_marginal' Forwards messages.
			this.vdouble__249_marginal_F = new DistributionStructArray<Gaussian,double>(6675);
			for(int nPlayers = 0; nPlayers<6675; nPlayers++) {
				this.vdouble__249_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__249_marginal' from DerivedVariable factor
			this.vdouble__249_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__249, this.vdouble__249_marginal_F);
			this.Changed_vdouble__249_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__250_marginal_F = new DistributionStructArray<Gaussian,double>(1000);
			// Create array for replicates of 'vdouble__250_use_B_nMatches__buffer'
			this.vdouble__250_use_B_nMatches__buffer = new RpropBufferData[1000];
			// Create array for 'skills_prior' Forwards messages.
			this.skills_prior_F = new DistributionStructArray<Gaussian,double>(6675);
			for(int nPlayers = 0; nPlayers<6675; nPlayers++) {
				this.skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(6675);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Forwards messages.
			...
			// Create array for replicates of 'vdouble863_F'
			this.vdouble863_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble863_F'
				this.vdouble863_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble866_F'
			this.vdouble866_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble866_F'
				this.vdouble866_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble865_F'
			this.vdouble865_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble865_F'
				this.vdouble865_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'Perfomance_opposing_team_uses_F'
			...
			this.vdouble858_reduced = new double[1000][];
			this.vdouble857_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble857_reduced[nMatches] = new double[2];
				this.vdouble858_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble860_F'
			this.vdouble860_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble860_F'
				this.vdouble860_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble859_F'
			this.vdouble859_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble859_F'
				this.vdouble859_F[nMatches] = new Gaussian[2][];
			}
			...
			this.vdouble845_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble845_reduced[nMatches] = new double[2];
			...
			// Create array for replicates of 'vdouble865_B'
			this.vdouble865_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble865_B'
				this.vdouble865_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble866_B'
			this.vdouble866_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble866_B'
				this.vdouble866_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_B'
			...
			// Create array for replicates of 'vdouble869_use_B'
			this.vdouble869_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble869_use_B'
				this.vdouble869_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble869_F'
			this.vdouble869_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble869_F'
				this.vdouble869_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_F'
			...
			this.vdouble852_reduced = new double[1000][];
			this.vdouble853_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble852_reduced[nMatches] = new double[2];
				this.vdouble853_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble855_F'
			this.vdouble855_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble855_F'
				this.vdouble855_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble854_F'
			this.vdouble854_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble854_F'
				this.vdouble854_F[nMatches] = new Gaussian[2][];
			}
			...
			// Create array for replicates of 'vdouble875_B'
			this.vdouble875_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble875_B'
				this.vdouble875_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble873_F'
			this.vdouble873_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble873_F'
				this.vdouble873_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble876_B'
			this.vdouble876_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble876_B'
				this.vdouble876_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'death_count_m__t__n_B'
			...
			// Create array for replicates of 'vdouble879_use_B'
			this.vdouble879_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble879_use_B'
				this.vdouble879_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble879_F'
			...
			// Create array for replicates of 'vdouble876_F'
			this.vdouble876_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble876_F'
				this.vdouble876_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble875_F'
			this.vdouble875_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble875_F'
				this.vdouble875_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble859_B'
			this.vdouble859_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble859_B'
				this.vdouble859_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble860_B'
			this.vdouble860_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble860_B'
				this.vdouble860_B[nMatches] = new Gaussian[2][];
			}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__249();
			this.Changed_vdouble__248();
			...
			this.Changed_vdouble__248_vdouble__249();
			this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4(initialise);
			this.Changed_numberOfIterationsDecreased_vdouble__248_vdouble__249_Init_deathcount_killcount_Match_time_m8(initialise);
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__249_Init_deathcou9(initialise);
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248_vdouble__2410(initialise);
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__2411(initialise);
			...
			this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__248(numberOfIterations);
		...
		public object Marginal(string variableName)
		{
			...
			if (variableName=="vdouble__248") {
				return this.Vdouble__248Marginal();
			}
			if (variableName=="Match_time_m") {
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__248") {
				this.vdouble__248 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__249") {
				this.vdouble__249 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__248' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__248Marginal()
		{
			return this.vdouble__248_marginal_F;
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__250_marginal_F);
		}
