...
namespace Models
{
	...
	public partial class Model49_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__423 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__423</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__423_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__421 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__421</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__421_isDone;
		...
		/// <summary>True if Changed_vdouble__421 has executed. Set this to false to force re-execution of Changed_vdouble__421</summary>
		public bool Changed_vdouble__421_isDone;
		/// <summary>True if Changed_vdouble__422 has executed. Set this to false to force re-execution of Changed_vdouble__422</summary>
		public bool Changed_vdouble__422_isDone;
		...
		/// <summary>Field backing the vdouble__421 property</summary>
		private double[] Vdouble__421;
		...
		/// <summary>Field backing the vdouble__422 property</summary>
		private double[] Vdouble__422;
		/// <summary>Message to marginal of 'vdouble__422'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__422_marginal_F;
		...
		public RpropBufferData[] vdouble__423_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__423_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__421_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__421'</summary>
		public double[] vdouble__421
		{
			get {
				return this.Vdouble__421;
			}
			set {
				if ((value!=null)&&(value.Length!=3353)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3353)+" was expected for variable \'vdouble__421\'");
				}
				this.Vdouble__421 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__421_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__423_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__422'</summary>
		public double[] vdouble__422
		{
			get {
				return this.Vdouble__422;
			}
			set {
				if ((value!=null)&&(value.Length!=3353)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3353)+" was expected for variable \'vdouble__422\'");
				}
				this.Vdouble__422 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__422_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__423_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__421 and vdouble__422</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__423(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__423_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3353);
			for(int nPlayers = 0; nPlayers<3353; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3353);
			...
			for(int nPlayers = 0; nPlayers<3353; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__421[nPlayers], this.Vdouble__422[nPlayers]);
			}
			...
			Gaussian[] vdouble1182_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1182_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1182_B'
			Gaussian[] vdouble1182_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1182_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1180_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1180_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1180_B'
			Gaussian[] vdouble1180_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1180_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1178_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1178_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1178_B'
			Gaussian[] vdouble1178_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1178_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool305_B'
			Bernoulli[] vbool305_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool305_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool305' from Not factor
					vbool305_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1176_F'
			Gaussian[] vdouble1176_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1176_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1176_B'
			Gaussian[] vdouble1176_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1176_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool302_B'
			Bernoulli[] vbool302_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool302_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool302' from Not factor
					vbool302_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble1182' from Difference factor
						vdouble1182_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1182' from IsPositive factor
						vdouble1182_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1182_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1182_B[nMatches]);
					...
					if (this.Team2wins[nMatches]==0) {
						...
						vdouble1180_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble1180' from IsPositive factor
						vdouble1180_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1180_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1180_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						vdouble1178_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1178' from IsPositive factor
						vdouble1178_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool305_B[nMatches], vdouble1178_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1178_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1176' from Difference factor
						vdouble1176_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1176' from IsPositive factor
						vdouble1176_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool302_B[nMatches], vdouble1176_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1176_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__423_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__421</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__421(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__421_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__423_F;
			// Create array for 'vdouble__423' Forwards messages.
			vdouble__423_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__423_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____100_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____100_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1150_F'
			Gaussian[][][] vdouble1150_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1148_F'
			Gaussian[][][] vdouble1148_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1154_F'
			Gaussian[] vdouble1154_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1155_F'
			Gaussian[] vdouble1155_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				// Create array for 'vdouble____100' Forwards messages.
				vdouble____100_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble1148_F'
				vdouble1148_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1150_F'
				vdouble1150_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____100' Forwards messages.
					vdouble____100_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble1148_F'
					vdouble1148_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1150_F'
					vdouble1150_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____100_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1148_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1148' from Gaussian factor
						vdouble1148_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__421[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1150_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1150' from Product factor
						vdouble1150_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1148_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____100' from Ratio factor
						vdouble____100_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1150_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1154_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1154' from Sum factor
				vdouble1154_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____100_F[nMatches][0]);
				vdouble1155_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1155' from Sum factor
				vdouble1155_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____100_F[nMatches][1]);
				// Message to 'vdouble__423' from Difference factor
				vdouble__423_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1154_F[nMatches], vdouble1155_F[nMatches]), string.Format("vdouble__423_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__423_use_B_reduced;
			vdouble__423_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__423_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__423_use_B_reduced, vdouble__423_F[nMatches], this.vdouble__423_marginal_F[nMatches], this.vdouble__423_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__423_marginal' from VariablePoint factor
					this.vdouble__423_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__423_use_B_reduced, vdouble__423_F[nMatches], this.vdouble__423_use_B_nMatches__buffer[nMatches], this.vdouble__423_marginal_F[nMatches]), string.Format("vdouble__423_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__421_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__421 and vdouble__422</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__421</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__423_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__423_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__421 and vdouble__422</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__421 and vdouble__422</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool303'
			bool[] vbool303 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool303[nMatches] = true;
					Constrain.Equal<bool>(true, vbool303[nMatches]);
				}
			}
			// Create array for replicates of 'vbool306'
			bool[] vbool306 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
		...
		/// <summary>Computations that depend on the observed value of vdouble__421</summary>
		private void Changed_vdouble__421()
		{
			if (this.Changed_vdouble__421_isDone) {
				return ;
			}
			// Create array for 'vdouble__421_marginal' Forwards messages.
			this.vdouble__421_marginal_F = new DistributionStructArray<Gaussian,double>(3353);
			for(int nPlayers = 0; nPlayers<3353; nPlayers++) {
				this.vdouble__421_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__421_marginal' from DerivedVariable factor
			this.vdouble__421_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__421, this.vdouble__421_marginal_F);
			this.Changed_vdouble__421_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__422</summary>
		private void Changed_vdouble__422()
		{
			if (this.Changed_vdouble__422_isDone) {
				return ;
			}
			// Create array for 'vdouble__422_marginal' Forwards messages.
			this.vdouble__422_marginal_F = new DistributionStructArray<Gaussian,double>(3353);
			for(int nPlayers = 0; nPlayers<3353; nPlayers++) {
				this.vdouble__422_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__422_marginal' from DerivedVariable factor
			this.vdouble__422_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__422, this.vdouble__422_marginal_F);
			this.Changed_vdouble__422_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__423_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__423_use_B_nMatches__buffer'
			this.vdouble__423_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3353);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__422();
			this.Changed_vdouble__421();
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__423(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__421(numberOfIterations);
		...
		{
			if (variableName=="vdouble__422") {
				return this.Vdouble__422Marginal();
			}
			if (variableName=="vdouble__421") {
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__421") {
				this.vdouble__421 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__422") {
				this.vdouble__422 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__422' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__422Marginal()
		{
			return this.vdouble__422_marginal_F;
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__423_marginal_F);
		}
