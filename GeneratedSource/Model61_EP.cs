...
namespace Models
{
	...
	public partial class Model61_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__523 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__523</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__523_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__523 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__523</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__523_isDone;
		...
		/// <summary>True if Changed_vdouble__523 has executed. Set this to false to force re-execution of Changed_vdouble__523</summary>
		public bool Changed_vdouble__523_isDone;
		/// <summary>True if Changed_vdouble__524 has executed. Set this to false to force re-execution of Changed_vdouble__524</summary>
		public bool Changed_vdouble__524_isDone;
		...
		/// <summary>Field backing the vdouble__523 property</summary>
		private double[] Vdouble__523;
		...
		/// <summary>Field backing the vdouble__524 property</summary>
		private double[] Vdouble__524;
		/// <summary>Message to marginal of 'vdouble__524'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__524_marginal_F;
		...
		public RpropBufferData[] vdouble__525_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__523_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__523_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__523'</summary>
		public double[] vdouble__523
		{
			get {
				return this.Vdouble__523;
			}
			set {
				if ((value!=null)&&(value.Length!=3500)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3500)+" was expected for variable \'vdouble__523\'");
				}
				this.Vdouble__523 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__523_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__523_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__524'</summary>
		public double[] vdouble__524
		{
			get {
				return this.Vdouble__524;
			}
			set {
				if ((value!=null)&&(value.Length!=3500)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3500)+" was expected for variable \'vdouble__524\'");
				}
				this.Vdouble__524 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__524_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__523_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__523 and vdouble__524</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__523(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__523_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3500);
			for(int nPlayers = 0; nPlayers<3500; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3500);
			...
			for(int nPlayers = 0; nPlayers<3500; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__523[nPlayers], this.Vdouble__524[nPlayers]);
			}
			...
			Gaussian[] vdouble1458_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1458_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1458_B'
			Gaussian[] vdouble1458_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1458_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1456_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1456_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1456_B'
			Gaussian[] vdouble1456_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1456_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble1454_F'
			Gaussian[] vdouble1454_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1454_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1454_B'
			Gaussian[] vdouble1454_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1454_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool377_B'
			Bernoulli[] vbool377_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool377_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool377' from Not factor
					vbool377_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1452_F'
			Gaussian[] vdouble1452_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1452_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1452_B'
			Gaussian[] vdouble1452_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1452_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool374_B'
			Bernoulli[] vbool374_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool374_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool374' from Not factor
					vbool374_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						...
						vdouble1458_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1458' from IsPositive factor
						vdouble1458_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1458_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1458_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble1456' from Difference factor
						vdouble1456_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble1456' from IsPositive factor
						vdouble1456_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1456_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1456_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1454' from Difference factor
						vdouble1454_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1454' from IsPositive factor
						vdouble1454_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool377_B[nMatches], vdouble1454_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1454_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1452' from Difference factor
						vdouble1452_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1452' from IsPositive factor
						vdouble1452_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool374_B[nMatches], vdouble1452_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1452_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__523_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__523</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__523(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__523_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__525_F;
			// Create array for 'vdouble__525' Forwards messages.
			vdouble__525_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__525_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____124_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____124_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1426_F'
			Gaussian[][][] vdouble1426_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1424_F'
			Gaussian[][][] vdouble1424_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1430_F'
			Gaussian[] vdouble1430_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1431_F'
			Gaussian[] vdouble1431_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				// Create array for 'vdouble____124' Forwards messages.
				vdouble____124_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble1424_F'
				vdouble1424_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1426_F'
				vdouble1426_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____124' Forwards messages.
					vdouble____124_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble1424_F'
					vdouble1424_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1426_F'
					vdouble1426_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____124_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1424_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1424' from Gaussian factor
						vdouble1424_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__523[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1426_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1426' from Product factor
						vdouble1426_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1424_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____124' from Ratio factor
						vdouble____124_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1426_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1430_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1430' from Sum factor
				vdouble1430_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____124_F[nMatches][0]);
				vdouble1431_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1431' from Sum factor
				vdouble1431_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____124_F[nMatches][1]);
				// Message to 'vdouble__525' from Difference factor
				vdouble__525_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1430_F[nMatches], vdouble1431_F[nMatches]), string.Format("vdouble__525_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__525_use_B_reduced;
			vdouble__525_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__525_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__525_use_B_reduced, vdouble__525_F[nMatches], this.vdouble__525_marginal_F[nMatches], this.vdouble__525_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__525_marginal' from VariablePoint factor
					this.vdouble__525_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__525_use_B_reduced, vdouble__525_F[nMatches], this.vdouble__525_use_B_nMatches__buffer[nMatches], this.vdouble__525_marginal_F[nMatches]), string.Format("vdouble__525_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__523_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__523 and vdouble__524</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__523</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__525_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__525_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__523 and vdouble__524</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__523 and vdouble__524</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool378'
			bool[] vbool378 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool378[nMatches] = true;
					Constrain.Equal<bool>(true, vbool378[nMatches]);
				}
			}
			// Create array for replicates of 'vbool380'
			bool[] vbool380 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vbool380[nMatches] = true;
					Constrain.Equal<bool>(true, vbool380[nMatches]);
				}
			}
			// Create array for replicates of 'vbool382'
			bool[] vbool382 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool382[nMatches] = true;
					Constrain.Equal<bool>(true, vbool382[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__523</summary>
		private void Changed_vdouble__523()
		{
			if (this.Changed_vdouble__523_isDone) {
				return ;
			}
			// Create array for 'vdouble__523_marginal' Forwards messages.
			this.vdouble__523_marginal_F = new DistributionStructArray<Gaussian,double>(3500);
			for(int nPlayers = 0; nPlayers<3500; nPlayers++) {
				this.vdouble__523_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__523_marginal' from DerivedVariable factor
			this.vdouble__523_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__523, this.vdouble__523_marginal_F);
			this.Changed_vdouble__523_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__524</summary>
		private void Changed_vdouble__524()
		{
			if (this.Changed_vdouble__524_isDone) {
				return ;
			}
			// Create array for 'vdouble__524_marginal' Forwards messages.
			this.vdouble__524_marginal_F = new DistributionStructArray<Gaussian,double>(3500);
			for(int nPlayers = 0; nPlayers<3500; nPlayers++) {
				this.vdouble__524_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__524_marginal' from DerivedVariable factor
			this.vdouble__524_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__524, this.vdouble__524_marginal_F);
			this.Changed_vdouble__524_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__525_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__525_use_B_nMatches__buffer'
			this.vdouble__525_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3500);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__524();
			this.Changed_vdouble__523();
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__523(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__523(numberOfIterations);
		...
		{
			if (variableName=="vdouble__524") {
				return this.Vdouble__524Marginal();
			}
			if (variableName=="vdouble__523") {
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__523") {
				this.vdouble__523 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__524") {
				this.vdouble__524 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__524' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__524Marginal()
		{
			return this.vdouble__524_marginal_F;
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__525_marginal_F);
		}
