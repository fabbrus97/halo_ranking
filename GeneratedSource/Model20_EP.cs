...
namespace Models
{
	...
	public partial class Model20_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_vdouble__169 has executed. Set this to false to force re-execution of Changed_vdouble__169</summary>
		public bool Changed_vdouble__169_isDone;
		...
		/// <summary>True if Changed_vdouble__195 has executed. Set this to false to force re-execution of Changed_vdouble__195</summary>
		public bool Changed_vdouble__195_isDone;
		/// <summary>True if Changed_vint____22 has executed. Set this to false to force re-execution of Changed_vint____22</summary>
		public bool Changed_vint____22_isDone;
		...
		/// <summary>Field backing the vdouble__169 property</summary>
		private double[] Vdouble__169;
		...
		/// <summary>Field backing the vdouble__195 property</summary>
		private double[] Vdouble__195;
		...
		/// <summary>Message to marginal of 'vdouble__197'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__197_marginal_F;
		...
		/// <summary>Field backing the vint____22 property</summary>
		private int[][] Vint____22;
		/// <summary>Message to marginal of 'vint____22'</summary>
		public PointMass<int[][]> vint____22_marginal_F;
		...
		/// <summary>The externally-specified value of 'vdouble__169'</summary>
		public double[] vdouble__169
		{
			get {
				return this.Vdouble__169;
			}
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vdouble__169\'");
				}
				this.Vdouble__169 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__169_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__195'</summary>
		public double[] vdouble__195
		{
			get {
				return this.Vdouble__195;
			}
			set {
				if ((value!=null)&&(value.Length!=6495)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6495)+" was expected for variable \'vdouble__195\'");
				}
				this.Vdouble__195 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__195_isDone = false;
			}
		}

		/// <summary>The externally-specified value of 'vint____22'</summary>
		public int[][] vint____22
		{
			get {
				return this.Vint____22;
			}
			set {
				if ((value!=null)&&(value.Length!=6495)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6495)+" was expected for variable \'vint____22\'");
				}
				this.Vint____22 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vint____22_isDone = false;
			}
		}
		...
		/// <summary>Computations that depend on the observed value of vdouble__169</summary>
		private void Changed_vdouble__169()
		{
			if (this.Changed_vdouble__169_isDone) {
				return ;
			}
			// Create array for 'vdouble__169_marginal' Forwards messages.
			this.vdouble__169_marginal_F = new DistributionStructArray<Gaussian,double>(200);
			for(int index67 = 0; index67<200; index67++) {
				this.vdouble__169_marginal_F[index67] = Gaussian.Uniform();
			}
			// Message to 'vdouble__169_marginal' from DerivedVariable factor
			this.vdouble__169_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__169, this.vdouble__169_marginal_F);
			this.Changed_vdouble__169_isDone = true;
		}
		...
		/// <summary>Computations that depend on the observed value of vdouble__195</summary>
		private void Changed_vdouble__195()
		{
			if (this.Changed_vdouble__195_isDone) {
				return ;
			}
			// Create array for 'vdouble__195_marginal' Forwards messages.
			this.vdouble__195_marginal_F = new DistributionStructArray<Gaussian,double>(6495);
			for(int nPlayers = 0; nPlayers<6495; nPlayers++) {
				this.vdouble__195_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__195_marginal' from DerivedVariable factor
			this.vdouble__195_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__195, this.vdouble__195_marginal_F);
			// Create array for 'vdouble__197_marginal' Forwards messages.
			this.vdouble__197_marginal_F = new DistributionStructArray<Gaussian,double>(6495);
			for(int nPlayers = 0; nPlayers<6495; nPlayers++) {
				this.vdouble__197_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__197_marginal' from DerivedVariable factor
			this.vdouble__197_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__195, this.vdouble__197_marginal_F);
			this.Changed_vdouble__195_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vint____22</summary>
		private void Changed_vint____22()
		{
			if (this.Changed_vint____22_isDone) {
				return ;
			}
			// Create array for 'vint____22_marginal' Forwards messages.
			this.vint____22_marginal_F = new PointMass<int[][]>(this.Vint____22);
			// Message to 'vint____22_marginal' from DerivedVariable factor
			this.vint____22_marginal_F = DerivedVariableOp.MarginalAverageConditional<PointMass<int[][]>,int[][]>(this.Vint____22, this.vint____22_marginal_F);
			this.Changed_vint____22_isDone = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__169();
			this.Changed_vint____22();
		...
		public object Marginal(string variableName)
		{
			...
			if (variableName=="vdouble__197") {
				return this.Vdouble__197Marginal();
			}
			if (variableName=="vdouble__183") {
			...
			if (variableName=="vint____22") {
				return this.Vint____22Marginal();
			}
			if (variableName=="time_passed") {
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vint____22") {
				this.vint____22 = (int[][])value;
				return ;
			}
			if (variableName=="vdouble__169") {
				this.vdouble__169 = (double[])value;
				return ;
			}
			if (variableName=="vint__50") {
			...
			if (variableName=="vdouble__195") {
				this.vdouble__195 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__197' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__197Marginal()
		{
			return this.vdouble__197_marginal_F;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vint____22' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public PointMass<int[][]> Vint____22Marginal()
		{
			return this.vint____22_marginal_F;
		}
