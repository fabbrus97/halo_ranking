...
namespace Models
{
	...
	public partial class Model38_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5_isInitialised;
		...
		public int[][][] PlayerIndex
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5_isDone = false;
		...
		public double[][][] time_passed
		{
			...
			set {
				...
				this.numberOfIterationsDone = 0;
				this.Changed_PlayerInTeam_time_passed_isDone = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5_isInitialised = false;
				this.Changed_numberOfIterations_PlayerIndex_PlayerInTeam_time_passed_vdouble__345_vdouble__346_vint__95_isDone = false;
			}
		}
		...
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5_isDone = true;
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5_isInitialised = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vint__95_Init_time_passed_vdouble__345_5(initialise);
