...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 15:01 on giovedì 14 luglio 2022.
	/// </remarks>
	public partial class Model28_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_vdouble__265 has executed. Set this to false to force re-execution of Changed_vdouble__265</summary>
		public bool Changed_vdouble__265_isDone;
		/// <summary>True if Changed_vint____30 has executed. Set this to false to force re-execution of Changed_vint____30</summary>
		public bool Changed_vint____30_isDone;
		...
		/// <summary>Field backing the vdouble__265 property</summary>
		private double[] Vdouble__265;
		...
		/// <summary>Field backing the vint____30 property</summary>
		private int[][] Vint____30;
		/// <summary>Message to marginal of 'vint____30'</summary>
		public PointMass<int[][]> vint____30_marginal_F;
		...
		public double[] vdouble__239
		{
			...
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vdouble__239\'");
				}
		...
		/// <summary>The externally-specified value of 'vdouble__265'</summary>
		public double[] vdouble__265
		{
			get {
				return this.Vdouble__265;
			}
			set {
				if ((value!=null)&&(value.Length!=6404)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6404)+" was expected for variable \'vdouble__265\'");
				}
				this.Vdouble__265 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__265_isDone = false;
			}
		}

		/// <summary>The externally-specified value of 'vint____30'</summary>
		public int[][] vint____30
		{
			get {
				return this.Vint____30;
			}
			set {
				if ((value!=null)&&(value.Length!=6404)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6404)+" was expected for variable \'vint____30\'");
				}
				this.Vint____30 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vint____30_isDone = false;
			}
		}
		...
		private void Changed_vdouble__239()
		{
			...
			this.vdouble__239_marginal_F = new DistributionStructArray<Gaussian,double>(200);
			for(int index93 = 0; index93<200; index93++) {
				this.vdouble__239_marginal_F[index93] = Gaussian.Uniform();
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__265</summary>
		private void Changed_vdouble__265()
		{
			if (this.Changed_vdouble__265_isDone) {
				return ;
			}
			// Create array for 'vdouble__265_marginal' Forwards messages.
			this.vdouble__265_marginal_F = new DistributionStructArray<Gaussian,double>(6404);
			for(int nPlayers = 0; nPlayers<6404; nPlayers++) {
				this.vdouble__265_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__265_marginal' from DerivedVariable factor
			this.vdouble__265_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__265, this.vdouble__265_marginal_F);
			// Create array for 'vdouble__267_marginal' Forwards messages.
			this.vdouble__267_marginal_F = new DistributionStructArray<Gaussian,double>(6404);
			for(int nPlayers = 0; nPlayers<6404; nPlayers++) {
				this.vdouble__267_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__267_marginal' from DerivedVariable factor
			this.vdouble__267_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__265, this.vdouble__267_marginal_F);
			this.Changed_vdouble__265_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vint____30</summary>
		private void Changed_vint____30()
		{
			if (this.Changed_vint____30_isDone) {
				return ;
			}
			// Create array for 'vint____30_marginal' Forwards messages.
			this.vint____30_marginal_F = new PointMass<int[][]>(this.Vint____30);
			// Message to 'vint____30_marginal' from DerivedVariable factor
			this.vint____30_marginal_F = DerivedVariableOp.MarginalAverageConditional<PointMass<int[][]>,int[][]>(this.Vint____30, this.vint____30_marginal_F);
			this.Changed_vint____30_isDone = true;
		}
		...
		public object Marginal(string variableName)
		{
			...
			if (variableName=="vint____30") {
				return this.Vint____30Marginal();
			}
			if (variableName=="time_passed") {
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__265") {
				this.vdouble__265 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vint____30' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public PointMass<int[][]> Vint____30Marginal()
		{
			return this.vint____30_marginal_F;
		}
