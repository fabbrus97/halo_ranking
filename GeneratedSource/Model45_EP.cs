...
namespace Models
{
	...
	public partial class Model45_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__383 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__383</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__383_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__387 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__387</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__387_isDone;
		...
		/// <summary>True if Changed_vdouble__387 has executed. Set this to false to force re-execution of Changed_vdouble__387</summary>
		public bool Changed_vdouble__387_isDone;
		/// <summary>True if Changed_vdouble__388 has executed. Set this to false to force re-execution of Changed_vdouble__388</summary>
		public bool Changed_vdouble__388_isDone;
		...
		/// <summary>Field backing the vdouble__387 property</summary>
		private double[] Vdouble__387;
		...
		/// <summary>Field backing the vdouble__388 property</summary>
		private double[] Vdouble__388;
		...
		public RpropBufferData[] vdouble__389_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__383_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__387_isDone = false;
			}
		}
		...
		/// <summary>The externally-specified value of 'vdouble__387'</summary>
		public double[] vdouble__387
		{
			get {
				return this.Vdouble__387;
			}
			set {
				if ((value!=null)&&(value.Length!=3378)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3378)+" was expected for variable \'vdouble__387\'");
				}
				this.Vdouble__387 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__387_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__383_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__388'</summary>
		public double[] vdouble__388
		{
			get {
				return this.Vdouble__388;
			}
			set {
				if ((value!=null)&&(value.Length!=3378)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3378)+" was expected for variable \'vdouble__388\'");
				}
				this.Vdouble__388 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__388_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTe8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_match_m_Time_player_n_Time_PlayerIndex_team2wi6_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_team2wi4_isInitialised = false;
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__383_isDone = false;
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__387 and vdouble__388</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__383(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__383_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3378);
			for(int nPlayers = 0; nPlayers<3378; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3378);
			...
			for(int nPlayers = 0; nPlayers<3378; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__387[nPlayers], this.Vdouble__388[nPlayers]);
			}
			...
			// Create array for replicates of 'vdouble1090_F'
			Gaussian[] vdouble1090_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1090_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1090_B'
			Gaussian[] vdouble1090_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1090_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble1088_F'
			Gaussian[] vdouble1088_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1088_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1088_B'
			Gaussian[] vdouble1088_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble1088_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1086_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1086_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1086_B'
			Gaussian[] vdouble1086_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1086_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool281_B'
			Bernoulli[] vbool281_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
			...
			// Create array for replicates of 'vdouble1084_F'
			Gaussian[] vdouble1084_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1084_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1084_B'
			Gaussian[] vdouble1084_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1084_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool278_B'
			Bernoulli[] vbool278_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool278_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool278' from Not factor
					vbool278_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble1090' from Difference factor
						vdouble1090_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1090' from IsPositive factor
						vdouble1090_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1090_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1090_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble1088' from Difference factor
						vdouble1088_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						// Message to 'vdouble1088' from IsPositive factor
						vdouble1088_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1088_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1088_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1086' from Difference factor
						vdouble1086_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1086' from IsPositive factor
						vdouble1086_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool281_B[nMatches], vdouble1086_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1086_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1084' from Difference factor
						vdouble1084_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1084' from IsPositive factor
						vdouble1084_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool278_B[nMatches], vdouble1084_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1084_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__383_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__387</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__387(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__387_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__389_F;
			// Create array for 'vdouble__389' Forwards messages.
			vdouble__389_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__389_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____92_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____92_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1058_F'
			Gaussian[][][] vdouble1058_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1056_F'
			Gaussian[][][] vdouble1056_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1062_F'
			Gaussian[] vdouble1062_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1063_F'
			Gaussian[] vdouble1063_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				...
				// Create array for replicates of 'vdouble1058_F'
				vdouble1058_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____92' Forwards messages.
					...
					// Create array for replicates of 'vdouble1058_F'
					vdouble1058_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						vdouble1056_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__387[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1058_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1058' from Product factor
						vdouble1058_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1056_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____92' from Ratio factor
						vdouble____92_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1058_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1062_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1062' from Sum factor
				vdouble1062_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____92_F[nMatches][0]);
				vdouble1063_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1063' from Sum factor
				vdouble1063_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____92_F[nMatches][1]);
				// Message to 'vdouble__389' from Difference factor
				vdouble__389_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1062_F[nMatches], vdouble1063_F[nMatches]), string.Format("vdouble__389_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__389_use_B_reduced;
			vdouble__389_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__389_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__389_use_B_reduced, vdouble__389_F[nMatches], this.vdouble__389_marginal_F[nMatches], this.vdouble__389_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__389_marginal' from VariablePoint factor
					this.vdouble__389_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__389_use_B_reduced, vdouble__389_F[nMatches], this.vdouble__389_use_B_nMatches__buffer[nMatches], this.vdouble__389_marginal_F[nMatches]), string.Format("vdouble__389_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__387_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__387 and vdouble__388</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__387</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__389_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__389_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__387 and vdouble__388</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__387 and vdouble__388</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool286'
			bool[] vbool286 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool286[nMatches] = true;
					Constrain.Equal<bool>(true, vbool286[nMatches]);
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__387</summary>
		private void Changed_vdouble__387()
		{
			if (this.Changed_vdouble__387_isDone) {
				return ;
			}
			// Create array for 'vdouble__387_marginal' Forwards messages.
			this.vdouble__387_marginal_F = new DistributionStructArray<Gaussian,double>(3378);
			for(int nPlayers = 0; nPlayers<3378; nPlayers++) {
				this.vdouble__387_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__387_marginal' from DerivedVariable factor
			this.vdouble__387_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__387, this.vdouble__387_marginal_F);
			this.Changed_vdouble__387_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__388</summary>
		private void Changed_vdouble__388()
		{
			if (this.Changed_vdouble__388_isDone) {
				return ;
			}
			// Create array for 'vdouble__388_marginal' Forwards messages.
			this.vdouble__388_marginal_F = new DistributionStructArray<Gaussian,double>(3378);
			for(int nPlayers = 0; nPlayers<3378; nPlayers++) {
				this.vdouble__388_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__388_marginal' from DerivedVariable factor
			this.vdouble__388_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__388, this.vdouble__388_marginal_F);
			this.Changed_vdouble__388_isDone = true;
		}
		...
		private void Constant()
		{
			...
			this.vdouble__389_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__389_use_B_nMatches__buffer'
			this.vdouble__389_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3378);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__388();
			this.Changed_vdouble__387();
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__383(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__387(numberOfIterations);
		...
		public void SetObservedValue(string variableName, object value)
		{
			...
			if (variableName=="vdouble__387") {
				this.vdouble__387 = (double[])value;
				return ;
			}
			if (variableName=="vdouble__388") {
				this.vdouble__388 = (double[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__389_marginal_F);
		}
