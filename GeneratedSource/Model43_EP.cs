...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 12:18 on giovedì 7 luglio 2022.
	/// </remarks>
	public partial class Model43_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__373 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__373</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__373_isDone;
		/// <summary>True if Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__370 has executed. Set this to false to force re-execution of Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__370</summary>
		public bool Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__370_isDone;
		...
		public RpropBufferData[] vdouble__372_use_B_nMatches__buffer;
		#endregion
		...
		public double[] match_m_Time
		{
			...
			set {
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__373_isDone = false;
				...
				this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__370_isDone = false;
			}
		}
		...
		public double[] vdouble__370
		{
			...
			set {
				if ((value!=null)&&(value.Length!=3340)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3340)+" was expected for variable \'vdouble__370\'");
				}
		...
		public double[] vdouble__371
		{
			...
			set {
				if ((value!=null)&&(value.Length!=3340)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+3340)+" was expected for variable \'vdouble__371\'");
				}
		...
		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__370 and vdouble__371</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__373(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__373_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> skills_prior_F;
			// Create array for 'skills_prior' Forwards messages.
			skills_prior_F = new DistributionStructArray<Gaussian,double>(3340);
			for(int nPlayers = 0; nPlayers<3340; nPlayers++) {
				skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_marginal' Forwards messages.
			this.skills_prior_marginal_F = new DistributionStructArray<Gaussian,double>(3340);
			...
			for(int nPlayers = 0; nPlayers<3340; nPlayers++) {
				...
				skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__370[nPlayers], this.Vdouble__371[nPlayers]);
			}
			...
			Gaussian[] vdouble1044_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1044_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1044_B'
			Gaussian[] vdouble1044_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble1044_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			Gaussian[] vdouble1042_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
			...
			Gaussian[] vdouble1042_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
			...
			Gaussian[] vdouble1040_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
			...
			Gaussian[] vdouble1040_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1040_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool269_B'
			Bernoulli[] vbool269_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool269_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool269' from Not factor
					vbool269_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			// Create array for replicates of 'vdouble1038_F'
			Gaussian[] vdouble1038_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
			...
			Gaussian[] vdouble1038_B = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1038_B[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vbool266_B'
			Bernoulli[] vbool266_B = new Bernoulli[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vbool266_B[nMatches] = Bernoulli.Uniform();
					// Message to 'vbool266' from Not factor
					vbool266_B[nMatches] = BooleanNotOp.BAverageConditional(true);
				}
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int nMatches = 0; nMatches<500; nMatches++) {
					...
					if (this.Team2wins[nMatches]==1) {
						...
						vdouble1044_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_F[nMatches]);
						// Message to 'vdouble1044' from IsPositive factor
						vdouble1044_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1044_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1044_B[nMatches]);
					...
					if (this.Team2wins[nMatches]==0) {
						...
						vdouble1042_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.062763845379169722);
						...
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1042_B[nMatches], 0.062763845379169722);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						vdouble1040_F[nMatches] = DoublePlusOp.AAverageConditional(-0.062763845379169722, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1040' from IsPositive factor
						vdouble1040_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool269_B[nMatches], vdouble1040_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.062763845379169722, vdouble1040_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						vdouble1038_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.062763845379169722);
						// Message to 'vdouble1038' from IsPositive factor
						vdouble1038_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool266_B[nMatches], vdouble1038_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1038_B[nMatches], 0.062763845379169722);
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__373_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of match_m_Time and numberOfIterations and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__370</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__370(int numberOfIterations)
		{
			if (this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__370_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__372_F;
			// Create array for 'vdouble__372' Forwards messages.
			vdouble__372_F = new DistributionStructArray<Gaussian,double>(500);
			for(int nMatches = 0; nMatches<500; nMatches++) {
				vdouble__372_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____88_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____88_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[500];
			// Create array for replicates of 'vdouble1012_F'
			Gaussian[][][] vdouble1012_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1010_F'
			Gaussian[][][] vdouble1010_F = new Gaussian[500][][];
			// Create array for replicates of 'vdouble1016_F'
			Gaussian[] vdouble1016_F = new Gaussian[500];
			// Create array for replicates of 'vdouble1017_F'
			Gaussian[] vdouble1017_F = new Gaussian[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				// Create array for 'vdouble____88' Forwards messages.
				vdouble____88_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble1010_F'
				vdouble1010_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1012_F'
				vdouble1012_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____88' Forwards messages.
					vdouble____88_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble1010_F'
					vdouble1010_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1012_F'
					vdouble1012_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____88_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1010_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1010' from Gaussian factor
						vdouble1010_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__370[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1012_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1012' from Product factor
						vdouble1012_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1010_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Player_n_Time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____88' from Ratio factor
						vdouble____88_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1012_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Match_m_Time[nMatches]);
					}
				}
				vdouble1016_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1016' from Sum factor
				vdouble1016_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____88_F[nMatches][0]);
				vdouble1017_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1017' from Sum factor
				vdouble1017_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____88_F[nMatches][1]);
				// Message to 'vdouble__372' from Difference factor
				vdouble__372_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1016_F[nMatches], vdouble1017_F[nMatches]), string.Format("vdouble__372_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__372_use_B_reduced;
			vdouble__372_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<500; nMatches++) {
					this.vdouble__372_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__372_use_B_reduced, vdouble__372_F[nMatches], this.vdouble__372_marginal_F[nMatches], this.vdouble__372_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__372_marginal' from VariablePoint factor
					this.vdouble__372_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__372_use_B_reduced, vdouble__372_F[nMatches], this.vdouble__372_use_B_nMatches__buffer[nMatches], this.vdouble__372_marginal_F[nMatches]), string.Format("vdouble__372_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__370_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and team2wins and vdouble__370 and vdouble__371</summary>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__370</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<500; nMatches++) {
				this.vdouble__372_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__372_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and team2wins and vdouble__370 and vdouble__371</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to match_m_Time and player_n_Time and PlayerIndex and PlayerInTeam and vdouble__370 and vdouble__371</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		private void Changed_team2wins()
		{
			...
			// Create array for replicates of 'vbool274'
			bool[] vbool274 = new bool[500];
			for(int nMatches = 0; nMatches<500; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vbool274[nMatches] = true;
					Constrain.Equal<bool>(true, vbool274[nMatches]);
				}
			}
		...
		private void Changed_vdouble__370()
		{
			...
			this.vdouble__370_marginal_F = new DistributionStructArray<Gaussian,double>(3340);
			for(int nPlayers = 0; nPlayers<3340; nPlayers++) {
		...
		private void Changed_vdouble__371()
		{
			...
			this.vdouble__371_marginal_F = new DistributionStructArray<Gaussian,double>(3340);
			for(int nPlayers = 0; nPlayers<3340; nPlayers++) {
		...
		private void Constant()
		{
			...
			this.vdouble__372_marginal_F = new DistributionStructArray<Gaussian,double>(500);
			// Create array for replicates of 'vdouble__372_use_B_nMatches__buffer'
			this.vdouble__372_use_B_nMatches__buffer = new RpropBufferData[500];
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(3340);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Backwards messages.
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_team2wins_vdouble__373(numberOfIterations);
			this.Changed_numberOfIterationsDecreased_Init_match_m_Time_player_n_Time_PlayerIndex_PlayerInTeam_vdouble2(initialise);
			this.Changed_match_m_Time_numberOfIterations_player_n_Time_PlayerIndex_PlayerInTeam_vdouble__370(numberOfIterations);
		...
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__372_marginal_F);
		}
