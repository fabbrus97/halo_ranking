...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 15:54 on giovedì 7 luglio 2022.
	/// </remarks>
	public partial class Model27_EP : IGeneratedAlgorithm
	{
		...
		public double[][] vdouble1225_reduced;
		public double[][] vdouble1232_reduced;
		public double[][] vdouble1233_reduced;
		public Gaussian[][][] vdouble1234_F;
		public Gaussian[][][] vdouble1235_F;
		public double[][] vdouble1237_reduced;
		public double[][] vdouble1238_reduced;
		public Gaussian[][][] vdouble1239_B;
		public Gaussian[][][] vdouble1239_F;
		public Gaussian[][][] vdouble1240_B;
		public Gaussian[][][] vdouble1240_F;
		public Gaussian[][][] vdouble1243_F;
		public Gaussian[][][] vdouble1245_B;
		public Gaussian[][][] vdouble1245_F;
		public Gaussian[][][] vdouble1246_B;
		public Gaussian[][][] vdouble1246_F;
		public Gaussian[][][] vdouble1249_F;
		/// <summary>Message from use of 'vdouble1249'</summary>
		public Gaussian[][][] vdouble1249_use_B;
		public Gaussian[][][] vdouble1253_F;
		public Gaussian[][][] vdouble1255_B;
		public Gaussian[][][] vdouble1255_F;
		public Gaussian[][][] vdouble1256_B;
		public Gaussian[][][] vdouble1256_F;
		public Gaussian[][][] vdouble1259_F;
		/// <summary>Message from use of 'vdouble1259'</summary>
		public Gaussian[][][] vdouble1259_use_B;
		#endregion
		...
		private void Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3(int numberOfIterations)
		{
			...
			// Create array for replicates of 'vdouble1235_B'
			Gaussian[][][] vdouble1235_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1235_B'
				vdouble1235_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble1235_B'
					vdouble1235_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble1235_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			...
			Gaussian[] vdouble1268_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1268_F[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1268_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble1266_F'
			Gaussian[] vdouble1266_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1266_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble1266_B'
			Gaussian[] vdouble1266_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble1266_B[nMatches] = Gaussian.Uniform();
				}
			}
				...
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							this.vdouble1243_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(2.5567203850565789, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble1246' from Plus factor
							this.vdouble1246_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble1243_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1245_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Product factor
							this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1246_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1249' from Gaussian factor
							this.vdouble1249_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1249_use' from Max factor
							this.vdouble1249_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Killcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble1249_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Gaussian factor
							this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble1249_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1246' from Product factor
							this.vdouble1246_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1245' from Plus factor
							this.vdouble1245_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble1246_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1243_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0] = GaussianProductOpBase.BAverageConditional(this.vdouble1245_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -0.54459509911730619);
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							this.vdouble1253_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-2.7928178121382596, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble1256' from Plus factor
							this.vdouble1256_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble1253_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1255_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Product factor
							this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1256_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1259' from Gaussian factor
							this.vdouble1259_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1259_use' from Max factor
							this.vdouble1259_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Deathcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble1259_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Gaussian factor
							this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble1259_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1256' from Product factor
							this.vdouble1256_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble1255' from Plus factor
							this.vdouble1255_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble1256_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1253_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(this.vdouble1255_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.79084835337752024);
							// Message to 'player_perf_t__n_uses' from Replicate factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==0) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								this.vdouble1234_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								...
								// Message to 'vdouble1235' from Product factor
								vdouble1235_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1233_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1234' from Ratio factor
								vdouble1234_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble1235_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'player_perf_t__n_0_0_' from Sum factor
								this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble1234_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1234_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							}
					...
					if (this.Team2wins[nMatches]==1) {
						...
						vdouble1272_F[nMatches] = DoublePlusOp.AAverageConditional(-0.001, Diff_F[nMatches]);
						// Message to 'vdouble1272' from IsPositive factor
						vdouble1272_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1272_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.001, vdouble1272_B[nMatches]);
					...
					if (this.Team2wins[nMatches]==0) {
						...
						vdouble1270_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.001);
						// Message to 'vdouble1270' from IsPositive factor
						vdouble1270_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble1270_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble1270_B[nMatches], 0.001);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble1268' from Difference factor
						vdouble1268_F[nMatches] = DoublePlusOp.AAverageConditional(-0.001, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble1268' from IsPositive factor
						vdouble1268_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool173_B[nMatches], vdouble1268_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.001, vdouble1268_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble1266' from Difference factor
						vdouble1266_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.001);
						// Message to 'vdouble1266' from IsPositive factor
						vdouble1266_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool170_B[nMatches], vdouble1266_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble1266_B[nMatches], 0.001);
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==1) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								this.vdouble1240_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1238_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1239' from Ratio factor
								this.vdouble1239_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(this.vdouble1240_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble1239' from Sum factor
								this.vdouble1239_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_1_1_' from Sum factor
								this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(this.vdouble1239_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1239_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble1240' from Ratio factor
								this.vdouble1240_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble1239_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_1_' from Product factor
								this.Perfomance_opposing_team_1__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1238_reduced[nMatches][nTeamsPerMatch], this.vdouble1240_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							if (nTeamsPerMatch==0) {
								// Message to 'vdouble1235' from Ratio factor
								this.vdouble1235_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble1234_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_0_' from Product factor
								this.Perfomance_opposing_team_0__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble1233_reduced[nMatches][nTeamsPerMatch], this.vdouble1235_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							...
							// Message to 'vdouble1245' from Product factor
							this.vdouble1245_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-0.54459509911730619, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							// Message to 'vdouble1243' from Plus factor
							vdouble1243_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble1246_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1245_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble1243_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 2.5567203850565789);
							// Message to 'vdouble1255' from Product factor
							this.vdouble1255_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(0.79084835337752024, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
						}
						if (nTeamsPerMatch==1) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							vdouble1253_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble1256_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble1255_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = GaussianProductOpBase.BAverageConditional(vdouble1253_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -2.7928178121382596);
		...
		private void Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__348(int numberOfIterations)
		{
			...
			// Create array for replicates of 'vdouble1208_F'
			Gaussian[] vdouble1208_F = new Gaussian[1000];
			// Create array for replicates of 'vdouble1201_F'
			Gaussian[][][] vdouble1201_F = new Gaussian[1000][][];
			// Create array for replicates of 'vdouble1203_F'
			Gaussian[][][] vdouble1203_F = new Gaussian[1000][][];
			// Create array for replicates of 'vdouble1207_F'
			Gaussian[] vdouble1207_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				...
				// Create array for replicates of 'vdouble1201_F'
				vdouble1201_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble1203_F'
				vdouble1203_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____114' Forwards messages.
					...
					// Create array for replicates of 'vdouble1203_F'
					vdouble1203_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1201_F'
					vdouble1201_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____114_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble1201_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1201' from Gaussian factor
						vdouble1201_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__348[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble1203_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble1203' from Product factor
						vdouble1203_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble1201_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____114' from Ratio factor
						vdouble____114_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble1203_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.match_time_m[nMatches]);
					}
				}
				vdouble1207_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1207' from Sum factor
				vdouble1207_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____114_F[nMatches][0]);
				vdouble1208_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble1208' from Sum factor
				vdouble1208_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____114_F[nMatches][1]);
				// Message to 'vdouble__350' from Difference factor
				vdouble__350_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble1207_F[nMatches], vdouble1208_F[nMatches]), string.Format("vdouble__350_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble1238_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble1237_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
						this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble1225_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						if (nTeamsPerMatch==0) {
							this.vdouble1233_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble1232_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble1246_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==1) {
							...
							this.vdouble1240_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble1246_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1249_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1249_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==0) {
							...
							this.vdouble1235_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble1234_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							for(int _a3 = 0; _a3<this.playerInTeam[nMatches][0]; _a3++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble1255_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1253_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1256_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1259_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						this.vdouble1256_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble1255_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						if (nTeamsPerMatch==1) {
							this.vdouble1239_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble1240_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
		...
		private void Changed_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble1237_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][0]);
						}
						this.vdouble1225_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][nTeamsPerMatch]);
					}
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
					...
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==0) {
							this.vdouble1232_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][1]);
						}
					}
				}
			}
		...
		private void Changed_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble1246_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble1237_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble1238_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble1240_F'
					this.vdouble1240_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble1225_reduced[nMatches][nTeamsPerMatch] = default(double);
					...
					// Create array for replicates of 'vdouble1246_B'
					this.vdouble1246_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1249_use_B'
					this.vdouble1249_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1249_F'
					this.vdouble1249_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble1232_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble1233_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble1235_F'
					this.vdouble1235_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1234_F'
					this.vdouble1234_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					if (nTeamsPerMatch==0) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					// Create array for replicates of 'vdouble1255_B'
					this.vdouble1255_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1253_F'
					this.vdouble1253_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1256_B'
					this.vdouble1256_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble1259_use_B'
					this.vdouble1259_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble1256_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble1255_F'
					this.vdouble1255_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble1240_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				}
			}
		...
		private void Constant()
		{
			...
			// Create array for replicates of 'vdouble1246_F'
			this.vdouble1246_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1246_F'
				this.vdouble1246_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1245_F'
			...
			this.vdouble1237_reduced = new double[1000][];
			this.vdouble1238_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble1237_reduced[nMatches] = new double[2];
				this.vdouble1238_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble1240_F'
			this.vdouble1240_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1240_F'
				this.vdouble1240_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1239_F'
			...
			this.vdouble1225_reduced = new double[1000][];
			this.Avg_play_time_team_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble1225_reduced[nMatches] = new double[2];
			...
			// Create array for replicates of 'vdouble1246_B'
			this.vdouble1246_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1246_B'
				this.vdouble1246_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_B'
			...
			// Create array for replicates of 'vdouble1249_use_B'
			this.vdouble1249_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1249_use_B'
				this.vdouble1249_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1249_F'
			this.vdouble1249_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1249_F'
				this.vdouble1249_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_F'
			...
			this.vdouble1233_reduced = new double[1000][];
			this.vdouble1232_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble1232_reduced[nMatches] = new double[2];
				this.vdouble1233_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble1235_F'
			this.vdouble1235_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1235_F'
				this.vdouble1235_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1234_F'
			this.vdouble1234_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1234_F'
				this.vdouble1234_F[nMatches] = new Gaussian[2][];
			}
			...
			// Create array for replicates of 'vdouble1255_B'
			this.vdouble1255_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1255_B'
				this.vdouble1255_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1253_F'
			this.vdouble1253_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1253_F'
				this.vdouble1253_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1256_B'
			this.vdouble1256_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1256_B'
				this.vdouble1256_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'death_count_m__t__n_B'
			...
			// Create array for replicates of 'vdouble1259_use_B'
			this.vdouble1259_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1259_use_B'
				this.vdouble1259_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1259_F'
			...
			// Create array for replicates of 'vdouble1256_F'
			this.vdouble1256_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1256_F'
				this.vdouble1256_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1255_F'
			this.vdouble1255_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1255_F'
				this.vdouble1255_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble1239_B'
			...
			// Create array for replicates of 'vdouble1240_B'
			this.vdouble1240_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble1240_B'
				this.vdouble1240_B[nMatches] = new Gaussian[2][];
			}
