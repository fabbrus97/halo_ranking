...
namespace Models
{
	...
	public partial class Model105_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_vdouble__912 has executed. Set this to false to force re-execution of Changed_vdouble__912</summary>
		public bool Changed_vdouble__912_isDone;
		...
		/// <summary>Message to marginal of 'vdouble__912'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__912_marginal_F;
		...
		public double[] skills__gamma_
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7311)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7311)+" was expected for variable \'skills__gamma_\'");
				}
		...
		public double[] vdouble__912
		{
			...
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vdouble__912\'");
				}
				this.Vdouble__912 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__912_isDone = false;
			}
		}
		...
		public int[][] vint____142
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7311)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7311)+" was expected for variable \'vint____142\'");
				}
		...
		private void Changed_skills__gamma_()
		{
			...
			this.skills__gamma__marginal_F = new DistributionStructArray<Gaussian,double>(7311);
		...
		/// <summary>Computations that depend on the observed value of vdouble__912</summary>
		private void Changed_vdouble__912()
		{
			if (this.Changed_vdouble__912_isDone) {
				return ;
			}
			// Create array for 'vdouble__912_marginal' Forwards messages.
			this.vdouble__912_marginal_F = new DistributionStructArray<Gaussian,double>(200);
			for(int index389 = 0; index389<200; index389++) {
				this.vdouble__912_marginal_F[index389] = Gaussian.Uniform();
			}
			// Message to 'vdouble__912_marginal' from DerivedVariable factor
			this.vdouble__912_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__912, this.vdouble__912_marginal_F);
			this.Changed_vdouble__912_isDone = true;
		}
		...
		{
			return this.vdouble__912_marginal_F;
		}
