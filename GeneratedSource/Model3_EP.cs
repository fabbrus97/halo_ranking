...
namespace Models
{
	...
	public partial class Model3_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48 has executed. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48</summary>
		public bool Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_isDone;
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811 has executed. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811_isDone;
		/// <summary>True if Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811 has performed initialisation. Set this to false to force re-execution of Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811</summary>
		public bool Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811_isInitialised;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10</summary>
		public bool Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10</summary>
		public bool Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10_isInitialised;
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9</summary>
		public bool Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9_isInitialised;
		...
		/// <summary>True if Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8</summary>
		public bool Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8</summary>
		public bool Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8_isInitialised;
		...
		/// <summary>True if Changed_vdouble__48 has executed. Set this to false to force re-execution of Changed_vdouble__48</summary>
		public bool Changed_vdouble__48_isDone;
		/// <summary>True if Changed_vdouble__48_vdouble__49 has executed. Set this to false to force re-execution of Changed_vdouble__48_vdouble__49</summary>
		public bool Changed_vdouble__48_vdouble__49_isDone;
		/// <summary>True if Changed_vdouble__49 has executed. Set this to false to force re-execution of Changed_vdouble__49</summary>
		public bool Changed_vdouble__49_isDone;
		...
		/// <summary>Message to marginal of 'vdouble__48'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__48_marginal_F;
		/// <summary>Field backing the vdouble__49 property</summary>
		private double[] Vdouble__49;
		/// <summary>Message to marginal of 'vdouble__49'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__49_marginal_F;
		/// <summary>Message to marginal of 'vdouble__50'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__50_marginal_F;
		/// <summary>Buffer for VariablePointOp_Rprop.MarginalAverageConditional</summary>
		public RpropBufferData[] vdouble__50_use_B_nMatches__buffer;
		public double[][] vdouble205_reduced;
		public double[][] vdouble212_reduced;
		public double[][] vdouble213_reduced;
		public Gaussian[][][] vdouble214_F;
		public Gaussian[][][] vdouble215_F;
		public double[][] vdouble217_reduced;
		public double[][] vdouble218_reduced;
		public Gaussian[][][] vdouble219_B;
		public Gaussian[][][] vdouble219_F;
		public Gaussian[][][] vdouble220_B;
		public Gaussian[][][] vdouble220_F;
		public Gaussian[][][] vdouble223_F;
		public Gaussian[][][] vdouble225_B;
		public Gaussian[][][] vdouble225_F;
		public Gaussian[][][] vdouble226_B;
		public Gaussian[][][] vdouble226_F;
		public Gaussian[][][] vdouble229_F;
		/// <summary>Message from use of 'vdouble229'</summary>
		public Gaussian[][][] vdouble229_use_B;
		public Gaussian[][][] vdouble233_F;
		public Gaussian[][][] vdouble235_B;
		public Gaussian[][][] vdouble235_F;
		public Gaussian[][][] vdouble236_B;
		public Gaussian[][][] vdouble236_F;
		public Gaussian[][][] vdouble239_F;
		/// <summary>Message from use of 'vdouble239'</summary>
		public Gaussian[][][] vdouble239_use_B;
		#endregion
		...
		public double[][][] deathcount
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10_isInitialised = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811_isInitialised = false;
		...
		public double[] Match_time_m
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10_isInitialised = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3_isDone = false;
				...
				this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_isDone = false;
			}
		}
		...
		public double[][][] p_time_m__t__n
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3_isDone = false;
		...
		public int[][][] PlayerIndex
		{
			...
			set {
				...
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9_isDone = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
				this.Changed_deathcount_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_Pla15_isDone = false;
		...
		public double[] vdouble__48
		{
			...
			set {
				if ((value!=null)&&(value.Length!=6696)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6696)+" was expected for variable \'vdouble__48\'");
				}
				this.Vdouble__48 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__48_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_17_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_7_isInitialised = false;
				this.Changed_vdouble__48_vdouble__49_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8_isDone = false;
				this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9_isDone = false;
				this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10_isDone = false;
				this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811_isDone = false;
				this.Changed_killcount_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_v14_isDone = false;
		...
		/// <summary>The externally-specified value of 'vdouble__49'</summary>
		public double[] vdouble__49
		{
			get {
				return this.Vdouble__49;
			}
			set {
				if ((value!=null)&&(value.Length!=6696)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+6696)+" was expected for variable \'vdouble__49\'");
				}
				this.Vdouble__49 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__49_isDone = false;
				this.Changed_numberOfIterationsDecreased_team2wins_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_17_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_PlayerInTeam_Init_deathcount_killcount_Match_time_m_p_time_m__t_7_isInitialised = false;
				this.Changed_vdouble__48_vdouble__49_isDone = false;
				this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4_isInitialised = false;
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of deathcount and killcount and Match_time_m and numberOfIterations and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins and vdouble__48 and vdouble__49</summary>
		...
		private void Changed_deathcount_killcount_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam3(int numberOfIterations)
		{
			...
			// Create array for replicates of 'vdouble215_B'
			Gaussian[][][] vdouble215_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble215_B'
				vdouble215_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble215_B'
					vdouble215_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble215_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			// Create array for replicates of 'vdouble214_B'
			Gaussian[][][] vdouble214_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble214_B'
				vdouble214_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble214_B'
					vdouble214_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						if (nTeamsPerMatch==0) {
							vdouble214_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble252_F[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==1) {
					vdouble252_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble250_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble250_B'
			Gaussian[] vdouble250_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==0) {
					vdouble250_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			// Create array for replicates of 'vdouble248_F'
			Gaussian[] vdouble248_F = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble248_F[nMatches] = Gaussian.Uniform();
				}
			}
			// Create array for replicates of 'vdouble248_B'
			Gaussian[] vdouble248_B = new Gaussian[1000];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble248_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble246_F[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				if (this.Team2wins[nMatches]==2) {
					vdouble246_B[nMatches] = Gaussian.Uniform();
				}
			}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble223_B'
				vdouble223_B[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for replicates of 'vdouble223_B'
					vdouble223_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble223_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
					}
				}
			}
				...
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							// Message to 'vdouble223' from Product factor
							this.vdouble223_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(2.5567203850565789, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
							// Message to 'vdouble226' from Plus factor
							this.vdouble226_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble223_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble225_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Product factor
							this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble226_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble229' from Gaussian factor
							this.vdouble229_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.kill_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble229_use' from Max factor
							this.vdouble229_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Killcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble229_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'kill_count_m__t__n' from Gaussian factor
							this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble229_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble226' from Product factor
							this.vdouble226_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble225' from Plus factor
							this.vdouble225_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble226_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble223_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0] = GaussianProductOpBase.BAverageConditional(this.vdouble225_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -0.54459509911730619);
							// Message to 'player_perf_t__n_uses' from Replicate factor
							...
							this.vdouble233_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-2.7928178121382596, this.player_perf_t__n_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2]);
							// Message to 'vdouble236' from Plus factor
							this.vdouble236_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.SumAverageConditional(this.vdouble233_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble235_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Product factor
							this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble236_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble239' from Gaussian factor
							this.vdouble239_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble239_use' from Max factor
							this.vdouble239_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = MaxGaussianOp.BAverageConditional(this.Deathcount[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.0, this.vdouble239_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'death_count_m__t__n' from Gaussian factor
							this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.MeanAverageConditional(this.vdouble239_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vc_Times_p_time[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble236' from Product factor
							this.vdouble236_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.AAverageConditional(this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'vdouble235' from Plus factor
							this.vdouble235_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.BAverageConditional(this.vdouble236_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble233_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'Perfomance_opposing_team_uses' from Product factor
							this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(this.vdouble235_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 0.79084835337752024);
							// Message to 'player_perf_t__n_uses' from Replicate factor
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==0) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'vdouble214' from Sum factor
								this.vdouble214_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								...
								// Message to 'vdouble215' from Product factor
								vdouble215_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble213_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble214' from Ratio factor
								vdouble214_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(vdouble215_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'player_perf_t__n_0_0_' from Sum factor
								this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(vdouble214_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble214_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item0_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_0_0__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							}
					...
					if (this.Team2wins[nMatches]==1) {
						// Message to 'vdouble252' from Difference factor
						vdouble252_F[nMatches] = DoublePlusOp.AAverageConditional(-0.001, Diff_F[nMatches]);
						// Message to 'vdouble252' from IsPositive factor
						vdouble252_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble252_F[nMatches]);
						// Message to 'Diff_1_' from Difference factor
						Diff_1__B[nMatches] = DoublePlusOp.BAverageConditional(-0.001, vdouble252_B[nMatches]);
						// Message to 'Diff' from Copy factor
						Diff_B[nMatches] = ArrayHelper.SetTo<Gaussian>(Diff_B[nMatches], Diff_1__B[nMatches]);
					}
					if (this.Team2wins[nMatches]==0) {
						// Message to 'vdouble250' from Difference factor
						vdouble250_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_F[nMatches], 0.001);
						// Message to 'vdouble250' from IsPositive factor
						vdouble250_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(Bernoulli.PointMass(true), vdouble250_F[nMatches]);
						// Message to 'Diff_0_' from Difference factor
						Diff_0__B[nMatches] = DoublePlusOp.SumAverageConditional(vdouble250_B[nMatches], 0.001);
						// Message to 'Diff' from Copy factor
					...
					if (this.Team2wins[nMatches]==2) {
						...
						// Message to 'vdouble248' from Difference factor
						vdouble248_F[nMatches] = DoublePlusOp.AAverageConditional(-0.001, Diff_2__uses_F[nMatches][1]);
						// Message to 'vdouble248' from IsPositive factor
						vdouble248_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool29_B[nMatches], vdouble248_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][1] = DoublePlusOp.BAverageConditional(-0.001, vdouble248_B[nMatches]);
						// Message to 'Diff_2__uses' from Replicate factor
						...
						// Message to 'vdouble246' from Difference factor
						vdouble246_F[nMatches] = DoublePlusOp.AAverageConditional(Diff_2__uses_F[nMatches][0], 0.001);
						// Message to 'vdouble246' from IsPositive factor
						vdouble246_B[nMatches] = IsPositiveOp_Proper.XAverageConditional(vbool26_B[nMatches], vdouble246_F[nMatches]);
						// Message to 'Diff_2__uses' from Difference factor
						this.Diff_2__uses_B[nMatches][0] = DoublePlusOp.SumAverageConditional(vdouble246_B[nMatches], 0.001);
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						if (nTeamsPerMatch==1) {
							...
							for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
								...
								// Message to 'Perfomance_opposing_team' from Replicate factor
								this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = ReplicateOp_NoDivide.DefAverageConditional<Gaussian>(this.Perfomance_opposing_team_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble220' from Product factor
								this.vdouble220_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.BAverageConditional(this.Perfomance_opposing_team_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble218_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble219' from Ratio factor
								this.vdouble219_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.AAverageConditional(this.vdouble220_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'vdouble219' from Sum factor
								this.vdouble219_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.SumAverageConditional(this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'player_perf_t__n_1_1_' from Sum factor
								this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = FastSumOp.ArrayAverageConditional<DistributionStructArray<Gaussian,double>>(this.vdouble219_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble219_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_item1_rep_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.player_perf_t__n_1_1__B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
								// Message to 'vdouble220' from Ratio factor
								this.vdouble220_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble219_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_1_' from Product factor
								this.Perfomance_opposing_team_1__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble218_reduced[nMatches][nTeamsPerMatch], this.vdouble220_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						...
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							if (nTeamsPerMatch==0) {
								// Message to 'vdouble215' from Ratio factor
								this.vdouble215_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(this.vdouble214_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch]);
								// Message to 'Perfomance_opposing_team_0_' from Product factor
								this.Perfomance_opposing_team_0__F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(this.vdouble213_reduced[nMatches][nTeamsPerMatch], this.vdouble215_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							...
							// Message to 'vdouble225' from Product factor
							this.vdouble225_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(-0.54459509911730619, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][0]);
							// Message to 'vdouble223' from Plus factor
							vdouble223_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble226_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble225_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1] = GaussianProductOpBase.BAverageConditional(vdouble223_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], 2.5567203850565789);
							// Message to 'vdouble235' from Product factor
							this.vdouble235_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(0.79084835337752024, this.Perfomance_opposing_team_uses_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][1]);
						}
						if (nTeamsPerMatch==1) {
					...
					for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
						for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
							...
							vdouble233_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = DoublePlusOp.AAverageConditional(this.vdouble236_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.vdouble235_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
							// Message to 'player_perf_t__n_uses' from Product factor
							this.player_perf_t__n_uses_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam][2] = GaussianProductOpBase.BAverageConditional(vdouble233_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], -2.7928178121382596);
		...
		/// <summary>Computations that depend on the observed value of deathcount and killcount and Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__48 and vdouble__49 and must reset on changes to team2wins</summary>
		...
		/// <summary>Computations that depend on the observed value of killcount and Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__48 and vdouble__49 and must reset on changes to deathcount and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterations and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__48</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48(int numberOfIterations)
		{
			if (this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_isDone) {
				return ;
			}
			DistributionStructArray<Gaussian,double> vdouble__50_F;
			// Create array for 'vdouble__50' Forwards messages.
			vdouble__50_F = new DistributionStructArray<Gaussian,double>(1000);
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				vdouble__50_F[nMatches] = Gaussian.Uniform();
			}
			// Create array for replicates of 'vdouble____18_F'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[] vdouble____18_F = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>[1000];
			...
			Gaussian[][][] vdouble181_F = new Gaussian[1000][][];
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for 'vdouble____18' Forwards messages.
				vdouble____18_F[nMatches] = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(2);
				// Create array for replicates of 'vdouble181_F'
				vdouble181_F[nMatches] = new Gaussian[2][];
				// Create array for replicates of 'vdouble183_F'
				vdouble183_F[nMatches] = new Gaussian[2][];
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					// Create array for 'vdouble____18' Forwards messages.
					vdouble____18_F[nMatches][nTeamsPerMatch] = new DistributionStructArray<Gaussian,double>(this.playerInTeam[nMatches][nTeamsPerMatch]);
					// Create array for replicates of 'vdouble183_F'
					vdouble183_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble181_F'
					vdouble181_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						vdouble____18_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						vdouble181_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble181' from Gaussian factor
						vdouble181_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianOpBase.SampleAverageConditional(this.Vdouble__48[this.playerIndex[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]], 1.0);
						vdouble183_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						// Message to 'vdouble183' from Product factor
						vdouble183_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = GaussianProductOpBase.ProductAverageConditional(vdouble181_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.P_time_m__t__n[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam]);
						// Message to 'vdouble____18' from Ratio factor
						vdouble____18_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = RatioGaussianOp.RatioAverageConditional(vdouble183_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam], this.match_time_m[nMatches]);
					}
				}
				vdouble187_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble187' from Sum factor
				vdouble187_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____18_F[nMatches][0]);
				vdouble188_F[nMatches] = Gaussian.Uniform();
				// Message to 'vdouble188' from Sum factor
				vdouble188_F[nMatches] = FastSumOp.SumAverageConditional(vdouble____18_F[nMatches][1]);
				// Message to 'vdouble__50' from Difference factor
				vdouble__50_F[nMatches] = Tracing.FireEvent<Gaussian>(DoublePlusOp.AAverageConditional(vdouble187_F[nMatches], vdouble188_F[nMatches]), string.Format("vdouble__50_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
			}
			Gaussian vdouble__50_use_B_reduced;
			vdouble__50_use_B_reduced = Gaussian.Uniform();
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				for(int nMatches = 0; nMatches<1000; nMatches++) {
					this.vdouble__50_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.Buffer(vdouble__50_use_B_reduced, vdouble__50_F[nMatches], this.vdouble__50_marginal_F[nMatches], this.vdouble__50_use_B_nMatches__buffer[nMatches]);
					// Message to 'vdouble__50_marginal' from VariablePoint factor
					this.vdouble__50_marginal_F[nMatches] = Tracing.FireEvent<Gaussian>(VariablePointOp_Rprop.MarginalAverageConditional(vdouble__50_use_B_reduced, vdouble__50_F[nMatches], this.vdouble__50_use_B_nMatches__buffer[nMatches], this.vdouble__50_marginal_F[nMatches]), string.Format("vdouble__50_marginal_F[{0}]", new object[1] {nMatches}), this.OnMessageUpdated, false);
				}
				this.OnProgressChanged(new ProgressChangedEventArgs(iteration));
			}
			this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of Match_time_m and numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__48 and vdouble__49 and must reset on changes to deathcount and killcount and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811(bool initialise)
		{
			if (this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811_isDone&&((!initialise)||this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811_isDone = true;
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811_isInitialised = true;
		}
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble218_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble217_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
						this.Avg_play_time_team_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble205_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						if (nTeamsPerMatch==0) {
							this.vdouble213_reduced[nMatches][nTeamsPerMatch] = Factor.Ratio(this.vdouble212_reduced[nMatches][nTeamsPerMatch], this.match_time_m[nMatches]);
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins and vdouble__48 and vdouble__49</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__48</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_Match_time_m_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdoubl2(bool initialise)
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble__50_marginal_F[nMatches] = Gaussian.Uniform();
				this.vdouble__50_use_B_nMatches__buffer[nMatches] = VariablePointOp_Rprop.BufferInit();
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__48 and vdouble__49 and must reset on changes to deathcount and killcount and Match_time_m and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
			...
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10_isDone = true;
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerIndex and PlayerInTeam and vdouble__48 and vdouble__49 and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9_isInitialised)) {
				return ;
			}
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Message to 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' from GetDeepJaggedItems factor
			...
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9_isDone = true;
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9_isInitialised = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and PlayerInTeam and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and team2wins and vdouble__48 and vdouble__49</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble223_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble226_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble225_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==1) {
							...
							this.vdouble220_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble219_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							for(int _a4 = 0; _a4<this.playerInTeam[nMatches][1]; _a4++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble225_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble226_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.kill_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble229_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble229_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						...
						if (nTeamsPerMatch==0) {
							...
							this.vdouble215_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble214_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							for(int _a3 = 0; _a3<this.playerInTeam[nMatches][0]; _a3++) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
						...
						this.vdouble235_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble233_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble236_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.death_count_m__t__n_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble239_use_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble239_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.death_count_m__t__n_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble236_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						this.vdouble235_F[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						if (nTeamsPerMatch==1) {
							this.vdouble219_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
							this.vdouble220_B[nMatches][nTeamsPerMatch][nPlayersMinusPerTeam] = Gaussian.Uniform();
						}
					}
				}
			}
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and team2wins and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and vdouble__48 and vdouble__49</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and vdouble__48 and vdouble__49 and must reset on changes to deathcount and killcount and Match_time_m and p_time_m__t__n and PlayerIndex and PlayerInTeam and team2wins</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8_isInitialised)) {
				return ;
			}
			this.skills_prior_use_F_marginal = GetDeepJaggedItemsOp<double>.Marginal<DistributionStructArray<Gaussian,double>,Gaussian>(this.skills_prior_F, this.skills_prior_use_B, this.skills_prior_use_F_marginal);
			this.Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8_isDone = true;
			this.Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8_isInitialised = true;
		}
		...
		private void Changed_p_time_m__t__n_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==1) {
							this.vdouble217_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][0]);
						}
						this.vdouble205_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][nTeamsPerMatch]);
					}
					for(int nPlayersMinusPerTeam = 0; nPlayersMinusPerTeam<this.playerInTeam[nMatches][nTeamsPerMatch]; nPlayersMinusPerTeam++) {
					...
					if (this.playerInTeam[nMatches][nTeamsPerMatch]>0) {
						if (nTeamsPerMatch==0) {
							this.vdouble212_reduced[nMatches][nTeamsPerMatch] = Factor.Sum(this.P_time_m__t__n[nMatches][1]);
						}
					}
				}
			}
		...
		private void Changed_PlayerInTeam()
		{
			...
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble223_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble226_F'
					this.vdouble226_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble225_F'
					this.vdouble225_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble217_reduced[nMatches][nTeamsPerMatch] = default(double);
					this.vdouble218_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble220_F'
					this.vdouble220_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble219_F'
					this.vdouble219_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					if (nTeamsPerMatch==1) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					this.vdouble205_reduced[nMatches][nTeamsPerMatch] = default(double);
					...
					// Create array for replicates of 'vdouble225_B'
					this.vdouble225_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble226_B'
					this.vdouble226_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble229_use_B'
					this.vdouble229_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble229_F'
					this.vdouble229_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble213_reduced[nMatches][nTeamsPerMatch] = default(double);
					// Create array for replicates of 'vdouble215_F'
					this.vdouble215_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble214_F'
					this.vdouble214_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					if (nTeamsPerMatch==0) {
				...
				for(int nTeamsPerMatch = 0; nTeamsPerMatch<2; nTeamsPerMatch++) {
					...
					// Create array for replicates of 'vdouble235_B'
					this.vdouble235_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble233_F'
					this.vdouble233_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble236_B'
					this.vdouble236_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					// Create array for replicates of 'vdouble239_use_B'
					this.vdouble239_use_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble239_F'
					this.vdouble239_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					...
					this.vdouble236_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble235_F'
					this.vdouble235_F[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble219_B'
					this.vdouble219_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
					// Create array for replicates of 'vdouble220_B'
					this.vdouble220_B[nMatches][nTeamsPerMatch] = new Gaussian[this.playerInTeam[nMatches][nTeamsPerMatch]];
				}
			}
		...
		/// <summary>Computations that depend on the observed value of vdouble__48</summary>
		private void Changed_vdouble__48()
		{
			if (this.Changed_vdouble__48_isDone) {
				return ;
			}
			// Create array for 'vdouble__48_marginal' Forwards messages.
			this.vdouble__48_marginal_F = new DistributionStructArray<Gaussian,double>(6696);
			for(int nPlayers = 0; nPlayers<6696; nPlayers++) {
				this.vdouble__48_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__48_marginal' from DerivedVariable factor
			this.vdouble__48_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__48, this.vdouble__48_marginal_F);
			this.Changed_vdouble__48_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__48 and vdouble__49</summary>
		private void Changed_vdouble__48_vdouble__49()
		{
			if (this.Changed_vdouble__48_vdouble__49_isDone) {
				return ;
			}
			for(int nPlayers = 0; nPlayers<6696; nPlayers++) {
				// Message to 'skills_prior' from Gaussian factor
				this.skills_prior_F[nPlayers] = GaussianOpBase.SampleAverageConditional(this.Vdouble__48[nPlayers], this.Vdouble__49[nPlayers]);
			}
			this.Changed_vdouble__48_vdouble__49_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of vdouble__49</summary>
		private void Changed_vdouble__49()
		{
			if (this.Changed_vdouble__49_isDone) {
				return ;
			}
			// Create array for 'vdouble__49_marginal' Forwards messages.
			this.vdouble__49_marginal_F = new DistributionStructArray<Gaussian,double>(6696);
			for(int nPlayers = 0; nPlayers<6696; nPlayers++) {
				this.vdouble__49_marginal_F[nPlayers] = Gaussian.Uniform();
			}
			// Message to 'vdouble__49_marginal' from DerivedVariable factor
			this.vdouble__49_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__49, this.vdouble__49_marginal_F);
			this.Changed_vdouble__49_isDone = true;
		}
		...
		private void Constant()
		{
			...
			// Create array for 'vdouble__50_marginal' Forwards messages.
			this.vdouble__50_marginal_F = new DistributionStructArray<Gaussian,double>(1000);
			// Create array for replicates of 'vdouble__50_use_B_nMatches__buffer'
			this.vdouble__50_use_B_nMatches__buffer = new RpropBufferData[1000];
			// Create array for 'skills_prior' Forwards messages.
			this.skills_prior_F = new DistributionStructArray<Gaussian,double>(6696);
			for(int nPlayers = 0; nPlayers<6696; nPlayers++) {
				this.skills_prior_F[nPlayers] = Gaussian.Uniform();
			}
			// Create array for 'skills_prior_use' Backwards messages.
			this.skills_prior_use_B = new DistributionStructArray<Gaussian,double>(6696);
			// Create array for 'skills_prior_itemPlayerIndex_nMatches__nTeamsPerMatch__nPlayersMinusPerTeam_' Forwards messages.
			...
			// Create array for replicates of 'vdouble223_F'
			this.vdouble223_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble223_F'
				this.vdouble223_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble226_F'
			this.vdouble226_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble226_F'
				this.vdouble226_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble225_F'
			this.vdouble225_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble225_F'
				this.vdouble225_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'Perfomance_opposing_team_uses_F'
			...
			this.vdouble217_reduced = new double[1000][];
			this.vdouble218_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble217_reduced[nMatches] = new double[2];
				this.vdouble218_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble220_F'
			this.vdouble220_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble220_F'
				this.vdouble220_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble219_F'
			this.vdouble219_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble219_F'
				this.vdouble219_F[nMatches] = new Gaussian[2][];
			}
			...
			this.vdouble205_reduced = new double[1000][];
			this.Avg_play_time_team_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble205_reduced[nMatches] = new double[2];
			...
			// Create array for replicates of 'vdouble225_B'
			this.vdouble225_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble225_B'
				this.vdouble225_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble226_B'
			this.vdouble226_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble226_B'
				this.vdouble226_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_B'
			...
			// Create array for replicates of 'vdouble229_use_B'
			this.vdouble229_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble229_use_B'
				this.vdouble229_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble229_F'
			this.vdouble229_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble229_F'
				this.vdouble229_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'kill_count_m__t__n_F'
			...
			this.vdouble213_reduced = new double[1000][];
			this.vdouble212_reduced = new double[1000][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				this.vdouble212_reduced[nMatches] = new double[2];
				this.vdouble213_reduced[nMatches] = new double[2];
			}
			// Create array for replicates of 'vdouble215_F'
			this.vdouble215_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble215_F'
				this.vdouble215_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble214_F'
			this.vdouble214_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble214_F'
				this.vdouble214_F[nMatches] = new Gaussian[2][];
			}
			...
			// Create array for replicates of 'vdouble235_B'
			this.vdouble235_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble235_B'
				this.vdouble235_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble233_F'
			this.vdouble233_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble233_F'
				this.vdouble233_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble236_B'
			this.vdouble236_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble236_B'
				this.vdouble236_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'death_count_m__t__n_B'
			...
			// Create array for replicates of 'vdouble239_use_B'
			this.vdouble239_use_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble239_use_B'
				this.vdouble239_use_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble239_F'
			this.vdouble239_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble239_F'
				this.vdouble239_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'death_count_m__t__n_F'
			...
			// Create array for replicates of 'vdouble236_F'
			this.vdouble236_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble236_F'
				this.vdouble236_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble235_F'
			this.vdouble235_F = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble235_F'
				this.vdouble235_F[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble219_B'
			this.vdouble219_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble219_B'
				this.vdouble219_B[nMatches] = new Gaussian[2][];
			}
			// Create array for replicates of 'vdouble220_B'
			this.vdouble220_B = new Gaussian[1000][][];
			for(int nMatches = 0; nMatches<1000; nMatches++) {
				// Create array for replicates of 'vdouble220_B'
				this.vdouble220_B[nMatches] = new Gaussian[2][];
			}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_vdouble__49();
			this.Changed_vdouble__48();
			...
			this.Changed_vdouble__48_vdouble__49();
			this.Changed_numberOfIterationsDecreased_Init_deathcount_killcount_Match_time_m_p_time_m__t__n_PlayerInde4(initialise);
			this.Changed_numberOfIterationsDecreased_vdouble__48_vdouble__49_Init_deathcount_killcount_Match_time_m_p8(initialise);
			this.Changed_numberOfIterationsDecreased_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_Init_deathcount9(initialise);
			this.Changed_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48_vdouble__49_10(initialise);
			this.Changed_Match_time_m_numberOfIterationsDecreased_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__4811(initialise);
			...
			this.Changed_Match_time_m_numberOfIterations_p_time_m__t__n_PlayerIndex_PlayerInTeam_vdouble__48(numberOfIterations);
		...
		public object Marginal(string variableName)
		{
			...
			if (variableName=="vdouble__50") {
				return this.Vdouble__50Marginal();
			}
		...
		{
			return this.vdouble__48_marginal_F;
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__50' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__50Marginal()
		{
			return ArrayHelper.MakeCopy<DistributionStructArray<Gaussian,double>>(this.vdouble__50_marginal_F);
		}
