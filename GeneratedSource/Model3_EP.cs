...
namespace Models
{
	...
	public partial class Model3_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_vdouble__28 has executed. Set this to false to force re-execution of Changed_vdouble__28</summary>
		public bool Changed_vdouble__28_isDone;
		...
		/// <summary>Field backing the vdouble__28 property</summary>
		private double[] Vdouble__28;
		...
		public double[] skills__gamma_
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7099)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7099)+" was expected for variable \'skills__gamma_\'");
				}
		...
		/// <summary>The externally-specified value of 'vdouble__28'</summary>
		public double[] vdouble__28
		{
			get {
				return this.Vdouble__28;
			}
			set {
				if ((value!=null)&&(value.Length!=200)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+200)+" was expected for variable \'vdouble__28\'");
				}
				this.Vdouble__28 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vdouble__28_isDone = false;
			}
		}
		...
		public int[][] vint____6
		{
			...
			set {
				if ((value!=null)&&(value.Length!=7099)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+7099)+" was expected for variable \'vint____6\'");
				}
		...
		private void Changed_skills__gamma_()
		{
			...
			this.skills__gamma__marginal_F = new DistributionStructArray<Gaussian,double>(7099);
		...
		/// <summary>Computations that depend on the observed value of vdouble__28</summary>
		private void Changed_vdouble__28()
		{
			if (this.Changed_vdouble__28_isDone) {
				return ;
			}
			// Create array for 'vdouble__28_marginal' Forwards messages.
			this.vdouble__28_marginal_F = new DistributionStructArray<Gaussian,double>(200);
			for(int index15 = 0; index15<200; index15++) {
				this.vdouble__28_marginal_F[index15] = Gaussian.Uniform();
			}
			// Message to 'vdouble__28_marginal' from DerivedVariable factor
			this.vdouble__28_marginal_F = DerivedVariableOp.MarginalAverageConditional<DistributionStructArray<Gaussian,double>,double[]>(this.Vdouble__28, this.vdouble__28_marginal_F);
			this.Changed_vdouble__28_isDone = true;
		}
